(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./parser/cssParser", "./services/cssCompletion", "./services/cssHover", "./services/cssNavigation", "./services/cssCodeActions", "./services/cssValidation", "./parser/scssParser", "./services/scssCompletion", "./parser/lessParser", "./services/lessCompletion", "./services/cssFolding", "./languageFacts", "./services/cssSelectionRange", "./cssLanguageTypes", "vscode-languageserver-types", "./languageFacts"], factory);
    }
    ...
    exports.CSSDataProvider = languageFacts_2.CSSDataProvider;
    ...
    function handleCustomData(options) {
        if (options && options.customDataProviders) {
            languageFacts_1.cssDataManager.addDataProviders(options.customDataProviders);
        }
    }
