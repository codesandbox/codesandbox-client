...
function addImportSpecifierFailures(ctx, failures, sourceFile) {
    forEachImport(sourceFile, function (importNode) {
        ...
        if ((defaultName === undefined || failures.has(defaultName)) &&
        ...
        if (defaultName !== undefined) {
            ...
            if (failure !== undefined) {
                ...
                var end = namedBindings !== undefined
        ...
        if (namedBindings !== undefined) {
            if (allNamedBindingsAreFailures) {
                ...
                for (var i = 0; i < elements.length; i++) {
                    ...
                    var end = nextElement !== undefined && prevElement == undefined
...
function makeUnusedCheckedProgram(program, checkParameters) {
    ...
    var sourceFilesByName = new Map(program
        .getSourceFiles()
        .map(function (s) { return [getCanonicalFileName(s.fileName), s]; }));
    // tslint:disable object-literal-sort-keys
