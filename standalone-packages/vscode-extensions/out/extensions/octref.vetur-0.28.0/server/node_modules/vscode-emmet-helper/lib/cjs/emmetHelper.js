...
const extract_abbreviation_1 = __importDefault(require("@emmetio/extract-abbreviation"));
...
function extractAbbreviation(document, position, options) {
    ...
    try {
        ...
        const result = extract_abbreviation_1.default(currentLine, pos, extractOptions);
...
function extractAbbreviationFromText(text, syntax) {
    ...
    try {
        ...
        const result = extract_abbreviation_1.default(text, pos, extractOptions);
        return {
            abbreviation: result.abbreviation,
            filter
        };
...
function updateExtensionsPath(emmetExtensionsPath, fs, workspaceFolderPath, homeDir) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let snippetsPath = fileService_1.joinPath(emmetExtensionsPathUri, 'snippets.json');
        let profilesPath = fileService_1.joinPath(emmetExtensionsPathUri, 'syntaxProfiles.json');
        try {
