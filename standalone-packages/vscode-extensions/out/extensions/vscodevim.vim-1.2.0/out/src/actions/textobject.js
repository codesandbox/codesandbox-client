    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const iMotion of ranges) {
                const currentSelectedRange = new range_1.Range(vimState.cursorStartPosition, vimState.cursorStopPosition);
                if (iMotion.failed) {
                    continue;
                }
                ...
                if (contender) {
                    const areTheyEqual = contender.equals(new range_1.Range(vimState.cursorStartPosition, vimState.cursorStopPosition)) ||
            ...
            if (!smallestRange) {
                ...
                vimState.cursorStopPosition = new position_1.Position(smallestRange.stop.line, smallestRange.stop.character);
