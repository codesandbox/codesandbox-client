...
(function (factory) {
    ...
    var LESSParser = /** @class */ (function (_super) {
        ...
        LESSParser.prototype._parseVariableDeclaration = function (panic) {
            ...
            var mark = this.mark();
            if (!this.peekDelim('@') && !this.peek(cssScanner_1.TokenType.AtKeyword) || !node.setVariable(this._parseVariable())) {
                return null;
            }
        ...
        LESSParser.prototype._parseVariable = function () {
            if (!this.peekDelim('@') && !this.peekDelim('$') && !this.peek(cssScanner_1.TokenType.AtKeyword)) {
                return null;
            }
        ...
        LESSParser.prototype._parseDetachedRuleSetMixin = function () {
            ...
            if (node.addChild(this._parseVariable()) && (this.hasWhitespace() || !this.accept(cssScanner_1.TokenType.ParenthesisL))) {
                this.restoreAtMark(mark);
                return null;
            }
            if (!this.accept(cssScanner_1.TokenType.ParenthesisR)) {
