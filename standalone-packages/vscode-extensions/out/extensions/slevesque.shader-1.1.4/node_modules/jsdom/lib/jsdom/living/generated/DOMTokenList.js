...
DOMTokenList.prototype.contains = function contains(token) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'contains' on 'DOMTokenList': " +
...
DOMTokenList.prototype.toggle = function toggle(token) {
  ...
  args[0] = conversions["DOMString"](args[0], { context: "Failed to execute 'toggle' on 'DOMTokenList': parameter 1" });

  if (args[1] !== undefined) {
    args[1] = conversions["boolean"](args[1], { context: "Failed to execute 'toggle' on 'DOMTokenList': parameter 2" });
  }
...
DOMTokenList.prototype.replace = function replace(token, newToken) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'replace' on 'DOMTokenList': " +
...
DOMTokenList.prototype.supports = function supports(token) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'supports' on 'DOMTokenList': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
