...
Document.prototype.getElementsByTagName = function getElementsByTagName(localName) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'getElementsByTagName' on 'Document': " +
...
Document.prototype.getElementsByTagNameNS = function getElementsByTagNameNS(namespace, localName) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'getElementsByTagNameNS' on 'Document': " +
...
Document.prototype.getElementsByClassName = function getElementsByClassName(classNames) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'getElementsByClassName' on 'Document': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
...
Document.prototype.adoptNode = function adoptNode(node) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'adoptNode' on 'Document': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
...
Document.prototype.createEvent = function createEvent(_interface) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'createEvent' on 'Document': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
...
Document.prototype.createNodeIterator = function createNodeIterator(root) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'createNodeIterator' on 'Document': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
  ...
  args[0] = convertNode(args[0], { context: "Failed to execute 'createNodeIterator' on 'Document': parameter 1" });
...
Document.prototype.createTreeWalker = function createTreeWalker(root) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'createTreeWalker' on 'Document': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
...
Document.prototype.getElementsByName = function getElementsByName(elementName) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'getElementsByName' on 'Document': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
...
Document.prototype.getElementById = function getElementById(elementId) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'getElementById' on 'Document': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
...
Object.defineProperty(Document.prototype, "onshow", {
  get() {
    if (!this || !module.exports.is(this)) {
      throw new TypeError("Illegal invocation");
    }
