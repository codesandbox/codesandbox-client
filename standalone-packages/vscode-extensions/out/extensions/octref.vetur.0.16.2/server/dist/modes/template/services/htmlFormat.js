...
function htmlFormat(document, currRange, vlsFormatConfig) {
    ...
    if (vlsFormatConfig.defaultFormatter.html === 'prettyhtml') {
        ...
        const prettierResult = formatWithPrettier(originalSource, paths_1.getFileFsPath(document.uri), currRange, vlsFormatConfig, false);
...
function formatWithPrettier(code, fileFsPath, range, vlsFormatConfig, initialIndent) {
    return prettier_1.prettierify(code, fileFsPath, range, vlsFormatConfig, 'vue', initialIndent);
}
