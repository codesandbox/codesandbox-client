...
function exposedOnlyView(module) {
    const exposing_by_name = util_1.keyBy(module.exposing, e => e.name);
    ...
    const annotations_by_name = util_1.keyBy(module.function_annotations, f => f.name);
    const declarations_by_name = util_1.keyBy(module.function_declarations, f => f.name);
    ...
    return {
        type: module.type,
        name: module.name,
        custom_types: exposed_types.filter(x => x.type === 'custom-type'),
        type_aliases: exposed_types.filter(x => x.type === 'type-alias'),
        functions: functions,
    };
}
exports.exposedOnlyView = exposedOnlyView;
//# sourceMappingURL=module_views.js.map