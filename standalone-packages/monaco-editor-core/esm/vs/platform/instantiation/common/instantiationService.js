...
var InstantiationService = /** @class */ (function () {
    ...
    InstantiationService.prototype._createAndCacheServiceInstance = function (id, desc, _trace) {
        ...
        while (true) {
            ...
            for (var _a = 0, roots_1 = roots; _a < roots_1.length; _a++) {
                ...
                var instance = this._createServiceInstance(data.desc.ctor, data.desc.staticArguments, data._trace);
    ...
    InstantiationService.prototype._createServiceInstance = function (ctor, args, _trace) {
        if (args === void 0) { args = []; }
