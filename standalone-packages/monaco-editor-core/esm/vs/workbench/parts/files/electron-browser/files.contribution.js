...
import { Extensions as ViewletExtensions, ViewletDescriptor, ShowViewletAction } from '../../../browser/viewlet';
import * as nls from '../../../../nls';
import { SyncActionDescriptor, MenuId, MenuRegistry } from '../../../../platform/actions/common/actions';
...
import { Extensions as EditorInputExtensions } from '../../../common/editor';
import { AutoSaveConfiguration, HotExitConfiguration, SUPPORTED_ENCODINGS } from '../../../../platform/files/common/files';
import { VIEWLET_ID, SortOrderConfiguration, FILE_EDITOR_INPUT_ID } from '../common/files';
import { FileEditorTracker } from '../browser/editors/fileEditorTracker';
import { SaveErrorHandler } from './saveErrorHandler';
import { FileEditorInput } from '../common/editors/fileEditorInput';
import { TextFileEditor } from '../browser/editors/textFileEditor';
import { BinaryFileEditor } from '../browser/editors/binaryFileEditor';
import { SyncDescriptor } from '../../../../platform/instantiation/common/descriptors';
import { IViewletService } from '../../../services/viewlet/browser/viewlet';
import * as platform from '../../../../base/common/platform';
import { DirtyFilesTracker } from '../common/dirtyFilesTracker';
import { ExplorerViewlet, ExplorerViewletViewsContribution } from './explorerViewlet';
import { EditorDescriptor, Extensions as EditorExtensions } from '../../../browser/editor';
import { DataUriEditorInput } from '../../../common/editor/dataUriEditorInput';
...
import { nativeSep } from '../../../../base/common/paths';
