...
import { IWorkspaceConfigurationService } from '../../configuration/common/configuration';
import { IJSONEditingService } from '../../configuration/common/jsonEditing';
import { IEditorService } from '../../editor/common/editorService';
import { IEditorGroupsService } from '../../group/common/editorGroupsService';
import { DEFAULT_SETTINGS_EDITOR_SETTING, FOLDER_SETTINGS_PATH, getSettingsTargetName, SettingsEditorOptions } from '../common/preferences';
import { DefaultPreferencesEditorInput, KeybindingsEditorInput, PreferencesEditorInput, SettingsEditor2Input } from '../common/preferencesEditorInput';
import { defaultKeybindingsContents, DefaultKeybindingsEditorModel, DefaultSettings, DefaultSettingsEditorModel, Settings2EditorModel, SettingsEditorModel, WorkspaceConfigurationEditorModel } from '../common/preferencesModels';
