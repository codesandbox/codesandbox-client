...
import { TAB_ACTIVE_FOREGROUND, TAB_UNFOCUSED_ACTIVE_FOREGROUND } from '../../../common/theme';
import { EventType as TouchEventType, Gesture } from '../../../../base/browser/touch';
import { addDisposableListener, EventType, addClass, EventHelper, removeClass, toggleClass } from '../../../../base/browser/dom';
import { EDITOR_TITLE_HEIGHT } from './editor';
import { CLOSE_EDITOR_COMMAND_ID } from './editorCommands';
