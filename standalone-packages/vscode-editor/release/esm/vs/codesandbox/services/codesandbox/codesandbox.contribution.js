...
import { EditorDescriptor, Extensions as EditorExtensions } from '../../../workbench/browser/editor.js';
import { ReactEditorInput } from './inputs/ReactEditorInput.js';
import { ReactEditor } from './inputs/reactEditor.js';
...
Registry.as(EditorExtensions.Editors).registerEditor(new EditorDescriptor(ReactEditor, ReactEditor.ID, "React Editor"), [
    new SyncDescriptor(ReactEditorInput)
]);
