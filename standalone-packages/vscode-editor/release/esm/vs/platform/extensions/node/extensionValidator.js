...
import pkg from '../../node/package.js';
...
export function isValidVersion(_version, _desiredVersion) {
    var version;
...
export function isValidExtensionVersion(version, extensionDesc, notices) {
...
export function isEngineValid(engine) {
    // TODO@joao: discuss with alex '*' doesn't seem to be a valid engine version
    return engine === '*' || isVersionValid(pkg.version, engine);
}
export function isVersionValid(currentVersion, requestedVersion, notices) {
