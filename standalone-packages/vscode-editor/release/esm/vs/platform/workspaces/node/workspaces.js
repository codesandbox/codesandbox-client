 ...
 *--------------------------------------------------------------------------------------------*/
import { isRawFileWorkspaceFolder } from '../common/workspaces.js';
import { isWindows, isLinux } from '../../../base/common/platform.js';
import { isAbsolute, relative } from '../../../../path.js';
import { isEqualOrParent, normalize } from '../../../base/common/paths.js';
 ...
 */
export function massageFolderPathForWorkspace(absoluteFolderPath, targetConfigFolder, existingFolders) {
...
function shouldUseSlashForPath(storedFolders) {
    ...
    var useSlashesForPath = !isWindows;
    if (isWindows) {
