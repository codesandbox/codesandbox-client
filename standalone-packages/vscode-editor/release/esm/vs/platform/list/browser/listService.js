...
var ObjectTreeResourceNavigator = /** @class */ (function (_super) {
    __extends(ObjectTreeResourceNavigator, _super);
    function ObjectTreeResourceNavigator(tree, options) {
        var _this = _super.call(this) || this;
        _this.tree = tree;
        _this.options = options;
        _this._openResource = new Emitter();
    ...
    ObjectTreeResourceNavigator.prototype.registerListeners = function () {
        var _this = this;
        if (this.options && this.options.openOnFocus) {
            this._register(this.tree.onDidChangeFocus(function (e) { return _this.onFocus(e); }));
        }
    ...
    ObjectTreeResourceNavigator.prototype.onFocus = function (e) {
    ...
    ObjectTreeResourceNavigator.prototype.onSelection = function (e) {
        if (!e.browserEvent || !(e.browserEvent instanceof MouseEvent)) {
            return;
        }
        var isDoubleClick = e.browserEvent.detail === 2;
        var sideBySide = e.browserEvent.ctrlKey || e.browserEvent.metaKey || e.browserEvent.altKey;
        this.open(!isDoubleClick, isDoubleClick, sideBySide);
    };
    ObjectTreeResourceNavigator.prototype.open = function (preserveFocus, pinned, sideBySide) {
        this._openResource.fire({
            editorOptions: {
                preserveFocus: preserveFocus,
                pinned: pinned,
    ...
    return ObjectTreeResourceNavigator;
}(Disposable));
export { ObjectTreeResourceNavigator };
...
var WorkbenchObjectTree = /** @class */ (function (_super) {
    ...
    function WorkbenchObjectTree(container, delegate, renderers, options, contextKeyService, listService, themeService, configurationService) {
        var _this = _super.call(this, container, delegate, renderers, __assign({ keyboardSupport: false, selectOnMouseDown: true, styleController: new DefaultStyleController(getSharedListStyleSheet()) }, computeStyles(themeService.getTheme(), defaultListStyles), handleListControllers(options, configurationService))) || this;
        _this.contextKeyService = createScopedContextKeyService(contextKeyService, _this);
        var listSupportsMultiSelect = WorkbenchListSupportsMultiSelectContextKey.bindTo(_this.contextKeyService);
        listSupportsMultiSelect.set(!(options.multipleSelectionSupport === false));
    ...
    Object.defineProperty(WorkbenchObjectTree.prototype, "openOnSingleClick", {
        get: function () {
            return this._openOnSingleClick;
        },
        enumerable: true,
