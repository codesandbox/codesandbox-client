...
import { isEqual, basenameOrAuthority } from '../../../base/common/resources.js';
import { isLinux, isWindows } from '../../../base/common/platform.js';
import { tildify, getPathLabel } from '../../../base/common/labels.js';
import { ltrim, startsWith } from '../../../base/common/strings.js';
import { isSingleFolderWorkspaceIdentifier, WORKSPACE_EXTENSION, toWorkspaceIdentifier, isWorkspaceIdentifier } from '../../workspaces/common/workspaces.js';
...
import { REMOTE_HOST_SCHEME } from '../../remote/common/remoteHosts.js';
...
var LabelService = /** @class */ (function () {
    function LabelService(environmentService, contextService, windowService) {
    ...
    LabelService.prototype.getWorkspaceLabel = function (workspace, options) {
        if (!isWorkspaceIdentifier(workspace) && !isSingleFolderWorkspaceIdentifier(workspace)) {
            var identifier = toWorkspaceIdentifier(workspace);
            if (!identifier) {
                return '';
            }
    ...
    LabelService.prototype.getHostLabel = function () {
        if (this.windowService) {
            var authority = this.windowService.getConfiguration().remoteAuthority;
            if (authority) {
                var formatter = this.findFormatter(URI.from({ scheme: REMOTE_HOST_SCHEME, authority: authority }));
