...
import { Emitter, filterEvent, debounceEvent } from '../../../base/common/event.js';
...
var Menu = /** @class */ (function () {
    function Menu(_id, _commandService, _contextKeyService) {
        ...
        debounceEvent(filterEvent(MenuRegistry.onDidChangeMenu, function (menuId) { return menuId === _this._id; }), function () { }, 100)(this._build, this, this._disposables);
        // when context keys change we need to change if the menu also
        // has changed
        this._contextKeyService.onDidChangeContext(function (event) {
            if (event.affectsSome(_this._contextKeys)) {
