...
import { sequence, IdleValue } from '../../../base/common/async.js';
...
import { getDocumentFormattingEdits, NoProviderError } from '../../../editor/contrib/format/format.js';
import { FormattingEdit } from '../../../editor/contrib/format/formattingEdit.js';
...
import { shouldSynchronizeModel } from '../../../editor/common/services/modelService.js';
import { SnippetController2 } from '../../../editor/contrib/snippet/snippetController2.js';
import { ICommandService } from '../../../platform/commands/common/commands.js';
import { CodeActionKind } from '../../../editor/contrib/codeAction/codeActionTrigger.js';
import { applyCodeAction } from '../../../editor/contrib/codeAction/codeActionCommands.js';
import { getCodeActions } from '../../../editor/contrib/codeAction/codeAction.js';
...
var FinalNewLineParticipant = /** @class */ (function () {
    ...
    FinalNewLineParticipant.prototype.doInsertFinalNewLine = function (model) {
        ...
        model.pushEditOperations(prevSelection, [EditOperation.insert(new Position(lineCount, model.getLineMaxColumn(lineCount)), model.getEOL())], function (edits) { return prevSelection; });
        if (editor) {
...
var FormatOnSaveParticipant = /** @class */ (function () {
    ...
    FormatOnSaveParticipant.prototype.participate = function (editorModel, env) {
        ...
        var timeout = this._configurationService.getValue('editor.formatOnSaveTimeout', { overrideIdentifier: model.getLanguageIdentifier().language, resource: editorModel.getResource() });
        return new Promise(function (resolve, reject) {
            ...
            request.then(function (edits) { return _this._editorWorkerService.computeMoreMinimalEdits(model.uri, edits); }).then(resolve, function (err) {
    ...
    CodeActionOnParticipant.prototype.participate = function (editorModel, env) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                codeActionsOnSave = Object.keys(setting).filter(function (x) { return setting[x]; }).map(function (x) { return new CodeActionKind(x); });
                if (!codeActionsOnSave.length) {
                    return [2 /*return*/, undefined];
                }
                timeout = this._configurationService.getValue('editor.codeActionsOnSaveTimeout', settingsOverrides);
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        setTimeout(function () { return reject(localize('codeActionsOnSave.didTimeout', "Aborted codeActionsOnSave after {0}ms", timeout)); }, timeout);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        actions = _a.sent();
                        actionsToRun = actions.filter(function (returnedAction) { return returnedAction.kind && codeActionsOnSave.some(function (onSaveKind) { return onSaveKind.contains(returnedAction.kind); }); });
...
var ExtHostSaveParticipant = /** @class */ (function () {
    ...
    ExtHostSaveParticipant.prototype.participate = function (editorModel, env) {
        ...
        return new Promise(function (resolve, reject) {
            setTimeout(function () { return reject(localize('timeout.onWillSave', "Aborted onWillSaveTextDocument-event after 1750ms")); }, 1750);
