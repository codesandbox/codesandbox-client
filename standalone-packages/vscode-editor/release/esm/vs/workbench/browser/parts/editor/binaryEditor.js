...
var BaseBinaryResourceEditor = /** @class */ (function (_super) {
    ...
    function BaseBinaryResourceEditor(id, callbacks, telemetryService, themeService, _fileService, storageService) {
        ...
        _this._onDidOpenInPlace = _this._register(new Emitter());
    ...
    BaseBinaryResourceEditor.prototype.createEditor = function (parent) {
        ...
        // Custom Scrollbars
        this.scrollbar = this._register(new DomScrollableElement(this.binaryContainer, { horizontal: 1 /* Auto */, vertical: 1 /* Auto */ }));
    ...
    BaseBinaryResourceEditor.prototype.setInput = function (input, options, token) {
        ...
        return _super.prototype.setInput.call(this, input, options, token).then(function () {
            return input.resolve().then(function (model) {
                ...
                // Render Input
                _this.resourceViewerContext = ResourceViewer.show({ name: model.getName(), resource: model.getResource(), size: model.getSize(), etag: model.getETag(), mime: model.getMime() }, _this._fileService, _this.binaryContainer, _this.scrollbar, function (resource) { return _this.handleOpenInternalCallback(input, options); }, function (resource) { return _this.callbacks.openExternal(resource); }, function (meta) { return _this.handleMetadataChanged(meta); });
                return void 0;
            });
        });
    };
