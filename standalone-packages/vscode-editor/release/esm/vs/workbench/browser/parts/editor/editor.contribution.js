...
import { Extensions as QuickOpenExtensions, QuickOpenHandlerDescriptor } from '../../quickopen.js';
import { StatusbarItemDescriptor, Extensions as StatusExtensions } from '../statusbar/statusbar.js';
import { EditorDescriptor, Extensions as EditorExtensions } from '../../editor.js';
import { SideBySideEditorInput, Extensions as EditorInputExtensions, TextCompareEditorActiveContext } from '../../../common/editor.js';
...
import { ChangeEncodingAction, ChangeEOLAction, ChangeModeAction, EditorStatus } from './editorStatus.js';
import { Extensions as ActionExtensions } from '../../../common/actions.js';
import { Scope, Extensions as ActionBarExtensions, ActionBarContributor } from '../../actions.js';
...
import { getQuickNavigateHandler, inQuickOpenContext } from '../quickopen/quickopen.js';
import { KeybindingsRegistry } from '../../../../platform/keybinding/common/keybindingsRegistry.js';
import { ContextKeyExpr } from '../../../../platform/contextkey/common/contextkey.js';
import { isMacintosh } from '../../../../base/common/platform.js';
import { AllEditorsPicker, ActiveEditorGroupPicker } from './editorPicker.js';
import { Schemas } from '../../../../base/common/network.js';
import { registerEditorContribution } from '../../../../editor/browser/editorExtensions.js';
import { OpenWorkspaceButtonContribution } from './editorWidgets.js';
...
registry.registerWorkbenchAction(new SyncActionDescriptor(NavigateForwardAction, NavigateForwardAction.ID, NavigateForwardAction.LABEL, { primary: 0, win: { primary: 512 /* Alt */ | 17 /* RightArrow */ }, mac: { primary: 256 /* WinCtrl */ | 1024 /* Shift */ | 83 /* US_MINUS */ }, linux: { primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 83 /* US_MINUS */ } }), 'Go Forward');
registry.registerWorkbenchAction(new SyncActionDescriptor(NavigateBackwardsAction, NavigateBackwardsAction.ID, NavigateBackwardsAction.LABEL, { primary: 0, win: { primary: 512 /* Alt */ | 15 /* LeftArrow */ }, mac: { primary: 256 /* WinCtrl */ | 83 /* US_MINUS */ }, linux: { primary: 2048 /* CtrlCmd */ | 512 /* Alt */ | 83 /* US_MINUS */ } }), 'Go Back');
...
// Touch Bar
if (isMacintosh) {
    MenuRegistry.appendMenuItem(34 /* TouchBarContext */, {
...
MenuRegistry.appendMenuItem(9 /* EmptyEditorGroupContext */, { command: { id: editorCommands.SPLIT_EDITOR_UP, title: nls.localize('splitUp', "Split Up") }, group: '2_split', order: 10 });
MenuRegistry.appendMenuItem(9 /* EmptyEditorGroupContext */, { command: { id: editorCommands.SPLIT_EDITOR_DOWN, title: nls.localize('splitDown', "Split Down") }, group: '2_split', order: 20 });
MenuRegistry.appendMenuItem(9 /* EmptyEditorGroupContext */, { command: { id: editorCommands.SPLIT_EDITOR_LEFT, title: nls.localize('splitLeft', "Split Left") }, group: '2_split', order: 30 });
MenuRegistry.appendMenuItem(9 /* EmptyEditorGroupContext */, { command: { id: editorCommands.SPLIT_EDITOR_RIGHT, title: nls.localize('splitRight', "Split Right") }, group: '2_split', order: 40 });
MenuRegistry.appendMenuItem(9 /* EmptyEditorGroupContext */, { command: { id: editorCommands.CLOSE_EDITOR_GROUP_COMMAND_ID, title: nls.localize('close', "Close") }, group: '3_close', order: 10, when: ContextKeyExpr.has('multipleEditorGroups') });
// Editor Title Context Menu
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.CLOSE_EDITOR_COMMAND_ID, title: nls.localize('close', "Close") }, group: '1_close', order: 10 });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.CLOSE_OTHER_EDITORS_IN_GROUP_COMMAND_ID, title: nls.localize('closeOthers', "Close Others") }, group: '1_close', order: 20 });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.CLOSE_EDITORS_TO_THE_RIGHT_COMMAND_ID, title: nls.localize('closeRight', "Close to the Right") }, group: '1_close', order: 30, when: ContextKeyExpr.has('config.workbench.editor.showTabs') });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.CLOSE_SAVED_EDITORS_COMMAND_ID, title: nls.localize('closeAllSaved', "Close Saved") }, group: '1_close', order: 40 });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.CLOSE_EDITORS_IN_GROUP_COMMAND_ID, title: nls.localize('closeAll', "Close All") }, group: '1_close', order: 50 });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.KEEP_EDITOR_COMMAND_ID, title: nls.localize('keepOpen', "Keep Open") }, group: '3_preview', order: 10, when: ContextKeyExpr.has('config.workbench.editor.enablePreview') });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.SPLIT_EDITOR_UP, title: nls.localize('splitUp', "Split Up") }, group: '5_split', order: 10 });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.SPLIT_EDITOR_DOWN, title: nls.localize('splitDown', "Split Down") }, group: '5_split', order: 20 });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.SPLIT_EDITOR_LEFT, title: nls.localize('splitLeft', "Split Left") }, group: '5_split', order: 30 });
MenuRegistry.appendMenuItem(8 /* EditorTitleContext */, { command: { id: editorCommands.SPLIT_EDITOR_RIGHT, title: nls.localize('splitRight', "Split Right") }, group: '5_split', order: 40 });
// Editor Title Menu
MenuRegistry.appendMenuItem(7 /* EditorTitle */, { command: { id: editorCommands.TOGGLE_DIFF_SIDE_BY_SIDE, title: nls.localize('toggleSideBySideView', "Toggle Side By Side View") }, group: '1_diff', order: 10, when: ContextKeyExpr.has('isInDiffEditor') });
MenuRegistry.appendMenuItem(7 /* EditorTitle */, { command: { id: editorCommands.SHOW_EDITORS_IN_GROUP, title: nls.localize('showOpenedEditors', "Show Opened Editors") }, group: '3_open', order: 10, when: ContextKeyExpr.has('config.workbench.editor.showTabs') });
MenuRegistry.appendMenuItem(7 /* EditorTitle */, { command: { id: editorCommands.CLOSE_EDITORS_IN_GROUP_COMMAND_ID, title: nls.localize('closeAll', "Close All") }, group: '5_close', order: 10, when: ContextKeyExpr.has('config.workbench.editor.showTabs') });
MenuRegistry.appendMenuItem(7 /* EditorTitle */, { command: { id: editorCommands.CLOSE_SAVED_EDITORS_COMMAND_ID, title: nls.localize('closeAllSaved', "Close Saved") }, group: '5_close', order: 20, when: ContextKeyExpr.has('config.workbench.editor.showTabs') });
function appendEditorToolItem(primary, when, order, alternative) {
    ...
    MenuRegistry.appendMenuItem(7 /* EditorTitle */, item);
}
...
MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.KEEP_EDITOR_COMMAND_ID, title: { value: nls.localize('keepEditor', "Keep Editor"), original: 'View: Keep Editor' }, category: category }, when: ContextKeyExpr.has('config.workbench.editor.enablePreview') });
MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.CLOSE_EDITORS_IN_GROUP_COMMAND_ID, title: { value: nls.localize('closeEditorsInGroup', "Close All Editors in Group"), original: 'View: Close All Editors in Group' }, category: category } });
MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.CLOSE_SAVED_EDITORS_COMMAND_ID, title: { value: nls.localize('closeSavedEditors', "Close Saved Editors in Group"), original: 'View: Close Saved Editors in Group' }, category: category } });
MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.CLOSE_OTHER_EDITORS_IN_GROUP_COMMAND_ID, title: { value: nls.localize('closeOtherEditors', "Close Other Editors in Group"), original: 'View: Close Other Editors in Group' }, category: category } });
MenuRegistry.appendMenuItem(0 /* CommandPalette */, { command: { id: editorCommands.CLOSE_EDITORS_TO_THE_RIGHT_COMMAND_ID, title: { value: nls.localize('closeRightEditors', "Close Editors to the Right in Group"), original: 'View: Close Editors to the Right in Group' }, category: category } });
// File menu
MenuRegistry.appendMenuItem(20 /* MenubarRecentMenu */, {
    group: '1_editor',
    command: {
...
MenuRegistry.appendMenuItem(25 /* MenubarViewMenu */, {
    ...
    submenu: 17 /* MenubarLayoutMenu */,
    order: 2
});
MenuRegistry.appendMenuItem(17 /* MenubarLayoutMenu */, {
    group: '1_split',
    command: {
...
// Forward/Back
MenuRegistry.appendMenuItem(15 /* MenubarGoMenu */, {
    group: '1_fwd_back',
    command: {
...
// Switch Editor
MenuRegistry.appendMenuItem(22 /* MenubarSwitchEditorMenu */, {
    group: '1_any',
    command: {
...
MenuRegistry.appendMenuItem(15 /* MenubarGoMenu */, {
    ...
    submenu: 22 /* MenubarSwitchEditorMenu */,
    order: 1
});
// Switch Group
MenuRegistry.appendMenuItem(23 /* MenubarSwitchGroupMenu */, {
    group: '1_focus_index',
    command: {
...
MenuRegistry.appendMenuItem(15 /* MenubarGoMenu */, {
    ...
    submenu: 23 /* MenubarSwitchGroupMenu */,
    order: 2
});
