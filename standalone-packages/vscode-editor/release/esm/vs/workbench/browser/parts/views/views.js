...
var PersistentContributableViewsModel = /** @class */ (function (_super) {
    ...
    PersistentContributableViewsModel.prototype.saveVisibilityStates = function (viewDescriptors) {
        ...
        this.storageService.store(this.hiddenViewsStorageId, JSON.stringify(values(storedViewsVisibilityStates)), 0 /* GLOBAL */);
    };
    PersistentContributableViewsModel.loadViewsStates = function (viewletStateStorageId, hiddenViewsStorageId, storageService, contextService) {
        ...
        var storedViewsStates = JSON.parse(storageService.get(viewletStateStorageId, 1 /* WORKSPACE */, '{}'));
        ...
        for (var _i = 0, _a = values(viewsVisibilityStates); _i < _a.length; _i++) {
        ...
        for (var _c = 0, _d = Object.keys(storedViewsStates); _c < _d.length; _c++) {
            var id = _d[_c];
    ...
    PersistentContributableViewsModel.loadViewsVisibilityState = function (hiddenViewsStorageId, storageService, contextService) {
        ...
        if (hasDuplicates) {
            storageService.store(hiddenViewsStorageId, JSON.stringify(values(storedViewsVisibilityStates)), 0 /* GLOBAL */);
        }
...
var ViewsService = /** @class */ (function (_super) {
    ...
    function ViewsService(lifecycleService, viewletService, storageService, contextKeyService) {
        var _this = _super.call(this) || this;
        ...
        _this._register(Registry.as(ViewletExtensions.Viewlets).onDidRegister(function (viewlet) { return _this.viewletService.setViewletEnablement(viewlet.id, _this.storageService.getBoolean("viewservice." + viewlet.id + ".enablement", 1 /* WORKSPACE */, viewlet.id !== TEST_VIEW_CONTAINER_ID)); }));
        return _this;
    }
    ...
    ViewsService.prototype.onDidRegisterViews = function (viewDescriptors) {
        ...
        var _loop_2 = function (viewDescriptor) {
            ...
            MenuRegistry.appendMenuItem(0 /* CommandPalette */, {
                command: command,
                when: when
            });
    ...
    ViewsService.prototype.updateViewletEnablement = function (viewContainer, viewDescriptorCollection) {
        ...
        this.storageService.store("viewservice." + viewContainer.id + ".enablement", enabled, 1 /* WORKSPACE */);
    };
