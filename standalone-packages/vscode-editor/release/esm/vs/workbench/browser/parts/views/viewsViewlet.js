...
import { dispose, combinedDisposable, toDisposable } from '../../../../base/common/lifecycle.js';
...
import { PanelViewlet, ViewletPanel } from './panelViewlet.js';
import { DefaultPanelDndController } from '../../../../base/browser/ui/splitview/panelview.js';
import { WorkbenchTree, IListService } from '../../../../platform/list/browser/listService.js';
import { latch, mapEvent } from '../../../../base/common/event.js';
import { IConfigurationService } from '../../../../platform/configuration/common/configuration.js';
import { IPartService } from '../../../services/part/common/partService.js';
import { localize } from '../../../../nls.js';
import { PersistentContributableViewsModel } from './views.js';
...
var ViewContainerViewlet = /** @class */ (function (_super) {
    ...
    function ViewContainerViewlet(id, viewletStateStorageId, showHeaderInTitleWhenSingleView, configurationService, partService, telemetryService, storageService, instantiationService, themeService, contextMenuService, extensionService, contextService) {
        var _this = _super.call(this, id, { showHeaderInTitleWhenSingleView: showHeaderInTitleWhenSingleView, dnd: new DefaultPanelDndController() }, configurationService, partService, contextMenuService, telemetryService, themeService, storageService) || this;
        ...
        _this.visibleViewsCountFromCache = _this.storageService.getInteger(_this.visibleViewsStorageId, 1 /* WORKSPACE */, 1);
