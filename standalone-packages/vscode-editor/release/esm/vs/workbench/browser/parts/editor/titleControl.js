...
import { createActionItem, fillInActionBarActions, fillInContextMenuActions } from '../../../../platform/actions/browser/menuItemActionItem.js';
import { ExecuteCommandAction, IMenuService } from '../../../../platform/actions/common/actions.js';
...
import { DraggedEditorGroupIdentifier, fillResourceDataTransfers, LocalSelectionTransfer } from '../../dnd.js';
...
import { EditorCommandsContextActionRunner, toResource } from '../../../common/editor.js';
import { ResourceContextKey } from '../../../common/resources.js';
import { Themable } from '../../../common/theme.js';
...
var TitleControl = /** @class */ (function (_super) {
    ...
    function TitleControl(parent, accessor, group, contextMenuService, instantiationService, contextKeyService, keybindingService, telemetryService, notificationService, menuService, quickOpenService, themeService, extensionService, configurationService) {
        ...
        _this.contextMenu = _this._register(_this.menuService.createMenu(8 /* EditorTitleContext */, _this.contextKeyService));
        _this.create(parent);
    ...
    TitleControl.prototype.getEditorActions = function () {
        ...
        if (activeControl instanceof BaseEditor) {
            ...
            var titleBarMenu = this.menuService.createMenu(7 /* EditorTitle */, scopedContextKeyService);
