...
import { mapEvent } from '../../../../base/common/event.js';
import { IThemeService } from '../../../../platform/theme/common/themeService.js';
import { contrastBorder } from '../../../../platform/theme/common/colorRegistry.js';
import { SIDE_BAR_TITLE_FOREGROUND, SIDE_BAR_BACKGROUND, SIDE_BAR_FOREGROUND, SIDE_BAR_BORDER } from '../../../common/theme.js';
import { INotificationService } from '../../../../platform/notification/common/notification.js';
import { EventType, addDisposableListener, trackFocus } from '../../../../base/browser/dom.js';
import { StandardMouseEvent } from '../../../../base/browser/mouseEvent.js';
import { RawContextKey, IContextKeyService } from '../../../../platform/contextkey/common/contextkey.js';
var SideBarFocusContextId = 'sideBarFocus';
export var SidebarFocusContext = new RawContextKey(SideBarFocusContextId, false);
var SidebarPart = /** @class */ (function (_super) {
    __extends(SidebarPart, _super);
    function SidebarPart(id, notificationService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService, themeService, contextKeyService) {
        ...
        _this.sideBarFocusContextKey = SidebarFocusContext.bindTo(contextKeyService);
        return _this;
    }
    Object.defineProperty(SidebarPart.prototype, "onDidViewletOpen", {
        get: function () {
            return mapEvent(this._onDidCompositeOpen.event, function (compositeEvent) { return compositeEvent.composite; });
        },
        enumerable: true,
        configurable: true
    });
    ...
    SidebarPart.prototype.create = function (parent) {
        ...
        var focusTracker = trackFocus(parent);
        focusTracker.onDidFocus(function () {
            _this.sideBarFocusContextKey.set(true);
        });
        focusTracker.onDidBlur(function () {
            _this.sideBarFocusContextKey.set(false);
        });
    };
