...
import { Extensions, EditorQuickOpenEntry, CLOSE_ON_FOCUS_LOST_CONFIG, SEARCH_EDITOR_HISTORY, PRESERVE_INPUT_CONFIG } from '../../quickopen.js';
...
var QuickOpenController = /** @class */ (function (_super) {
    ...
    function QuickOpenController(editorGroupService, notificationService, contextKeyService, configurationService, instantiationService, partService, environmentService, themeService, storageService) {
