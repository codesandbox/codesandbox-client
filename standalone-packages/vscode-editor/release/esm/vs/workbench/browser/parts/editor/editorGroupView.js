...
import { isErrorWithActions } from '../../../../base/common/errorsWithActions.js';
...
var EditorGroupView = /** @class */ (function (_super) {
    ...
    EditorGroupView.prototype.createContainerContextMenu = function () {
        var _this = this;
        var menu = this._register(this.menuService.createMenu(9 /* EmptyEditorGroupContext */, this.contextKeyService));
