...
var BreadcrumbsPicker = /** @class */ (function () {
    function BreadcrumbsPicker(parent, _instantiationService, _themeService, _configurationService) {
        ...
        var treeConfig = this._completeTreeConfiguration({ dataSource: undefined, renderer: undefined, highlighter: undefined });
        this._tree = this._instantiationService.createInstance(HighlightingWorkbenchTree, this._treeContainer, treeConfig, { useShadows: false, filterOnType: filterConfig.getValue(), showTwistie: false, twistiePixels: 12 }, { placeholder: localize('placeholder', "Find") });
...
var BreadcrumbsOutlinePicker = /** @class */ (function (_super) {
    ...
    BreadcrumbsOutlinePicker.prototype._getOutlineItemComparator = function () {
