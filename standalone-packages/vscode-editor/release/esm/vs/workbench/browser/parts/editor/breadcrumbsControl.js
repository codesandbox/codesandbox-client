        ...
        this._contextViewService.showContextView({
            render: function (parent) {
                ...
                var selectListener = picker.onDidPickElement(function (data) {
                    ...
                    _this._contextViewService.hideContextView(_this);
                    _this._revealInEditor(event, data.target, _this._getEditorGroup(data.payload && data.payload.originalEvent), (data.payload && data.payload.originalEvent && data.payload.originalEvent.middleButton));
                    /* __GDPR__
                        "breadcrumbs/open" : {
                            "type": { "classification": "SystemMetaData", "purpose": "FeatureInsight" }
                        }
