...
import { LocalSelectionTransfer, DraggedEditorIdentifier, ResourcesDropHandler, DraggedEditorGroupIdentifier, DragAndDropObserver } from '../../dnd.js';
import { addDisposableListener, EventType, EventHelper, isAncestor, toggleClass, addClass, removeClass } from '../../../../base/browser/dom.js';
import { EDITOR_TITLE_HEIGHT, getActiveTextEditorOptions } from './editor.js';
import { EDITOR_DRAG_AND_DROP_BACKGROUND, Themable } from '../../../common/theme.js';
