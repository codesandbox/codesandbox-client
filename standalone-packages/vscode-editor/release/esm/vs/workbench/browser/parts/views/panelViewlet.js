...
var PanelViewlet = /** @class */ (function (_super) {
    ...
    function PanelViewlet(id, options, configurationService, partService, contextMenuService, telemetryService, themeService, storageService) {
        var _this = _super.call(this, id, configurationService, partService, telemetryService, themeService, storageService) || this;
    ...
    PanelViewlet.prototype.create = function (parent) {
        ...
        this._register(addDisposableListener(parent, EventType.CONTEXT_MENU, function (e) { return _this.showContextMenu(new StandardMouseEvent(e)); }));
    };
