...
var HistoryService = /** @class */ (function (_super) {
    ...
    function HistoryService(editorService, editorGroupService, contextService, storageService, configurationService, fileService, windowService, instantiationService, partService, contextKeyService) {
    ...
    HistoryService.prototype.registerListeners = function () {
        ...
        this._register(this.storageService.onWillSaveState(function (reason) { return _this.saveState(); }));
