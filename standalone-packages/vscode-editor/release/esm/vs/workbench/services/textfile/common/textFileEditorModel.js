...
import * as path from '../../../../base/common/paths.js';
...
import { IFileService, CONTENT_CHANGE_EVENT_BUFFER_DELAY } from '../../../../platform/files/common/files.js';
...
import { IHashService } from '../../hash/common/hashService.js';
...
var TextFileEditorModel = /** @class */ (function (_super) {
    ...
    TextFileEditorModel.prototype.onFilesAssociationChange = function () {
        ...
        var languageSelection = this.getOrCreateMode(this.modeService, void 0, firstLineText);
    ...
    TextFileEditorModel.prototype.doTouch = function (versionId) {
        ...
        return this.saveSequentializer.setPending(versionId, this.fileService.updateContent(this.lastResolvedDiskStat.resource, this.createSnapshot(), {
            ...
            _this.updateLastResolvedDiskStat(stat);
        }, function (error) { return onUnexpectedError(error); } /* just log any error but do not notify the user since the file was not dirty */));
    };
