...
var themingRegistry = Registry.as(ThemeingExtensions.ColorContribution);
var textMateScopes = [
    'comment',
    'comment.block',
...
export var tokenColorizationSettingSchema = {
    type: 'object',
...
export var colorsSchema = themingRegistry.getColorSchema();
export function tokenColorsSchema(description) {
    return {
        type: 'array',
...
export var schemaId = 'vscode://schemas/color-theme';
var schema = {
    type: 'object',
    allowComments: true,
    properties: {
...
export function register() {
    var schemaRegistry = Registry.as(JSONExtensions.JSONContribution);
