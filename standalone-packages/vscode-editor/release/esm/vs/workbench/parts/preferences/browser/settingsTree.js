...
import { escapeRegExpCharacters, startsWith } from '../../../../base/common/strings.js';
import { URI } from '../../../../base/common/uri.js';
import { DefaultTreestyler } from '../../../../base/parts/tree/browser/treeDefaults.js';
...
import { editorBackground, errorForeground, focusBorder, foreground, inputValidationErrorBackground, inputValidationErrorForeground, inputValidationErrorBorder } from '../../../../platform/theme/common/colorRegistry.js';
import { attachButtonStyler, attachInputBoxStyler, attachSelectBoxStyler, attachStyler } from '../../../../platform/theme/common/styler.js';
import { IThemeService, registerThemingParticipant } from '../../../../platform/theme/common/themeService.js';
import { isExcludeSetting, settingKeyToDisplayFormat, SettingsTreeGroupElement, SettingsTreeNewExtensionsElement, SettingsTreeSettingElement } from './settingsTreeModels.js';
...
import { SETTINGS_EDITOR_COMMAND_SHOW_CONTEXT_MENU } from '../common/preferences.js';
var $ = DOM.$;
...
var SettingsRenderer = /** @class */ (function () {
    function SettingsRenderer(_measureParent, themeService, contextViewService, openerService, instantiationService, commandService, contextMenuService, keybindingService) {
        ...
        this._onDidClickOverrideElement = new Emitter();
    ...
    SettingsRenderer.prototype.renderSettingElement = function (tree, element, templateId, template) {
        ...
        if (element.overriddenScopeList.length) {
            ...
            var _loop_1 = function (i) {
                var view = DOM.append(template.otherOverridesElement, $('a.modified-scope', null, element.overriddenScopeList[i]));
    ...
    SettingsRenderer.prototype.setElementAriaLabels = function (dataElement, templateId, template) {
