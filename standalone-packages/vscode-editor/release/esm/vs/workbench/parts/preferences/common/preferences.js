...
export var CONTEXT_SETTINGS_JSON_EDITOR = new RawContextKey('inSettingsJSONEditor', false);
...
export var SETTINGS_EDITOR_COMMAND_SWITCH_TO_JSON = 'settings.switchToJSON';
export var SETTINGS_EDITOR_COMMAND_FILTER_MODIFIED = 'settings.filterByModified';
export var SETTINGS_EDITOR_COMMAND_FILTER_ONLINE = 'settings.filterByOnline';
