...
import { foreground, inputBackground, inputBorder, inputForeground, listActiveSelectionBackground, listActiveSelectionForeground, listHoverBackground, listHoverForeground, listInactiveSelectionBackground, listInactiveSelectionForeground, registerColor, selectBackground, selectBorder, selectForeground, textLinkForeground, textPreformatForeground, editorWidgetBorder, textLinkActiveForeground } from '../../../../platform/theme/common/colorRegistry.js';
import { attachButtonStyler, attachInputBoxStyler } from '../../../../platform/theme/common/styler.js';
...
registerThemingParticipant(function (theme, collector) {
    ...
    var activeLink = theme.getColor(textLinkActiveForeground);
    if (activeLink) {
...
var ExcludeSettingWidget = /** @class */ (function (_super) {
    ...
    ExcludeSettingWidget.prototype.renderEditItem = function (item) {
        ...
        this.listDisposables.push(disposableTimeout(function () {
            patternInput.focus();
            patternInput.select();
        }));
        return rowElement;
