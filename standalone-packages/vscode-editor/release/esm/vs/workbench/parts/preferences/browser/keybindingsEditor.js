...
var KeybindingsEditor = /** @class */ (function (_super) {
    ...
    function KeybindingsEditor(telemetryService, themeService, keybindingsService, contextMenuService, keybindingEditingService, contextKeyService, notificationService, clipboardService, instantiationService, editorService, storageService, preferencesService) {
    ...
    KeybindingsEditor.prototype.createHeader = function (parent) {
        ...
        var clearInputAction = new Action(KEYBINDINGS_EDITOR_COMMAND_CLEAR_SEARCH_RESULTS, localize('clearInput', "Clear Keybindings Search Input"), 'clear-input', false, function () { _this.search(''); return Promise.resolve(null); });
    ...
    KeybindingsEditor.prototype.createOpenKeybindingsElement = function (parent) {
        ...
        var fileElement = DOM.append(openKeybindingsContainer, $('.file-name', null, localize('keybindings-file-name', "keybindings.json")));
    ...
    KeybindingsEditor.prototype.createList = function (parent) {
        ...
        this.keybindingsList = this._register(this.instantiationService.createInstance(WorkbenchList, this.keybindingsListContainer, new Delegate(), [new KeybindingHeaderRenderer(), new KeybindingItemRenderer(this, this.keybindingsService)], { identityProvider: function (e) { return e.id; }, mouseSupport: true, ariaLabel: localize('keybindingsLabel', "Keybindings"), setRowLineHeight: false }));
...
var WhenColumn = /** @class */ (function (_super) {
    ...
    WhenColumn.prototype.render = function (keybindingItemEntry) {
        ...
        if (keybindingItemEntry.keybindingItem.when) {
            var whenLabel = new HighlightedLabel(this.whenColumn, false);
