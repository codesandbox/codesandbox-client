...
import { parseQuery, SearchResultModel, SettingsTreeGroupElement, SettingsTreeModel, SettingsTreeSettingElement } from '../browser/settingsTreeModels.js';
...
import { CONTEXT_SETTINGS_EDITOR, CONTEXT_SETTINGS_SEARCH_FOCUS, CONTEXT_TOC_ROW_FOCUS, IPreferencesSearchService, MODIFIED_SETTING_TAG, SETTINGS_EDITOR_COMMAND_SHOW_CONTEXT_MENU } from '../common/preferences.js';
...
var SettingsEditor2 = /** @class */ (function (_super) {
    ...
    function SettingsEditor2(telemetryService, configurationService, themeService, preferencesService, instantiationService, preferencesSearchService, logService, contextKeyService, contextMenuService, storageService, notificationService, editorGroupService, keybindingService) {
    ...
    SettingsEditor2.prototype.restoreCachedState = function () {
        var cachedState = this.editorMemento.loadEditorState(this.group, this.input);
    ...
    SettingsEditor2.prototype.switchToSettingsFile = function () {
        var query = parseQuery(this.searchWidget.getValue());
    ...
    SettingsEditor2.prototype.createBody = function (parent) {
        ...
        var clearFilterLink = DOM.append(this.clearFilterLinkContainer, $('a.pointer.prominent', { tabindex: 0 }, localize('clearSearchFilters', 'Clear Filters')));
        ...
        var clearSearch = DOM.append(clearSearchContainer, $('a.pointer.prominent', { tabindex: 0 }, localize('clearSearch', 'Clear Search')));
    ...
    SettingsEditor2.prototype.createTOC = function (parent) {
        ...
        this._register(this.tocTree.onDidChangeFocus(function (e) {
            ...
            if (element && (!e.payload || !e.payload.fromScroll)) {
                var refreshP = Promise.resolve(null);
    ...
    SettingsEditor2.prototype.createSettingsTree = function (parent) {
        ...
        this._register(this.settingsTreeRenderer.onDidClickOverrideElement(function (element) {
            if (ConfigurationTargetToString(2 /* WORKSPACE */) === element.scope.toUpperCase()) {
                _this.settingsTargetsWidget.updateTarget(2 /* WORKSPACE */);
            }
            else if (ConfigurationTargetToString(1 /* USER */) === element.scope.toUpperCase()) {
                _this.settingsTargetsWidget.updateTarget(1 /* USER */);
            }
    ...
    SettingsEditor2.prototype.updateElementsByKey = function (keys) {
        ...
        if (keys.length) {
            ...
            return Promise.all(keys.map(function (key) { return _this.renderTree(key); }))
                .then(function () { });
        }
        else {
