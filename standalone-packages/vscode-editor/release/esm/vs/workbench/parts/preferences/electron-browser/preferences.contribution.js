...
import { DefaultPreferencesEditorInput, KeybindingsEditorInput, PreferencesEditorInput, SettingsEditor2Input } from '../../../services/preferences/common/preferencesEditorInput.js';
...
MenuRegistry.appendMenuItem(7 /* EditorTitle */, {
    command: {
...
CommandsRegistry.registerCommand(SETTINGS_EDITOR_COMMAND_SWITCH_TO_JSON, function (serviceAccessor) {
    var control = serviceAccessor.get(IEditorService).activeControl;
...
CommandsRegistry.registerCommand(SETTINGS_EDITOR_COMMAND_FILTER_MODIFIED, function (serviceAccessor) {
    var control = serviceAccessor.get(IEditorService).activeControl;
    if (control instanceof SettingsEditor2) {
        control.focusSearch("@" + MODIFIED_SETTING_TAG);
    }
});
CommandsRegistry.registerCommand(SETTINGS_EDITOR_COMMAND_FILTER_ONLINE, function (serviceAccessor) {
    var control = serviceAccessor.get(IEditorService).activeControl;
    if (control instanceof SettingsEditor2) {
