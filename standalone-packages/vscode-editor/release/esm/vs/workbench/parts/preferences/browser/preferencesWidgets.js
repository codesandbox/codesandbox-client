...
import { ActionBar, BaseActionItem } from '../../../../base/browser/ui/actionbar/actionbar.js';
...
import { activeContrastBorder, badgeBackground, badgeForeground, contrastBorder, focusBorder } from '../../../../platform/theme/common/colorRegistry.js';
import { attachInputBoxStyler, attachStylerCallback } from '../../../../platform/theme/common/styler.js';
import { IThemeService, registerThemingParticipant } from '../../../../platform/theme/common/themeService.js';
import { IWorkspaceContextService } from '../../../../platform/workspace/common/workspace.js';
import { PANEL_ACTIVE_TITLE_BORDER, PANEL_ACTIVE_TITLE_FOREGROUND, PANEL_INACTIVE_TITLE_FOREGROUND } from '../../../common/theme.js';
    ...
    SearchWidget.prototype.create = function (parent) {
        ...
        if (this.options.showResultCount) {
            ...
            this._register(attachStylerCallback(this.themeService, { badgeBackground: badgeBackground, contrastBorder: contrastBorder }, function (colors) {
                ...
                var color = _this.themeService.getTheme().getColor(badgeForeground);
...
var EditPreferenceWidget = /** @class */ (function (_super) {
    ...
    function EditPreferenceWidget(editor) {
        ...
        _this._register(_this.editor.onMouseDown(function (e) {
            ...
            if (e.target.type !== 2 /* GUTTER_GLYPH_MARGIN */ || data.isAfterLines || !_this.isVisible()) {
                return;
            }
