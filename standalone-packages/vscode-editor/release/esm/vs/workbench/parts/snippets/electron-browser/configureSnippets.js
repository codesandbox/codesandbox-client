...
function createGlobalSnippetFile(defaultPath, windowService, notificationService, fileService, opener) {
    return __awaiter(this, void 0, void 0, function () {
        var path, resource;
...
CommandsRegistry.registerCommand(id, function (accessor) { return __awaiter(_this, void 0, void 0, function () {
    var snippetService, quickInputService, opener, windowService, modeService, envService, notificationService, workspaceService, fileService, picks, existing, globalSnippetPicks, _i, _a, folder, pick;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, createGlobalSnippetFile(pick.uri, windowService, notificationService, fileService, opener)];
            case 3:
