...
import { anyEvent, debounceEvent, Emitter } from '../../../../base/common/event.js';
...
import { TreeResourceNavigator, WorkbenchTree } from '../../../../platform/list/browser/listService.js';
import { INotificationService, Severity } from '../../../../platform/notification/common/notification.js';
import { IProgressService } from '../../../../platform/progress/common/progress.js';
import { ISearchHistoryService, VIEW_ID, SearchErrorCode } from '../../../../platform/search/common/search.js';
import { IStorageService } from '../../../../platform/storage/common/storage.js';
import { ITelemetryService } from '../../../../platform/telemetry/common/telemetry.js';
import { diffInserted, diffInsertedOutline, diffRemoved, diffRemovedOutline, editorFindMatchHighlight, editorFindMatchHighlightBorder, listActiveSelectionForeground } from '../../../../platform/theme/common/colorRegistry.js';
import { IThemeService, registerThemingParticipant } from '../../../../platform/theme/common/themeService.js';
import { IWorkspaceContextService } from '../../../../platform/workspace/common/workspace.js';
import { OpenFileFolderAction, OpenFolderAction } from '../../../browser/actions/workspaceActions.js';
import { SimpleFileResourceDragAndDrop } from '../../../browser/dnd.js';
import { Viewlet } from '../../../browser/viewlet.js';
import { ExcludePatternInputWidget, PatternInputWidget } from './patternInputWidget.js';
import { CancelSearchAction, ClearSearchResultsAction, CollapseDeepestExpandedLevelAction, RefreshAction } from './searchActions.js';
import { SearchAccessibilityProvider, SearchDataSource, SearchFilter, SearchRenderer, SearchSorter, SearchTreeController } from './searchResultsView.js';
...
import { FileMatch, FolderMatch, ISearchWorkbenchService, Match } from '../common/searchModel.js';
...
var SearchView = /** @class */ (function (_super) {
    ...
    function SearchView(partService, telemetryService, fileService, editorService, progressService, notificationService, dialogService, storageService, contextViewService, instantiationService, configurationService, contextService, searchWorkbenchService, contextKeyService, replaceService, untitledEditorService, preferencesService, themeService, searchHistoryService, editorGroupsService) {
        var _this = _super.call(this, VIEW_ID, configurationService, partService, telemetryService, themeService, storageService) || this;
        ...
        _this.viewletState = _this.getMemento(1 /* WORKSPACE */);
        ...
        _this.selectCurrentMatchEmitter = _this._register(new Emitter());
        _this._register(debounceEvent(_this.selectCurrentMatchEmitter.event, function (l, e) { return e; }, 100, /*leading=*/ true)(function () { return _this.selectCurrentMatch(); }));
        _this.delayedRefresh = _this._register(new Delayer(250));
        return _this;
    }
    ...
    SearchView.prototype.refreshAndUpdateCount = function (event) {
        ...
        return this.refreshTree(event).then(function () {
            ...
            _this.updateSearchResultCount(_this.viewModel.searchResult.query.userDisabledExcludesAndIgnoreFiles);
        });
    };
    ...
    SearchView.prototype.createSearchResultsView = function (container) {
        ...
        var renderer = this._register(this.instantiationService.createInstance(SearchRenderer, this));
    ...
    SearchView.prototype.onQueryTriggered = function (query, options, excludePatternText, includePatternText) {
        ...
        var onError = function (e) {
            if (errors.isPromiseCanceledError(e)) {
                ...
                _this.viewModel.searchResult.clear();
                if (e.code === SearchErrorCode.unknownEncoding && !_this.configurationService.getValue('search.useLegacySearch')) {
                    _this.notificationService.prompt(Severity.Info, nls.localize('otherEncodingWarning', "You can enable \"search.useLegacySearch\" to search non-standard file encodings."), [{
                            label: nls.localize('otherEncodingWarning.openSettingsLabel', "Open Settings"),
                            run: function () { return _this.openSettings('search.useLegacySearch'); }
                        }]);
                }
                else if (e.code === SearchErrorCode.regexParseError && !_this.configurationService.getValue('search.usePCRE2')) {
                    // If the regex parsed in JS but not rg, it likely uses features that are supported in JS and PCRE2 but not Rust
                    _this.notificationService.prompt(Severity.Info, nls.localize('rgRegexError', "You can enable \"search.usePCRE2\" to enable some extra regex features like lookbehind and backreferences."), [{
                            label: nls.localize('otherEncodingWarning.openSettingsLabel', "Open Settings"),
        ...
        var uiRefreshHandle = setInterval(function () {
            ...
            if (visibleMatches !== fileCount) {
                ...
                _this.tree.refresh();
                _this.updateSearchResultCount(options.disregardExcludeSettings);
            }
            if (fileCount > 0) {
                _this.updateActions();
            }
