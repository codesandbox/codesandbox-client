...
import { RemoveAction, ReplaceAction, ReplaceAllAction, ReplaceAllInFolderAction } from './searchActions.js';
...
var SearchRenderer = /** @class */ (function (_super) {
    ...
    function SearchRenderer(searchView, instantiationService, themeService, configurationService, contextService) {
    ...
    SearchRenderer.prototype.renderMatchTemplate = function (tree, templateId, container) {
        ...
        var actions = new ActionBar(actionBarContainer, { animated: false });
        return {
            parent: parent,
            before: before,
            match: match,
    ...
    SearchRenderer.prototype.getMatchTitle = function (match, showLineNumbers) {
...
var SearchTreeController = /** @class */ (function (_super) {
    ...
    SearchTreeController.prototype.onContextMenu = function (tree, element, event) {
        var _this = this;
        if (!this.contextMenu) {
            this.contextMenu = this.menuService.createMenu(33 /* SearchContext */, tree.contextKeyService);
