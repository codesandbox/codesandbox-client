...
import { Extensions as ViewletExtensions, ViewletDescriptor } from '../../../browser/viewlet.js';
...
import { getSelectionSearchString } from '../../../../editor/contrib/find/findController.js';
import { IViewletService } from '../../../services/viewlet/browser/viewlet.js';
import * as Constants from '../common/constants.js';
import { registerContributions as replaceContributions } from '../browser/replaceContributions.js';
import { registerContributions as searchWidgetContributions } from '../browser/searchWidget.js';
import { ContextKeyExpr } from '../../../../platform/contextkey/common/contextkey.js';
import { ToggleCaseSensitiveKeybinding, ToggleRegexKeybinding, ToggleWholeWordKeybinding } from '../../../../editor/contrib/find/findModel.js';
import { ISearchWorkbenchService, SearchWorkbenchService } from '../common/searchModel.js';
import { CommandsRegistry } from '../../../../platform/commands/common/commands.js';
import { SearchView } from '../browser/searchView.js';
import { defaultQuickOpenContextKey } from '../../../browser/parts/quickopen/quickopen.js';
import { OpenSymbolHandler } from '../browser/openSymbolHandler.js';
import { OpenAnythingHandler } from '../browser/openAnythingHandler.js';
import { registerLanguageCommand } from '../../../../editor/browser/editorExtensions.js';
import { getWorkspaceSymbols } from '../common/search.js';
import { illegalArgument } from '../../../../base/common/errors.js';
import { WorkbenchListFocusContextKey, IListService } from '../../../../platform/list/browser/listService.js';
...
import { Extensions as PanelExtensions, PanelDescriptor } from '../../../browser/panel.js';
...
import { VIEW_ID } from '../../../../platform/search/common/search.js';
import { Extensions as WorkbenchExtensions } from '../../../common/contributions.js';
import { SearchViewLocationUpdater } from '../browser/searchViewLocationUpdater.js';
...
MenuRegistry.appendMenuItem(33 /* SearchContext */, {
    command: {
        id: Constants.ReplaceActionId,
...
MenuRegistry.appendMenuItem(10 /* ExplorerContext */, {
    group: '4_search',
    order: 10,
    command: {
        id: FIND_IN_FOLDER_ID,
...
MenuRegistry.appendMenuItem(13 /* MenubarEditMenu */, {
    group: '4_find_global',
    command: {
