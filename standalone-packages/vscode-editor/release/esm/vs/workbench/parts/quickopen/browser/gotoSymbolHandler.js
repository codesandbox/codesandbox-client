...
import { DocumentSymbolProviderRegistry, symbolKindToCssClass } from '../../../../editor/common/modes.js';
...
var NLS_SYMBOL_KIND_CACHE = (_a = {},
    _a[5 /* Method */] = nls.localize('method', "methods ({0})"),
    _a[11 /* Function */] = nls.localize('function', "functions ({0})"),
    _a[8 /* Constructor */] = nls.localize('_constructor', "constructors ({0})"),
    _a[12 /* Variable */] = nls.localize('variable', "variables ({0})"),
    _a[4 /* Class */] = nls.localize('class', "classes ({0})"),
    _a[22 /* Struct */] = nls.localize('struct', "structs ({0})"),
    _a[23 /* Event */] = nls.localize('event', "events ({0})"),
    _a[24 /* Operator */] = nls.localize('operator', "operators ({0})"),
    _a[10 /* Interface */] = nls.localize('interface', "interfaces ({0})"),
    _a[2 /* Namespace */] = nls.localize('namespace', "namespaces ({0})"),
    _a[3 /* Package */] = nls.localize('package', "packages ({0})"),
    _a[25 /* TypeParameter */] = nls.localize('typeParameter', "type parameters ({0})"),
    _a[1 /* Module */] = nls.localize('modules', "modules ({0})"),
    _a[6 /* Property */] = nls.localize('property', "properties ({0})"),
    _a[9 /* Enum */] = nls.localize('enum', "enumerations ({0})"),
    _a[21 /* EnumMember */] = nls.localize('enumMember', "enumeration members ({0})"),
    _a[14 /* String */] = nls.localize('string', "strings ({0})"),
    _a[0 /* File */] = nls.localize('file', "files ({0})"),
    _a[17 /* Array */] = nls.localize('array', "arrays ({0})"),
    _a[15 /* Number */] = nls.localize('number', "numbers ({0})"),
    _a[16 /* Boolean */] = nls.localize('boolean', "booleans ({0})"),
    _a[18 /* Object */] = nls.localize('object', "objects ({0})"),
    _a[19 /* Key */] = nls.localize('key', "keys ({0})"),
    _a[7 /* Field */] = nls.localize('field', "fields ({0})"),
    _a[13 /* Constant */] = nls.localize('constant', "constants ({0})"),
    _a);
    ...
    GotoSymbolHandler.prototype.doGetActiveOutline = function () {
        ...
        if (activeTextEditorWidget) {
            ...
            if (model_1 && types.isFunction(model_1.getLanguageIdentifier)) {
                return Promise.resolve(asThenable(function () { return getDocumentSymbols(model_1, true, _this.pendingOutlineRequest.token); }).then(function (entries) {
