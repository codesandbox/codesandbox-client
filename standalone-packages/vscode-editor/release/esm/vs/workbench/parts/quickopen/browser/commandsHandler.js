...
var CommandsHistory = /** @class */ (function (_super) {
    ...
    CommandsHistory.prototype.load = function () {
        ...
        commandCounter = this.storageService.getInteger(CommandsHistory.PREF_KEY_COUNTER, 0 /* GLOBAL */, commandCounter);
    };
...
var CommandsHandler = /** @class */ (function (_super) {
    ...
    CommandsHandler.prototype.getResults = function (searchValue, token) {
        ...
        return this.extensionService.whenInstalledExtensionsRegistered().then(function () {
            ...
            // Other Actions
            var menu = _this.editorService.invokeWithinEditorContext(function (accessor) { return _this.menuService.createMenu(0 /* CommandPalette */, accessor.get(IContextKeyService)); });
