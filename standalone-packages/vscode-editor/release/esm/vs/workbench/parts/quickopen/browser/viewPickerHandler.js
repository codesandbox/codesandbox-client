...
var ViewPickerHandler = /** @class */ (function (_super) {
    ...
    ViewPickerHandler.prototype.getViewEntries = function () {
        ...
        viewlets.forEach(function (viewlet, index) { return viewEntries.push(new ViewEntry(viewlet.name, nls.localize('views', "Side Bar"), function () { return _this.viewletService.openViewlet(viewlet.id, true); })); });
        // Panels
