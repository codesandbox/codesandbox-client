...
import { ExplorerFocusCondition, FileOnDiskContentProvider, VIEWLET_ID } from '../common/files.js';
...
import { getResourceForCommand, getMultiSelectedResources } from '../browser/files.js';
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    win: {
        primary: KeyChord(2048 /* CtrlCmd */ | 41 /* KEY_K */, 2048 /* CtrlCmd */ | 1024 /* Shift */ | 33 /* KEY_C */)
    },
