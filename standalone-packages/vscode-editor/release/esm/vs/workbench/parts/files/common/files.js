...
import { ExplorerItem, OpenEditor } from './explorerModel.js';
...
import { InputFocusedContextKey } from '../../../../platform/workbench/common/contextkeys.js';
...
var FileOnDiskContentProvider = /** @class */ (function () {
    ...
    FileOnDiskContentProvider.prototype.provideTextContent = function (resource) {
        var _this = this;
        var fileOnDiskResource = resource.with({ scheme: Schemas.file });
