...
import { ActionRunner as BaseActionRunner } from '../../../../../base/common/actions.js';
import * as comparers from '../../../../../base/common/comparers.js';
...
import { DuplicateFileAction, AddFilesAction, FileCopiedContext } from '../fileActions.js';
import { DRAG_OVER_ACCEPT_BUBBLE_DOWN, DRAG_OVER_ACCEPT_BUBBLE_DOWN_COPY, DRAG_OVER_ACCEPT_BUBBLE_UP, DRAG_OVER_ACCEPT_BUBBLE_UP_COPY, DRAG_OVER_REJECT } from '../../../../../base/parts/tree/browser/tree.js';
import { DesktopDragAndDropData, ExternalElementsDragAndDropData } from '../../../../../base/parts/tree/browser/treeDnd.js';
import { ExplorerItem, NewStatPlaceholder, Model } from '../../common/explorerModel.js';
...
import { attachInputBoxStyler } from '../../../../../platform/theme/common/styler.js';
...
import { extractResources, SimpleFileResourceDragAndDrop, CodeDataTransfers, fillResourceDataTransfers } from '../../../../browser/dnd.js';
import { WorkbenchTreeController } from '../../../../../platform/list/browser/listService.js';
import { IClipboardService } from '../../../../../platform/clipboard/common/clipboardService.js';
import { DataTransfers } from '../../../../../base/browser/dnd.js';
import { Schemas } from '../../../../../base/common/network.js';
import { rtrim } from '../../../../../base/common/strings.js';
import { IDialogService, getConfirmMessage } from '../../../../../platform/dialogs/common/dialogs.js';
...
var FileController = /** @class */ (function (_super) {
    ...
    FileController.prototype.onContextMenu = function (tree, stat, event) {
        ...
        if (!this.contributedContextMenu) {
            this.contributedContextMenu = this.menuService.createMenu(10 /* ExplorerContext */, tree.contextKeyService);
