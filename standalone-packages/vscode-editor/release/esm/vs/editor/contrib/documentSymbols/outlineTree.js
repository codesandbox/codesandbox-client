...
import { symbolKindToCssClass } from '../../common/modes.js';
import { OutlineElement, OutlineGroup, OutlineModel, TreeElement } from './outlineModel.js';
...
var OutlineRenderer = /** @class */ (function () {
    ...
    OutlineRenderer.prototype.renderTemplate = function (tree, templateId, container) {
        if (templateId === 'outline-element') {
            ...
            return { icon: icon, labelContainer: labelContainer, label: new HighlightedLabel(labelContainer, true), detail: detail, decoration: decoration };
        }
        if (templateId === 'outline-group') {
            var labelContainer = dom.$('.outline-element-label');
            dom.addClass(container, 'outline-element');
            dom.append(container, labelContainer);
            return { labelContainer: labelContainer, label: new HighlightedLabel(labelContainer, true) };
        }
