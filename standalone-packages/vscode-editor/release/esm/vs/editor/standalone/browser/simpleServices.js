...
import { ImmortalReference, combinedDisposable, toDisposable, Disposable } from '../../../base/common/lifecycle.js';
import { OS, isLinux, isMacintosh } from '../../../base/common/platform.js';
import Severity from '../../../base/common/severity.js';
import { Registry } from '../../../platform/registry/common/platform.js';
import { Extensions } from '../../../platform/configuration/common/configurationRegistry.js';
import { URI } from '../../../base/common/uri.js';
import { IConfigurationService, compare } from '../../../platform/configuration/common/configuration.js';
import { WorkspaceFolder, Workspace } from '../../../platform/workspace/common/workspace.js';
...
import { Configuration, DefaultConfigurationModel, ConfigurationChangeEvent } from '../../../platform/configuration/common/configurationModels.js';
import { AbstractKeybindingService } from '../../../platform/keybinding/common/abstractKeybindingService.js';
import { KeybindingResolver } from '../../../platform/keybinding/common/keybindingResolver.js';
import { KeybindingsRegistry } from '../../../platform/keybinding/common/keybindingsRegistry.js';
import { ResolvedKeybindingItem } from '../../../platform/keybinding/common/resolvedKeybindingItem.js';
import { USLayoutResolvedKeybinding } from '../../../platform/keybinding/common/usLayoutResolvedKeybinding.js';
import { WorkspaceConfigurationChangeEvent } from '../../../workbench/services/configuration/common/configurationModels.js';
...
var SimpleConfigurationService = /** @class */ (function (_super) {
    ...
    SimpleConfigurationService.prototype.onDidChangeUserConfiguration = function () {
        var _this = this;
        var changedKeys = [];
        var _a = compare(this._configuration.user, this.userConfiguration.configurationModel), added = _a.added, updated = _a.updated, removed = _a.removed;
        changedKeys = added.concat(updated, removed);
        if (changedKeys.length) {
            var oldConfiguartion_1 = this._configuration;
            this.reset();
            changedKeys = changedKeys.filter(function (key) { return !equals(oldConfiguartion_1.getValue(key, {}, null), _this._configuration.getValue(key, {}, null)); });
            if (changedKeys.length) {
...
var SimpleResourceConfigurationService = /** @class */ (function () {
    ...
    SimpleResourceConfigurationService.prototype.getValue = function (resource, arg2, arg3) {
        var position = Position.isIPosition(arg2) ? arg2 : null;
...
var SimpleMenuService = /** @class */ (function () {
    function SimpleMenuService(configurationService) {
        this.configurationService = configurationService;
    }
    SimpleMenuService.prototype.createMenu = function (id, contextKeyService) {
        return new Menu(id, new Promise(function (r) { return setTimeout(function () { r(true); }, 500); }), this._commandService, contextKeyService);
    };
    SimpleMenuService = __decorate([
        __param(0, IConfigurationService)
    ], SimpleMenuService);
