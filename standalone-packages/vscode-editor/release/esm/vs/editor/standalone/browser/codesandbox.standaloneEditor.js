...
import { TextModelResolvedOptions, FindMatch } from '../../common/model.js';
import { INotificationService } from '../../../platform/notification/common/notification.js';
import { IConfigurationService } from '../../../platform/configuration/common/configuration.js';
import { loadCodesandboxServices } from '../../../codesandbox/codesandbox.services.js';
var services = null;
function withAllStandaloneServices(domElement, override, callback) {
    services = new DynamicStandaloneServices(domElement, override);
    if (override) {
        loadCodesandboxServices(services, services.get(IInstantiationService), override);
    }
 ...
 */
export function create(domElement, options, override, callback) {
...
export function resolveModel(uri) {
    return services.get(ITextModelService).createModelReference(uri);
}
/**
