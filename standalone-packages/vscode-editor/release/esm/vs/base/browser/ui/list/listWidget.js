...
var TraitSpliceable = /** @class */ (function () {
    ...
    TraitSpliceable.prototype.splice = function (start, deleteCount, elements) {
        ...
        var pastElementsWithTrait = this.trait.get().map(function (i) { return getId(_this.view.element(i)); });
        var elementsWithTrait = elements.map(function (e) { return pastElementsWithTrait.indexOf(getId(e)) > -1; });
