...
import { getOrDefault2 } from '../../../common/objects.js';
...
var ListView = /** @class */ (function () {
    function ListView(container, virtualDelegate, renderers, options) {
        ...
        this.scrollableElement = new ScrollableElement(this.rowsContainer, {
            ...
            horizontal: 2 /* Hidden */,
            vertical: getOrDefault2(options, function (o) { return o.verticalScrollMode; }, DefaultOptions.verticalScrollMode),
            useShadows: getOrDefault2(options, function (o) { return o.useShadows; }, DefaultOptions.useShadows)
        });
        ...
        this.setRowLineHeight = getOrDefault2(options, function (o) { return o.setRowLineHeight; }, DefaultOptions.setRowLineHeight);
        this.layout();
    }
    ...
    ListView.prototype.setupDragAndDropScrollInterval = function () {
        ...
        if (!this.dragAndDropScrollInterval) {
            ...
            this.dragAndDropScrollTimeout = window.setTimeout(function () {
                ...
                _this.dragAndDropScrollTimeout = -1;
            }, 1000);
        }
    };
