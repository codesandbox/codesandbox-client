...
import { Emitter, chain, filterEvent } from '../../../common/event.js';
...
var PanelView = /** @class */ (function (_super) {
    ...
    PanelView.prototype.addPanel = function (panel, size, index) {
        ...
        disposables.push(scheduleAtNextAnimationFrame(function () { return shouldAnimate = true; }));
        filterEvent(panel.onDidChange, function () { return shouldAnimate; })(this.setupAnimation, this, disposables);
