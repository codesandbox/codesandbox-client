...
declare namespace monaco.editor {
	 ...
	 * The editor will read the size of `domElement`.
	 */
	export function create(domElement: HTMLElement, override: IEditorOverrideServices, callback: (services: {
		serviceCollection: ServiceCollection;
	}) => void): void;

	export function addWorkbenchActions({ id, label, commandLabel, run, category, keybindings }: {
		id: string;
		label: string;
		commandLabel: string;
		run: () => Promise<any>;
	...
	export function appendMenuItem(menuBarId: number, { group, command, order, }: IMenuItem): void;
	...
	export function getDefaultWorkspace(): ISingleFolderWorkspaceInitializationPayload;

	export function createMonacoEditorAPI(): {
		create: any;
		addWorkbenchActions: any;
		appendMenuItem: any;
		setModelMarkers: any;
	...
	export const listFilterWidgetBackground: string;

	export const listFilterWidgetOutline: string;

	export const listFilterWidgetNoMatchesOutline: string;
	...
	export const editorHoverStatusBarBackground: string;
	 ...
	 * Diff Editor Colors
	 */
	export const defaultInsertColor: any;

	export const defaultRemoveColor: any;
