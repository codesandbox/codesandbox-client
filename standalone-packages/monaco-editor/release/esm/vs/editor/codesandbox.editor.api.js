...
import { createMonacoEditorAPI } from './standalone/browser/codesandbox.standaloneEditor.js';
...
var api = global.monaco || createMonacoBaseAPI();
api.editor = createMonacoEditorAPI();
api.languages = api.languages || createMonacoLanguagesAPI();
