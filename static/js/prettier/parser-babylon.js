  ...
  var parserBabylon_1 = createCommonjsModule(function(module) {
    ...
    function parse(t, e, s) {
      var i = index,
        ...
        a = s && "json" === s.parser ? "parseExpression" : "parse";
      var n = void 0;
      try {
        n = i[a](t, r);
      } catch (e) {
        try {
          ...
          throw createError(e.message.replace(/ \(.*\)/, ""), {
            start: { line: e.loc.line, column: e.loc.column + 1 }
          });
        }
      }
      ...
      index = createCommonjsModule$$1(function(t, e) {
          ...
          return t < 65
            ...
            : t < 91 ||
              (t < 97
                ...
                : t < 123 ||
                  (t <= 65535
                    ? t >= 170 && R.test(String.fromCharCode(t))
                    : r(t, O)));
        }
        function n(t) {
          return t < 48
        ...
        function h(t, e) {
          for (var s = 1, i = 0; ; ) {
            B.lastIndex = i;
            var r = B.exec(t);
            if (!(r && r.index < e)) return new W(s, e - i);
        ...
        function f(t) {
          ...
          if ("JSXMemberExpression" === t.type)
            return f(t.object) + "." + f(t.property);
        ...
        function P(t, e) {
          var s = b(e, t);
          return s.options.strictMode &&
            (s.state.strict = !0), s.getExpression();
        }
        function b(t, e) {
          return new (t && t.plugins ? g(t.plugins) : st)(t, e);
        }
        function g(t) {
          if (t.indexOf("decorators") >= 0 && t.indexOf("decorators2") >= 0)
            throw new Error(
          ...
          if (
            (
              ...
              e.indexOf("flow") >= 0 && e.indexOf("typescript") >= 0
            )
          )
            throw new Error("Cannot combine flow and typescript plugins.");
          e.indexOf("typescript") >= 0 &&
            (e = e.filter(function(t) {
              return "typescript" !== t;
            })).push("typescript"), e.indexOf("estree") >= 0 &&
            (e = e.filter(function(t) {
              return "estree" !== t;
            })).unshift("estree");
          var s = e.join("/"),
        ...
        var T = {
          ...
          A = function A(t, e) {
            (t.prototype = Object.create(
              e.prototype
            )), (t.prototype.constructor = t), (t.__proto__ = e);
          },
          w = !0,
          k = function k(t, e) {
            void 0 === e && (e = {}), (this.label = t), (this.keyword =
              e.keyword), (this.beforeExpr = !!e.beforeExpr), (this.startsExpr = !!e.startsExpr), (this.rightAssociative = !!e.rightAssociative), (this.isLoop = !!e.isLoop), (this.isAssign = !!e.isAssign), (this.prefix = !!e.prefix), (this.postfix = !!e.postfix), (this.binop =
              e.binop || null), (this.updateContext = null);
          },
          N = (function(t) {
            function e(e, s) {
              return void 0 === s && (s = {}), (s.keyword = e), t.call(
                this,
                e,
                s
              ) || this;
          ...
          C = {
            num: new k("num", { startsExpr: !0 }),
            bigint: new k("bigint", { startsExpr: !0 }),
            regexp: new k("regexp", { startsExpr: !0 }),
            string: new k("string", { startsExpr: !0 }),
            name: new k("name", { startsExpr: !0 }),
            eof: new k("eof"),
            bracketL: new k("[", { beforeExpr: w, startsExpr: !0 }),
            bracketR: new k("]"),
            braceL: new k("{", { beforeExpr: w, startsExpr: !0 }),
            braceBarL: new k("{|", { beforeExpr: w, startsExpr: !0 }),
            braceR: new k("}"),
            braceBarR: new k("|}"),
            parenL: new k("(", { beforeExpr: w, startsExpr: !0 }),
            parenR: new k(")"),
            comma: new k(",", { beforeExpr: w }),
            semi: new k(";", { beforeExpr: w }),
            colon: new k(":", { beforeExpr: w }),
            doubleColon: new k("::", { beforeExpr: w }),
            dot: new k("."),
            question: new k("?", { beforeExpr: w }),
            questionDot: new k("?."),
            arrow: new k("=>", { beforeExpr: w }),
            template: new k("template"),
            ellipsis: new k("...", { beforeExpr: w }),
            backQuote: new k("`", { startsExpr: !0 }),
            dollarBraceL: new k("${", { beforeExpr: w, startsExpr: !0 }),
            at: new k("@"),
            hash: new k("#"),
            eq: new k("=", { beforeExpr: w, isAssign: !0 }),
            assign: new k("_=", { beforeExpr: w, isAssign: !0 }),
            incDec: new k("++/--", { prefix: !0, postfix: !0, startsExpr: !0 }),
            bang: new k("!", { beforeExpr: w, prefix: !0, startsExpr: !0 }),
            tilde: new k("~", { beforeExpr: w, prefix: !0, startsExpr: !0 }),
            logicalOR: new E("||", 1),
            logicalAND: new E("&&", 2),
            bitwiseOR: new E("|", 3),
            bitwiseXOR: new E("^", 4),
          ...
          S = {
            break: new N("break"),
            case: new N("case", { beforeExpr: w }),
            catch: new N("catch"),
            continue: new N("continue"),
            debugger: new N("debugger"),
            default: new N("default", { beforeExpr: w }),
            do: new N("do", { isLoop: !0, beforeExpr: w }),
            else: new N("else", { beforeExpr: w }),
            finally: new N("finally"),
            for: new N("for", { isLoop: !0 }),
            function: new N("function", { startsExpr: !0 }),
            if: new N("if"),
            return: new N("return", { beforeExpr: w }),
            switch: new N("switch"),
            throw: new N("throw", { beforeExpr: w }),
            try: new N("try"),
            var: new N("var"),
            let: new N("let"),
            const: new N("const"),
            while: new N("while", { isLoop: !0 }),
            with: new N("with"),
            new: new N("new", { beforeExpr: w, startsExpr: !0 }),
            this: new N("this", { startsExpr: !0 }),
            super: new N("super", { startsExpr: !0 }),
            class: new N("class"),
            extends: new N("extends", { beforeExpr: w }),
            export: new N("export"),
            import: new N("import", { startsExpr: !0 }),
            yield: new N("yield", { beforeExpr: w, startsExpr: !0 }),
            null: new N("null", { startsExpr: !0 }),
            true: new N("true", { startsExpr: !0 }),
            false: new N("false", { startsExpr: !0 }),
            in: new N("in", { beforeExpr: w, binop: 7 }),
            instanceof: new N("instanceof", { beforeExpr: w, binop: 7 }),
            typeof: new N("typeof", {
              beforeExpr: w,
              prefix: !0,
              startsExpr: !0
            }),
            void: new N("void", { beforeExpr: w, prefix: !0, startsExpr: !0 }),
            delete: new N("delete", {
              beforeExpr: w,
              prefix: !0,
              startsExpr: !0
        ...
        var O = [
          ...
          U = {
            braceStatement: new V("{", !1),
            braceExpression: new V("{", !0),
            templateQuasi: new V("${", !0),
            parenStatement: new V("(", !1),
            parenExpression: new V("(", !0),
            template: new V("`", !0, !0, function(t) {
              return t.readTmplToken();
            }),
            functionExpression: new V("function", !0)
          };
        (C.parenR.updateContext = C.braceR.updateContext = function() {
          if (1 !== this.state.context.length) {
            var t = this.state.context.pop();
            t === U.braceStatement && this.curContext() === U.functionExpression
          ...
          "of" !== this.state.value || this.curContext() !== U.parenStatement
            ? (
                (this.state.exprAllowed = !1),
                (t !== C._let && t !== C._const && t !== C._var) ||
                  (F.test(this.input.slice(this.state.end)) &&
                    (this.state.exprAllowed = !0))
              )
            : (this.state.exprAllowed = !t.beforeExpr);
        }), (C.braceL.updateContext = function(t) {
          this.state.context.push(
            this.braceIsBlock(t) ? U.braceStatement : U.braceExpression
          ), (this.state.exprAllowed = !0);
          ...
          var e =
            t === C._if || t === C._for || t === C._with || t === C._while;
          this.state.context.push(
            e ? U.parenStatement : U.parenExpression
          ), (this.state.exprAllowed = !0);
        ...
        var W = function W(t, e) {
          ...
          X = (function(t) {
            ...
            return A(e, t), (e.prototype.raise = function(t, e, s) {
              var i = h(this.input, t);
              e += " (" + i.line + ":" + i.column + ")";
              var r = new SyntaxError(e);
              throw ((r.pos = t), (r.loc = i), s && (r.missingPlugin = s), r);
            }), e;
          })(
            (function(t) {
              function e() {
              ...
              return A(e, t), (e.prototype.addComment = function(t) {
                this.filename &&
                  (t.loc.filename = this.filename), this.state.trailingComments.push(
                  t
                ...
                if (!("Program" === t.type && t.body.length > 0)) {
                  ...
                  for (
                    e.length > 0 && p(e).start >= t.start && (s = e.pop());
                    e.length > 0 && p(e).start >= t.start;
                  ...
                  if (
                    (
                      !i && s && (i = s),
                      s && this.state.leadingComments.length > 0
                    )
                  ) {
                    var h = p(this.state.leadingComments);
                  ...
                  if (i) {
                    if (i.leadingComments)
                      if (i !== t && p(i.leadingComments).end <= t.start)
                        (t.leadingComments =
                          i.leadingComments), (i.leadingComments = null);
                      else
                        for (a = i.leadingComments.length - 2; a >= 0; --a) {
                          if (i.leadingComments[a].end <= t.start) {
                            t.leadingComments = i.leadingComments.splice(
                              0,
                              a + 1
                            );
                            break;
                    ...
                    if (p(this.state.leadingComments).end <= t.start) {
                      ...
                      var l = this.state.leadingComments.slice(0, a);
                      (t.leadingComments = 0 === l.length ? null : l), 0 ===
                        (r = this.state.leadingComments.slice(a)).length &&
                        (r = null);
                    }
                  (this.state.commentPreviousNode = t), r &&
                    (r.length && r[0].start >= t.start && p(r).end <= t.end
                      ? (t.innerComments = r)
                      : (t.trailingComments = r)), e.push(t);
                }
              }), e;
            })(
              (function() {
          ...
          G = (function() {
            ...
            return (t.prototype.init = function(t, e) {
              (this.strict =
                !1 !== t.strictMode &&
                "module" ===
                  t.sourceType), (this.input = e), (this.potentialArrowAt = -1), (this.inMethod = this.inFunction = this.inGenerator = this.inAsync = this.inPropertyName = this.inType = this.inClassProperty = this.noAnonFunctionType = !1), (this.classLevel = 0), (this.labels = []), (this.decoratorStack = [
                []
              ]), (this.tokens = []), (this.comments = []), (this.trailingComments = []), (this.leadingComments = []), (this.commentStack = []), (this.commentPreviousNode = null), (this.pos = this.lineStart = 0), (this.curLine =
                t.startLine), (this.type =
                C.eof), (this.value = null), (this.start = this.end = this.pos), (this.startLoc = this.endLoc = this.curPosition()), (this.lastTokEndLoc = this.lastTokStartLoc = null), (this.lastTokStart = this.lastTokEnd = this.pos), (this.context = [
                U.braceStatement
          ...
          J = function J(t) {
            (this.type = t.type), (this.value = t.value), (this.start =
              t.start), (this.end = t.end), (this.loc = new K(
              t.startLoc,
              t.endLoc
            ));
          },
          z = (function(t) {
            ...
            (function(t) {
              function e(e, s) {
                var i;
                return (i =
                  t.call(this) || this), (i.state = new G()), i.state.init(
                  e,
                  s
                ), (i.isLookahead = !1), i;
              }
              return A(e, t), (e.prototype.next = function() {
                this.options.tokens &&
                  ...
                  this.state.tokens.push(
                    new J(this.state)
                  ), (this.state.lastTokEnd = this.state.end), (this.state.lastTokStart = this.state.start), (this.state.lastTokEndLoc = this.state.endLoc), (this.state.lastTokStartLoc = this.state.startLoc), this.nextToken();
                ...
                (this.state = t.clone(
                  !0
                )), (this.isLookahead = !0), this.next(), (this.isLookahead = !1);
                var e = this.state;
                ...
                return (t && t.preserveSpace) ||
                  this.skipSpace(), (this.state.containsOctal = !1), (this.state.octalPosition = null), (this.state.start = this.state.pos), (this.state.startLoc = this.state.curPosition()), this
                  .state.pos >= this.input.length
                ...
                this.isLookahead ||
                  (
                    this.options.tokens && this.state.tokens.push(n),
                ...
                -1 === s &&
                  ...
                  ), (this.state.pos = s + 2), (B.lastIndex = e);
                for (
                  var i = void 0;
                  (i = B.exec(this.input)) && i.index < this.state.pos;
                ...
                t: for (; this.state.pos < this.input.length; ) {
                  ...
                  switch (t) {
                    ...
                    case 8232:
                    case 8233:
                      ++this.state.pos, ++this.state
                        .curLine, (this.state.lineStart = this.state.pos);
                      break;
                    case 47:
                    ...
                    default:
                      if (
                        !(
                          (t > 8 && t < 14) ||
                          (t >= 5760 && q.test(String.fromCharCode(t)))
                        )
                      )
                        break t;
                      ++this.state.pos;
                ...
                return 42 === t &&
                  ...
                  (
                    ...
                    (e = C.exponent)
                  ), 61 === i && (s++, (e = C.assign)), this.finishOp(e, s);
                ...
                switch (t) {
                  case 35:
                    if (
                      ...
                      return ++this.state.pos, this.finishToken(C.hash);
                    this.raise(
                      this.state.pos,
                      "Unexpected character '" + c(t) + "'"
                    );
                  case 46:
                  ...
                  case 126:
                    return this.finishOp(C.tilde, 1);
                }
                this.raise(
                  this.state.pos,
                  "Unexpected character '" + c(t) + "'"
                ...
                return a &&
                  (/^[gmsiyu]*$/.test(a) ||
                    ...
                    )), this.finishToken(C.regexp, { pattern: r, flags: a });
              }), (e.prototype.readInt = function(t, e) {
                for (
                  var s = this.state.pos,
                    i = 16 === t ? H.hex : H.decBinOct,
                    r = 0,
                    a = 0,
                    n = null == e ? 1 / 0 : e;
                  a < n;
                  ...
                  if (this.hasPlugin("numericSeparator")) {
                    ...
                    if (95 === o) {
                      (i.indexOf(p) > -1 ||
                        ...
                        this.raise(
                          this.state.pos,
                          "Invalid NumericLiteralSeparator"
                        ), ++this.state.pos;
                      continue;
                    }
                  }
                  if (
                    (h =
                      o >= 97
                        ...
                        : o >= 65
                          ? o - 65 + 10
                          : o >= 48 && o <= 57 ? o - 48 : 1 / 0) >= t
                  )
                    break;
                  ++this.state.pos, (r = r * t + h);
                }
                ...
                if (
                  ...
                  var r = this.input
                    ...
                    .replace(/[_n]/g, "");
                  return this.finishToken(C.bigint, r);
                }
                ...
                46 !== n ||
                  ...
                  s ||
                  (
                    (43 !== (n = this.input.charCodeAt(++this.state.pos)) &&
                      45 !== n) ||
                      ++this.state.pos,
                    null === this.readInt(10) &&
                  ...
                  110 === n &&
                  (
                    (i || s) && this.raise(e, "Invalid BigIntLiteral"),
                    ++this.state.pos,
                    (r = !0)
                  ), a(this.fullCharCodeAtPos()) &&
                  this.raise(
                ...
                var o = this.input
                  .slice(e, this.state.pos)
                  .replace(/[_n]/g, "");
                if (r) return this.finishToken(C.bigint, o);
                var h = void 0;
                return i
                  ? (h = parseFloat(o))
                  : s && 1 !== o.length
                    ? this.state.strict
                      ? this.raise(e, "Invalid number")
                      : (h = /[89]/.test(o) ? parseInt(o, 10) : parseInt(o, 8))
                    : (h = parseInt(o, 10)), this.finishToken(C.num, h);
                ...
                if (123 === this.input.charCodeAt(this.state.pos)) {
                  ...
                  if (
                    ...
                    if (!t)
                      return (this.state.invalidTemplateEscapePosition =
                        s - 2), null;
                ...
                for (var t = "", e = this.state.pos, s = !1; ; ) {
                  ...
                  if (92 === i) {
                    ...
                    ++this.state
                      .curLine, (this.state.lineStart = this.state.pos), (e = this
                      .state.pos);
                  } else ++this.state.pos;
                }
                ...
                switch ((++this.state.pos, s)) {
                  ...
                  case 13:
                    10 === this.input.charCodeAt(this.state.pos) &&
                      ++this.state.pos;
                  case 10:
                    return (this.state.lineStart = this.state.pos), ++this.state
                      .curLine, "";
                  default:
                    if (s >= 48 && s <= 55) {
                      ...
                      if (
                        (
                          o > 255 &&
                            ((n = n.slice(0, -1)), (o = parseInt(n, 8))),
                          o > 0
                        )
                      ) {
                        if (t)
                          return (this.state.invalidTemplateEscapePosition = a), null;
                        this.state.strict
                      ...
                      return (this.state.pos +=
                        n.length - 1), String.fromCharCode(o);
                    }
                ...
                for (
                  ...
                  if (n(i)) this.state.pos += i <= 65535 ? 1 : 2;
                  else {
                    if (92 !== i) break;
                    (this.state.containsEsc = !0), (t += this.input.slice(
                      s,
                      this.state.pos
                    ));
                    ...
                    (e ? a : n)(o, !0) ||
                      this.raise(r, "Invalid Unicode escape"), (t += c(
                      o
                    )), (s = this.state.pos);
                  }
                  e = !1;
                ...
                if (t === C.colon) {
                  ...
                  if (e === U.braceStatement || e === U.braceExpression)
                    return !e.isExpr;
                }
                return t === C._return
                  ? F.test(
                  ...
                  : t === C._else ||
                    ...
                    (t === C.braceL
                      ? this.curContext() === U.braceStatement
                      : t === C.relational || !this.state.exprAllowed);
          ...
          Y = (function() {
            function t(t, e, s) {
              (this.type =
                ""), (this.start = e), (this.end = 0), (this.loc = new K(
                s
              )), t && t.options.ranges && (this.range = [e, 0]), t &&
                t.filename &&
          ...
          st = (function(t) {
            function e(e, i) {
              var r;
              return (e = s(e)), (r =
                t.call(this, e, i) || this), (r.options = e), (r.inModule =
                "module" ===
                r.options.sourceType), (r.input = i), (r.plugins = l(
                r.options.plugins
              )), (r.filename = e.sourceFilename), 0 === r.state.pos &&
                "#" === r.input[0] &&
                "!" === r.input[1] &&
                r.skipLineComment(2), r;
            }
            ...
            (function(t) {
              ...
              return A(e, t), (e.prototype.parseTopLevel = function(t, e) {
                return (e.sourceType = this.options.sourceType), this.parseBlockBody(
                  e,
                  !0,
                  !0,
                  C.eof
                ), (t.program = this.finishNode(
                  e,
                  "Program"
                )), (t.comments = this.state.comments), this.options.tokens &&
                  (t.tokens = this.state.tokens), this.finishNode(t, "File");
                ...
                return this.addExtra(s, "raw", r), this.addExtra(
                  s,
                  "rawValue",
                  a
                ...
                return this.match(C.at) &&
                  this.parseDecorators(!0), this.parseStatementContent(t, e);
                ...
                switch (s) {
                  ...
                  case C._function:
                    if (this.lookahead().type === C.dot) break;
                    return t || this.unexpected(), this.parseFunctionStatement(
                      i
                    );
                  case C._class:
                  ...
                  case C.name:
                    if ("async" === this.state.value) {
                      ...
                      if (
                        ...
                        return this.expect(C._function), this.parseFunction(
                          i,
                          !0,
                          !1,
                          !0
                ...
                var e = this.state.decoratorStack[
                ...
                this.hasPlugin("decorators2") && (t = !1);
                for (
                  var e = this.state.decoratorStack[
                    this.state.decoratorStack.length - 1
                  ];
                ...
                var t = this.startNode();
                if ((this.next(), this.hasPlugin("decorators2"))) {
                  for (
                    var e = this.state.start,
                      s = this.state.startLoc,
                      i = this.parseIdentifier(!1);
                    this.eat(C.dot);

                  ) {
                    var r = this.startNodeAt(e, s);
                    (r.object = i), (r.property = this.parseIdentifier(
                      !0
                    )), (r.computed = !1), (i = this.finishNode(
                      r,
                      "MemberExpression"
                    ));
                  }
                  if (this.eat(C.parenL)) {
                    ...
                    (a.callee = i), this.state.decoratorStack.push(
                      []
                    ), (a.arguments = this.parseCallExpressionArguments(
                      C.parenR,
                      !1
                    )), this.state.decoratorStack.pop(), (i = this.finishNode(
                      a,
                      "CallExpression"
                ...
                var s = "break" === e;
                this.next(), this.isLineTerminator()
                  ? (t.label = null)
                  : this.match(C.name)
                ...
                return i === this.state.labels.length &&
                  this.raise(t.start, "Unsyntactic " + e), this.finishNode(
                  t,
                  s ? "BreakStatement" : "ContinueStatement"
                );
              }), (e.prototype.parseDebuggerStatement = function(t) {
                return this.next(), this.semicolon(), this.finishNode(
                  t,
                  "DebuggerStatement"
                );
                ...
                return this.next(), this.state.labels.push(
                  ...
                  !1
                )), this.state.labels.pop(), this.expect(
                  C._while
                ), (t.test = this.parseParenExpression()), this.eat(
                  C.semi
                ...
                if (
                  ...
                  var s = this.startNode(),
                    i = this.state.type;
                  return this.next(), this.parseVar(s, !0, i), this.finishNode(
                    s,
                    "VariableDeclaration"
                ...
                if (this.match(C._in) || this.isContextual("of")) {
                  var n = this.isContextual("of")
                    ? "for-of statement"
                    : "for-in statement";
                  return this.toAssignable(a, void 0, n), this.checkLVal(
                    a,
                    void 0,
                    void 0,
                    n
                ...
                return r.start && this.unexpected(r.start), e &&
                  this.unexpected(), this.parseFor(t, a);
                ...
                return this.next(), (t.test = this.parseParenExpression()), (t.consequent = this.parseStatement(
                  ...
                  : null), this.finishNode(t, "IfStatement");
              }), (e.prototype.parseReturnStatement = function(t) {
                return this.state.inFunction ||
                ...
                var e = (t.cases = []);
                this.expect(C.braceL), this.state.labels.push(tt);
                for (var s, i = void 0; !this.match(C.braceR); ) {
                  if (this.match(C._case) || this.match(C._default)) {
                    var r = this.match(C._case);
                    i && this.finishNode(i, "SwitchCase"), e.push(
                      (i = this.startNode())
                    ), (i.consequent = []), this.next(), r
                    ...
                    i
                      ? i.consequent.push(this.parseStatement(!0))
                      : this.unexpected();
                }
                return i &&
                  this.finishNode(
                    i,
                    "SwitchCase"
                  ), this.next(), this.state.labels.pop(), this.finishNode(
                  t,
                  "SwitchStatement"
                );
              }), (e.prototype.parseThrowStatement = function(t) {
                return this.next(), F.test(
                  this.input.slice(this.state.lastTokEnd, this.state.start)
                ) &&
                  this.raise(
                    this.state.lastTokEnd,
                    "Illegal newline after throw"
                  ), (t.argument = this.parseExpression()), this.semicolon(), this.finishNode(
                  t,
                  "ThrowStatement"
                );
                ...
                if (
                  ...
                  this.next(), this.match(C.parenL)
                    ...
                    : (
                        ...
                        (e.param = null)
                      ), (e.body = this.parseBlock()), (t.handler = this.finishNode(
                    e,
                    "CatchClause"
                  ));
                }
                return (t.guardedHandlers = $), (t.finalizer = this.eat(
                  C._finally
                )
                  ? this.parseBlock()
                  : null), t.handler ||
                ...
                return this.next(), this.parseVar(
                  ...
                  !1,
                  e
                ), this.semicolon(), this.finishNode(t, "VariableDeclaration");
              }), (e.prototype.parseWhileStatement = function(t) {
                return this.next(), (t.test = this.parseParenExpression()), this.state.labels.push(
                  Z
                ), (t.body = this.parseStatement(
                  !1
                )), this.state.labels.pop(), this.finishNode(
                  t,
                  "WhileStatement"
                );
                ...
                return this.state.strict &&
                  this.raise(
                    this.state.start,
                    "'with' in strict mode"
                  ), this.next(), (t.object = this.parseParenExpression()), (t.body = this.parseStatement(
                  !1
                ...
                for (
                  var o = this.state.type.isLoop
                      ? "loop"
                      : this.match(C._switch) ? "switch" : null,
                  ...
                  (p.statementStart = this.state.start), (p.kind = o);
                }
                return this.state.labels.push({
                  name: e,
                  kind: o,
                  statementStart: this.state.start
                }), (t.body = this.parseStatement(!0)), ("ClassDeclaration" ==
                  t.body.type ||
                  ("VariableDeclaration" == t.body.type &&
                    "var" !== t.body.kind) ||
                  ("FunctionDeclaration" == t.body.type &&
                    (this.state.strict || t.body.generator || t.body.async))) &&
                  this.raise(
                    t.body.start,
                    "Invalid labeled declaration"
                  ), this.state.labels.pop(), (t.label = s), this.finishNode(
                  t,
                  "LabeledStatement"
                );
              }), (e.prototype.parseExpressionStatement = function(t, e) {
                return (t.expression = e), this.semicolon(), this.finishNode(
                  t,
                  "ExpressionStatement"
                );
              }), (e.prototype.parseBlock = function(t) {
                var e = this.startNode();
                return this.expect(C.braceL), this.parseBlockBody(
                  e,
                  t,
                  !1,
                  C.braceR
              ...
              }), (e.prototype.parseBlockOrModuleBlockBody = function(
                t,
                e,
                s,
                i
                ...
                return (t.init = e), this.expect(C.semi), (t.test = this.match(
                  C.semi
                )
                  ? null
                  : this.parseExpression()), this.expect(
                  C.semi
                ), (t.update = this.match(C.parenR)
                  ? null
                  : this.parseExpression()), this.expect(
                  C.parenR
                ), (t.body = this.parseStatement(
                ...
                var i = this.match(C._in) ? "ForInStatement" : "ForOfStatement";
                return s
                  ? this.eatContextual("of")
                  : this.next(), "ForOfStatement" === i &&
                  (t.await = !!s), (t.left = e), (t.right = this.parseExpression()), this.expect(
                  C.parenR
                ), (t.body = this.parseStatement(
                  !1
                )), this.state.labels.pop(), this.finishNode(t, i);
                ...
                for (t.kind = s.keyword; ; ) {
                  ...
                  if (
                    (
                      ...
                      i.push(this.finishNode(r, "VariableDeclarator")),
                      !this.eat(C.comma)
                    )
                  )
                    break;
                ...
                (t.id = this.parseBindingAtom()), this.checkLVal(
                  t.id,
                  !0,
                  void 0,
                ...
                return (this.state.inMethod = !1), this.initFunction(
                  t,
                  i
                ), this.match(C.star) &&
                  (
                    t.async && this.expectPlugin("asyncGenerators"),
                    (t.generator = !0),
                    this.next()
                  ), !e ||
                  r ||
                  this.match(C.name) ||
                  this.match(C._yield) ||
                  this.unexpected(), (this.match(C.name) ||
                  this.match(C._yield)) &&
                  (t.id = this.parseBindingIdentifier()), this.parseFunctionParams(
                  t
                ), this.parseFunctionBodyAndFinish(
                  t,
                  e ? "FunctionDeclaration" : "FunctionExpression",
                  s
                ), (this.state.inMethod = a), t;
              }), (e.prototype.parseFunctionParams = function(t) {
                this.expect(C.parenL), (t.params = this.parseBindingList(
                  C.parenR
                ));
              }), (e.prototype.parseClass = function(t, e, s) {
                return this.next(), this.takeDecorators(t), this.parseClassId(
                  t,
                  e,
                  s
                ), this.parseClassSuper(t), this.parseClassBody(
                  t
                ), this.finishNode(
                  t,
                ...
                return (
                  this.match(C.eq) || this.match(C.semi) || this.match(C.braceR)
                );
                ...
                var s = { hadConstructor: !1 },
                  i = [],
                  r = this.startNode();
                for (
                  r.body = [], this.expect(C.braceL);
                  !this.eat(C.braceR);
                  ...
                  if (this.eat(C.semi))
                    ...
                    i.length &&
                      (
                        (a.decorators = i),
                        this.resetStartLocationFromNode(a, i[0]),
                        (i = [])
                      ), this.parseClassMember(r, a, s), this.hasPlugin(
                      "decorators2"
                    ) &&
                      "method" != a.kind &&
                      a.decorators &&
                ...
                i.length &&
                  ...
                  ), (t.body = this.finishNode(r, "ClassBody")), this.state
                  .classLevel--, (this.state.strict = e);
              }), (e.prototype.parseClassMember = function(t, e, s) {
                var i = e,
                  r = i,
                  a = i,
                  n = !1;
                if (this.match(C.name) && "static" === this.state.value) {
                  var o = this.parseIdentifier(!0);
                  if (this.isClassMethod())
                    return (r.kind =
                      "method"), (r.computed = !1), (r.key = o), (r.static = !1), void this.parseClassMethod(
                      t,
                      r,
                      !1,
                      !1,
                  ...
                  if (this.isClassProperty())
                    return (a.computed = !1), (a.key = o), (a.static = !1), void t.body.push(
                      this.parseClassProperty(a)
                    );
                  n = !0;
                }
                if (this.match(C.hash)) {
                  this.expectPlugin("classPrivateProperties"), this.next();
                  var h = i;
                  return (h.key = this.parseIdentifier(
                    !0
                  )), (h.static = n), void t.body.push(
                    this.parsePrivateClassProperty(h)
                  );
                }
                this.parseClassMemberWithIsStatic(t, e, s, n);
              }), (e.prototype.parseClassMemberWithIsStatic = function(
                t,
                e,
                s,
                i
                ...
                var r = e,
                  ...
                  n = r,
                  o = r;
                if (((a.static = i), this.eat(C.star)))
                  return (n.kind = "method"), this.parsePropertyName(
                    n
                    ...
                    ), void this.parseClassMethod(t, n, !0, !1, !1);
                var h = this.match(C.name),
                  p = this.parseClassPropertyName(a);
                if (
                  (this.parsePostMemberNameModifiers(a), this.isClassMethod())
                ) {
                  var c = this.isNonstaticConstructor(n);
                  (n.kind = c ? "constructor" : "method"), c &&
                    (
                      n.decorators &&
                        this.raise(
                          n.start,
                      ...
                      (s.hadConstructor = !0)
                    ), this.parseClassMethod(t, n, !1, !1, c);
                } else if (this.isClassProperty()) this.pushClassProperty(t, o);
                else if (h && "async" === p.name && !this.isLineTerminator()) {
                  var l = !1;
                  this.match(C.star) &&
                    (
                      this.expectPlugin("asyncGenerators"),
                      this.next(),
                      (l = !0)
                    ), (n.kind = "method"), this.parsePropertyName(
                    n
                  ), this.isNonstaticConstructor(n) &&
                    this.raise(
                      n.key.start,
                      "Constructor can't be an async function"
                    ), this.parseClassMethod(t, n, l, !0, !1);
                } else
                  !h ||
                  ...
                  (this.isLineTerminator() && this.match(C.star))
                    ? this.isLineTerminator()
                      ? (
                          ...
                          t.body.push(this.parseClassProperty(o))
                        )
                      : this.unexpected()
                    : (
                        (n.kind = p.name),
                        ...
                        this.parseClassMethod(t, n, !1, !1, !1),
                ...
                return t.computed ||
                  !t.static ||
                  ("prototype" !== t.key.name && "prototype" !== t.key.value) ||
                  this.raise(
                    t.key.start,
                    "Classes may not have static property named prototype"
                  ), e;
              }), (e.prototype.pushClassProperty = function(t, e) {
                this.isNonstaticConstructor(e) &&
                  this.raise(
                    e.key.start,
                    "Classes may not have a non-static field named 'constructor'"
                  ), t.body.push(this.parseClassProperty(e));
              }), (e.prototype.parsePostMemberNameModifiers = function(
                t
              ) {}), (e.prototype.parseAccessModifier = function() {}), (e.prototype.parsePrivateClassProperty = function(
                t
              ) {
                return (this.state.inClassProperty = !0), this.match(C.eq)
                  ? (this.next(), (t.value = this.parseMaybeAssign()))
                  : (t.value = null), this.semicolon(), (this.state.inClassProperty = !1), this.finishNode(
                  t,
                ...
                return t.typeAnnotation ||
                  this.expectPlugin(
                    "classProperties"
                  ), (this.state.inClassProperty = !0), this.match(C.eq)
                  ? (
                ...
                if (this.shouldParseExportStar()) {
                  ...
                  if (
                    ...
                    this.expect(C.star), this.expectContextual(
                      "as"
                    ), (i.exported = this.parseIdentifier()), s.push(
                  ...
                  if (this.eat(C._default)) {
                    var r = this.startNode(),
                      a = !1;
                    return this.eat(C._function)
                      ? (r = this.parseFunction(r, !0, !1, !1, !0))
                      : this.isContextual("async") &&
                        this.lookahead().type === C._function
                        ? (
                            this.eatContextual("async"),
                            this.eat(C._function),
                            (r = this.parseFunction(r, !0, !1, !0, !0))
                          )
                        : this.match(C._class)
                      ...
                      this.semicolon(), this.checkExport(
                      t,
                      !0,
                      !0
                  ...
                  if (this.shouldParseExportDeclaration()) {
                    ...
                    (t.specifiers = []), (t.source = null), (t.declaration = this.parseExportDeclaration(
                      t
                    ));
                  } else
                    (t.declaration = null), (t.specifiers = this.parseExportSpecifiers()), this.parseExportFrom(
                      t
                    );
                }
                return this.checkExport(t, !0), this.finishNode(
                  t,
                ...
                return (
                  t.type === C.comma ||
                  (t.type === C.name && "from" === t.value)
                );
              }), (e.prototype.parseExportSpecifiersMaybe = function(t) {
                this.eat(C.comma) &&
                  (t.specifiers = t.specifiers.concat(
                ...
                this.eatContextual("from")
                  ...
                  : e ? this.unexpected() : (t.source = null), this.semicolon();
              }), (e.prototype.shouldParseExportStar = function() {
                return this.match(C.star);
              }), (e.prototype.parseExportStar = function(t, e) {
                if ((this.expect(C.star), e && this.isContextual("as"))) {
                  var s = this.startNodeAt(
                    this.state.lastTokStart,
                    this.state.lastTokStartLoc
                  );
                  this.next(), (s.exported = this.parseIdentifier(
                    !0
                  )), (t.specifiers = [
                    this.finishNode(s, "ExportNamespaceSpecifier")
                  ]), this.parseExportSpecifiersMaybe(t), this.parseExportFrom(
                    t,
                    !0
                  );
                } else
                  this.parseExportFrom(t, !0), this.finishNode(
                    t,
                ...
                this.state.exportedIdentifiers.indexOf(e) > -1 &&
                  this.raiseDuplicateExportError(
                    t,
                    e
                ...
                return this.match(C.string)
                  ...
                  : (
                      ...
                      (t.source = this.match(C.string)
                        ? this.parseExprAtom()
                        : this.unexpected())
                    ), this.semicolon(), this.finishNode(
                  t,
                  "ImportDeclaration"
                );
                ...
                if (this.match(C.star)) {
                  var r = this.startNode();
                  return this.next(), this.expectContextual(
                    "as"
                  ), (r.local = this.parseIdentifier()), this.checkLVal(
                    r.local,
                    !0,
                    void 0,
                ...
                var e = this.startNode();
                (e.imported = this.parseIdentifier(!0)), this.eatContextual(
                  "as"
                )
                ...
                return (i.local = t), this.checkLVal(
                  i.local,
                  !0,
                  void 0,
              ...
              (function(t) {
                ...
                return A(e, t), (e.prototype.checkPropClash = function(t, e) {
                  ...
                  return this.match(C.eof) ||
                    this.unexpected(), (t.comments = this.state.comments), t;
                  ...
                  var o = void 0;
                  e ? (o = !1) : ((e = { start: 0 }), (o = !0)), (this.match(
                    C.parenL
                  ) ||
                    this.match(C.name)) &&
                  ...
                  if (
                    (s && (h = s.call(this, h, r, a)), this.state.type.isAssign)
                  ) {
                    var p = this.startNodeAt(r, a);
                    if (
                      (
                        (p.operator = this.state.value),
                        (p.left = this.match(C.eq)
                          ? this.toAssignable(
                              h,
                              void 0,
                    ...
                    return this.next(), (p.right = this.parseMaybeAssign(
                      t
                  ...
                  return "ArrowFunctionExpression" === n.type && n.start === a
                    ? n
                    : e && e.start ? n : this.parseConditional(n, t, i, r, s);
                }), (e.prototype.parseConditional = function(t, e, s, i, r) {
                  if (this.eat(C.question)) {
                    var a = this.startNodeAt(s, i);
                    return (a.test = t), (a.consequent = this.parseMaybeAssign()), this.expect(
                      C.colon
                  ...
                  return "ArrowFunctionExpression" === a.type && a.start === r
                    ? a
                    : e && e.start ? a : this.parseExprOp(a, s, i, -1, t);
                  ...
                  if (!(null == a || (r && this.match(C._in))) && a > i) {
                    ...
                    return (n.right = this.parseExprOp(
                  ...
                  for (
                    ...
                    (h.operator = this.state.value), (h.prefix = !1), (h.argument = o), this.checkLVal(
                      o,
                      void 0,
                      void 0,
                      "postfix operation"
                    ), this.next(), (o = this.finishNode(
                      h,
                      "UpdateExpression"
                    ));
                  }
                  ...
                  return "ArrowFunctionExpression" === r.type && r.start === i
                    ? r
                    : t && t.start ? r : this.parseSubscripts(r, e, s);
                  ...
                  if (!i && this.eat(C.doubleColon)) {
                    var a = this.startNodeAt(e, s);
                    return (a.object = t), (a.callee = this.parseNoCallExpr()), (r.stop = !0), this.parseSubscripts(
                  ...
                  if (this.match(C.questionDot)) {
                    if (
                      (
                        ...
                        i && this.lookahead().type == C.parenL
                      )
                    )
                      return (r.stop = !0), t;
                    this.next();
                    ...
                    if (this.eat(C.bracketL))
                      return (n.object = t), (n.property = this.parseExpression()), (n.computed = !0), (n.optional = !0), this.expect(
                        C.bracketR
                      ), this.finishNode(n, "MemberExpression");
                    if (this.eat(C.parenL)) {
                      var o = this.atPossibleAsync(t);
                      return (n.callee = t), (n.arguments = this.parseCallExpressionArguments(
                        C.parenR,
                        o
                      )), (n.optional = !0), this.finishNode(
                        n,
                        "CallExpression"
                      );
                    }
                    return (n.object = t), (n.property = this.parseIdentifier(
                      !0
                    )), (n.computed = !1), (n.optional = !0), this.finishNode(
                      n,
                      "MemberExpression"
                    );
                  }
                  if (this.eat(C.dot)) {
                    ...
                    return (h.object = t), (h.property = this.hasPlugin(
                      "classPrivateProperties"
                    )
                      ? this.parseMaybePrivateName()
                      : this.parseIdentifier(
                          !0
                        )), (h.computed = !1), this.finishNode(
                      h,
                      "MemberExpression"
                    );
                  }
                  if (this.eat(C.bracketL)) {
                    ...
                    return (p.object = t), (p.property = this.parseExpression()), (p.computed = !0), this.expect(
                      C.bracketR
                    ), this.finishNode(p, "MemberExpression");
                  }
                  if (!i && this.match(C.parenL)) {
                    var c = this.atPossibleAsync(t);
                    this.next();
                    var l = this.startNodeAt(e, s);
                    l.callee = t;
                    var u = { start: -1 };
                    return (l.arguments = this.parseCallExpressionArguments(
                      C.parenR,
                      c,
                      u
                    )), this.finishCallExpression(l), c &&
                    this.shouldParseAsyncArrow()
                      ...
                      : (this.toReferencedList(l.arguments), l);
                  }
                  if (this.match(C.backQuote)) {
                    var d = this.startNodeAt(e, s);
                    return (d.tag = t), (d.quasi = this.parseTemplate(
                      !0
                  ...
                  if ("Import" === t.callee.type) {
                    ...
                    e &&
                      ...
                      this.raise(e.start, "... is not allowed in import()");
                  }
                  return this.finishNode(t, "CallExpression");
                }), (e.prototype.parseCallExpressionArguments = function(
                  t,
                  e,
                  s
                ) {
                ...
                }), (e.prototype.parseAsyncArrowFromCallExpression = function(
                  t,
                  e
                ) {
                  return this.expect(C.arrow), this.parseArrowExpression(
                    t,
                    e.arguments,
                    !0
                  );
                  ...
                  switch (this.state.type) {
                    case C._super:
                      return this.state.inMethod ||
                        this.state.inClassProperty ||
                        this.options.allowSuperOutsideMethod ||
                        this.raise(
                          this.state.start,
                          "'super' outside of function or class"
                        ), (s = this.startNode()), this.next(), this.match(
                        C.parenL
                      ) ||
                        this.match(C.bracketL) ||
                        this.match(C.dot) ||
                        this.unexpected(), this.match(C.parenL) &&
                    ...
                    case C._import:
                      return this.lookahead().type === C.dot
                        ...
                        : (
                            ...
                            this.next(),
                            this.match(C.parenL) ||
                              this.unexpected(null, C.parenL),
                            this.finishNode(s, "Import")
                          );
                    case C._this:
                      return (s = this.startNode()), this.next(), this.finishNode(
                        s,
                        "ThisExpression"
                      );
                    case C._yield:
                    ...
                    case C.name:
                      s = this.startNode();
                      var i =
                          "await" === this.state.value && this.state.inAsync,
                      ...
                      if ("await" === a.name) {
                        ...
                        if (e && "async" === a.name && this.match(C.name)) {
                          ...
                          return this.expect(
                            C.arrow
                          ), this.parseArrowExpression(s, n, !0);
                        }
                      }
                      return e &&
                      !this.canInsertSemicolon() &&
                    ...
                    case C._do:
                      ...
                      var h = this.state.inFunction,
                        p = this.state.labels;
                      return (this.state.labels = []), (this.state.inFunction = !1), (o.body = this.parseBlock(
                        !1
                      )), (this.state.inFunction = h), (this.state.labels = p), this.finishNode(
                        o,
                        "DoExpression"
                      );
                    case C.regexp:
                      ...
                      return (s = this.parseLiteral(
                        c.value,
                        "RegExpLiteral"
                      )), (s.pattern = c.pattern), (s.flags = c.flags), s;
                    case C.num:
                    ...
                    case C.bracketL:
                      return (s = this.startNode()), this.next(), (s.elements = this.parseExprList(
                        ...
                        !0,
                        t
                      )), this.toReferencedList(s.elements), this.finishNode(
                        s,
                        "ArrayExpression"
                      );
                    case C.braceL:
                    ...
                    case C._class:
                      return (s = this.startNode()), this.takeDecorators(
                        s
                      ), this.parseClass(s, !1);
                    case C._new:
                    ...
                    case C.doubleColon:
                      ...
                      var l = (s.callee = this.parseNoCallExpr());
                      if ("MemberExpression" === l.type)
                  ...
                  var t = this.startNode();
                  return (t.value = this.match(
                    C._true
                  )), this.next(), this.finishNode(t, "BooleanLiteral");
                }), (e.prototype.parseMaybePrivateName = function() {
                  if (this.eat(C.hash)) {
                    var t = this.startNode();
                    return (t.id = this.parseIdentifier(!0)), this.finishNode(
                      t,
                      "PrivateName"
                    );
                  }
                  ...
                  var t = this.startNode(),
                    e = this.parseIdentifier(!0);
                  return this.expect(C.dot), "import" === e.name &&
                  ...
                  return this.addExtra(r, "rawValue", t), this.addExtra(
                    r,
                    "raw",
                    this.input.slice(s, this.state.end)
                  ), (r.value = t), this.next(), this.finishNode(r, e);
                }), (e.prototype.parseParenExpression = function() {
                  this.expect(C.parenL);
                  var t = this.parseExpression();
                  return this.expect(C.parenR), t;
                }), (e.prototype.parseParenAndDistinguishExpression = function(
                  t
                ) {
                  var e = this.state.start,
                    s = this.state.startLoc,
                  ...
                  for (
                    ...
                    if (p) p = !1;
                      ...
                      (
                        this.expect(C.comma, h.start || null),
                        this.match(C.parenR)
                      )
                    ) {
                      l = this.state.start;
                    ...
                    if (this.match(C.ellipsis)) {
                      ...
                      (c = this.state.start), n.push(
                        this.parseParenItem(this.parseRest(), u, d)
                      ), this.match(C.comma) &&
                        this.lookahead().type === C.parenR &&
                        this.raise(
                          this.state.start,
                          "A trailing comma is not permitted after the rest element"
                        );
                    ...
                    n.push(
                      this.parseMaybeAssign(!1, o, this.parseParenItem, h)
                    );
                  }
                  ...
                  if (
                    ...
                    for (var x = 0; x < n.length; x++) {
                      var v = n[x];
                      v.extra &&
                        v.extra.parenthesized &&
                        this.unexpected(v.extra.parenStart);
                    }
                    return this.parseArrowExpression(m, n);
                  }
                  return n.length ||
                    this.unexpected(this.state.lastTokStart), l &&
                    this.unexpected(l), c && this.unexpected(c), o.start &&
                    this.unexpected(o.start), h.start &&
                    this.unexpected(h.start), n.length > 1
                    ? (
                        ((i = this.startNodeAt(r, a)).expressions = n),
                        this.toReferencedList(i.expressions),
                        this.finishNodeAt(i, "SequenceExpression", f, y)
                      )
                    : (i = n[0]), this.addExtra(
                    i,
                    "parenthesized",
                    !0
                  ), this.addExtra(i, "parenStart", e), i;
                  ...
                  return (t.callee = this.parseNoCallExpr()), this.eat(
                    C.questionDot
                  ) && (t.optional = !0), this.parseNewArguments(
                    t
                  ), this.finishNode(t, "NewExpression");
                }), (e.prototype.parseNewArguments = function(t) {
                  if (this.eat(C.parenL)) {
                    var e = this.parseExprList(C.parenR);
                  ...
                  for (e.quasis = [s]; !s.tail; ) {
                    this.expect(C.dollarBraceL), e.expressions.push(
                      this.parseExpression()
                    ), this.expect(C.braceR), e.quasis.push(
                  ...
                  for (var n = null; !this.eat(C.braceR); ) {
                    ...
                    if (
                      ...
                      if (
                        (
                          ...
                          (o = this.parseSpread(t ? { start: 0 } : void 0)),
                          t && this.toAssignable(o, !0, "object pattern"),
                          a.properties.push(o),
                          !t
                        )
                      )
                    ...
                    if (
                      (
                        (o.method = !1),
                        (t || e) &&
                          ((c = this.state.start), (l = this.state.startLoc)),
                        t || (h = this.eat(C.star)),
                    ...
                    this.parseObjPropValue(
                      ...
                      t,
                      e
                    ), this.checkPropClash(o, i), o.shorthand &&
                      this.addExtra(o, "shorthand", !0), a.properties.push(o);
                  }
                  return null !== n &&
                    this.unexpected(
                      n,
                  ...
                  return s || e || this.match(C.parenL)
                    ? (
                        ...
                        (t.kind = "method"),
                        (t.method = !0),
                        this.parseMethod(t, e, s, !1, "ObjectMethod")
                      )
                ...
                }), (e.prototype.parseObjPropValue = function(
                  t,
                  e,
                  s,
                  i,
                  ...
                  if (this.eat(C.bracketL))
                    (t.computed = !0), (t.key = this.parseMaybeAssign()), this.expect(
                      C.bracketR
                    );
                  else {
                    t.computed = !1;
                    var e = this.state.inPropertyName;
                    (this.state.inPropertyName = !0), (t.key =
                      this.match(C.num) || this.match(C.string)
                        ? this.parseExprAtom()
                        : this.parseIdentifier(
                            !0
                  ...
                  var a = this.state.inMethod;
                  (this.state.inMethod = t.kind || !0), this.initFunction(
                    t,
                    s
                  ), this.expect(C.parenL);
                  var n = i;
                  return (t.params = this.parseBindingList(
                    C.parenR,
                    !1,
                    n
                  )), (t.generator = !!e), this.parseFunctionBodyAndFinish(
                    t,
                    r
                  ), (this.state.inMethod = a), t;
                  ...
                  )), this.parseFunctionBody(t, !0), this.finishNode(
                    t,
                  ...
                  return !1;
                }), (e.prototype.parseFunctionBodyAndFinish = function(
                  t,
                  e,
                  s
                ) {
                  ...
                  if (((this.state.inAsync = t.async), s))
                    ...
                    var r = this.state.inFunction,
                      ...
                      n = this.state.labels;
                    (this.state.inFunction = !0), (this.state.inGenerator =
                      t.generator), (this.state.labels = []), (t.body = this.parseBlock(
                      !0
                    )), (t.expression = !1), (this.state.inFunction = r), (this.state.inGenerator = a), (this.state.labels = n);
                  }
                  ...
                  if (
                    ...
                    var p = Object.create(null),
                      c = this.state.strict;
                    o && (this.state.strict = !0), t.id &&
                      this.checkLVal(t.id, !0, void 0, "function name");
                    for (
                      var l = t.params,
                        u = Array.isArray(l),
                        d = 0,
                        l = u ? l : l[Symbol.iterator]();
                      ;
                      ...
                      o &&
                        ...
                        ), this.checkLVal(y, !0, p, "function parameter list");
                    }
                    this.state.strict = c;
                  }
                  ...
                  return (e.name = s), (e.loc.identifierName = s), this.finishNode(
                    e,
                    "Identifier"
                  );
                  ...
                  var s = void 0;
                  if (this.match(C.name)) s = this.state.value;
                  else {
                  ...
                  (this.isReservedWord(t) || (s && this.isKeyword(t))) &&
                    this.raise(e, t + " is a reserved word"), this.state
                    .strict &&
                    (L.strict(t) || (i && L.strictBind(t))) &&
                    this.raise(e, t + " is a reserved word in strict mode");
                }), (e.prototype.parseAwait = function(t) {
                  return this.state.inAsync || this.unexpected(), this.match(
                    C.star
                  ) &&
                    this.raise(
                      t.start,
                      "await* has been removed from the async functions proposal. Use Promise.all() instead."
                    ), (t.argument = this.parseMaybeUnary()), this.finishNode(
                    t,
                    "AwaitExpression"
                  );
                }), (e.prototype.parseYield = function() {
                  var t = this.startNode();
                  return this.next(), this.match(C.semi) ||
                  this.canInsertSemicolon() ||
                ...
                (function(t) {
                  ...
                  return A(e, t), (e.prototype.toAssignable = function(
                    t,
                    e,
                    s
                  ) {
                    if (t)
                      switch (t.type) {
                        ...
                        case "ObjectProperty":
                          ...
                          break;
                        case "SpreadElement":
                          this.checkToRestConversion(t), (t.type =
                            "RestElement");
                          var c = t.argument;
                          this.toAssignable(c, e, s);
                          break;
                        case "ArrayExpression":
                          (t.type = "ArrayPattern"), this.toAssignableList(
                            t.elements,
                            e,
                            s
                          );
                    ...
                    return t;
                  }), (e.prototype.toAssignableObjectExpressionProp = function(
                    t,
                    e,
                    s
                  ) {
                    ...
                    if (i) {
                      ...
                      if (r && "RestElement" === r.type) --i;
                        ...
                        r.type = "RestElement";
                        var a = r.argument;
                        this.toAssignable(a, e, s), "Identifier" !== a.type &&
                          "MemberExpression" !== a.type &&
                          "ArrayPattern" !== a.type &&
                          this.unexpected(a.start), --i;
                      }
                    }
                    for (var n = 0; n < i; n++) {
                      var o = t[n];
                    ...
                    var e = this.startNode();
                    return this.next(), (e.argument = this.parseMaybeAssign(
                      !1,
                      t
                    )), this.finishNode(e, "SpreadElement");
                  }), (e.prototype.parseRest = function() {
                    var t = this.startNode();
                    return this.next(), (t.argument = this.parseBindingAtom()), this.finishNode(
                      t,
                      "RestElement"
                    );
                    ...
                    switch (this.state.type) {
                      ...
                      case C.bracketL:
                        var t = this.startNode();
                        return this.next(), (t.elements = this.parseBindingList(
                          C.bracketR,
                          !0
                    ...
                    for (var i = [], r = !0; !this.eat(t); ) {
                      if (
                        (
                          r ? (r = !1) : this.expect(C.comma),
                          e && this.match(C.comma)
                        )
                      )
                        i.push(null);
                      else {
                    ...
                    return (i.left = s), (i.right = this.parseMaybeAssign()), this.finishNode(
                      i,
                      "AssignmentPattern"
                    );
                    ...
                    switch (t.type) {
                      case "Identifier":
                        if (
                          (this.checkReservedWord(t.name, t.start, !1, !0), s)
                        ) {
                          var r = "_" + t.name;
                          s[r]
                            ? this.raise(
                      ...
                      case "ObjectPattern":
                        for (
                          ...
                          var p = h;
                          "ObjectProperty" === p.type &&
                            (p = p.value), this.checkLVal(
                            p,
                            e,
                            s,
                            "object destructuring pattern"
                  ...
                  (function(t) {
                    ...
                    return A(e, t), (e.prototype.startNode = function() {
                      ...
                      return (t.type = e), (t.end = s), (t.loc.end = i), this
                        .options.ranges &&
                        (t.range[1] = s), this.processComment(t), t;
                    }), (e.prototype.resetStartLocationFromNode = function(
                      t,
                      e
                    ) {
                      (t.start = e.start), (t.loc.start = e.loc.start), this
                        .options.ranges && (t.range[0] = e.range[0]);
                    }), e;
                  })(z)
                )
              )
          ...
          it = function it(t) {
            return (function(t) {
              ...
              return A(e, t), (e.prototype.estreeParseRegExpLiteral = function(
                t
              ) {
                var e = t.pattern,
                  s = t.flags,
                ...
                return (i.value = e.value), (i.raw =
                  e.extra.raw), (s.expression = this.finishNodeAt(
                  i,
                  "Literal",
                  e.end,
                  e.loc.end
                )), (s.directive = e.extra.raw.slice(1, -1)), this.finishNodeAt(
                  s,
                  "ExpressionStatement",
                  t.end,
                  t.loc.end
                ...
                u(e)
                  ...
                  : t.prototype.checkDeclaration.call(this, e);
              }), (e.prototype.checkGetterSetterParamCount = function(t) {
                var e = "get" === t.kind ? 0 : 1;
                ...
                return (n.kind = e.kind), (n = t.prototype.parseMethod.call(
                  this,
                  n,
                  s,
                  i,
                  r,
                  "FunctionExpression"
                )), delete n.kind, (e.value = n), this.finishNode(e, a);
              }), (e.prototype.parseObjectMethod = function(e, s, i, r) {
                var a = t.prototype.parseObjectMethod.call(this, e, s, i, r);
                return a &&
                  (
                    (a.type = "Property"),
                ...
                var n = t.prototype.parseObjectProperty.call(
                  this,
                  e,
                  s,
                  i,
                ...
                return u(e)
                  ? (this.toAssignable(e.value, s, i), e)
                  : t.prototype.toAssignable.call(this, e, s, i);
              }), (e.prototype.toAssignableObjectExpressionProp = function(
                e,
                s,
                i
                ...
                "get" === e.kind || "set" === e.kind
                  ...
                  : e.method
                    ...
                    : t.prototype.toAssignableObjectExpressionProp.call(
                        this,
                        e,
                        s,
                        i
          ...
          nt = function nt(t) {
            return (function(t) {
              ...
              return A(e, t), (e.prototype.flowParseTypeInitialiser = function(
                t
              ) {
                ...
                return this.expectContextual("checks"), (e.line === i.line &&
                  e.column === i.column - 1) ||
                  this.raise(
                    s,
                ...
                return this.next(), this.flowParseInterfaceish(
                  t
                ...
                return (s.returnType = a[0]), (t.predicate =
                  a[1]), (i.typeAnnotation = this.finishNode(
                  s,
                  ...
                  e,
                  e.type
                ), this.semicolon(), this.finishNode(t, "DeclareFunction");
                ...
                return this.next(), (t.id = this.flowParseTypeAnnotatableIdentifier()), this.semicolon(), this.finishNode(
                  t,
                  "DeclareVariable"
                );
              }), (e.prototype.flowParseDeclareModule = function(t) {
                var e = this;
                this.next(), this.match(C.string)
                ...
                this.expect(C.braceR), this.finishNode(s, "BlockStatement");
                var n = null,
                  o = !1,
                  h =
                ...
                return i.forEach(function(t) {
                  d(t)
                    ? ("CommonJS" === n && e.unexpected(t.start, h), (n = "ES"))
                    : "DeclareModuleExports" === t.type &&
                      (
                        ...
                        "ES" === n && e.unexpected(t.start, h),
                        (n = "CommonJS"),
                        (o = !0)
                      );
                }), (t.kind = n || "CommonJS"), this.finishNode(
                  t,
                  "DeclareModule"
                );
              }), (e.prototype.flowParseDeclareExportDeclaration = function(
                t,
                e
              ) {
                ...
                if (
                  ...
                  return "ExportNamedDeclaration" ===
                    ...
                    (
                      ...
                      (t.default = !1),
                      delete t.exportKind
                    ), (t.type = "Declare" + t.type), t;
                throw this.unexpected();
              }), (e.prototype.flowParseDeclareModuleExports = function(t) {
                return this.expectContextual("module"), this.expect(
                  C.dot
                ), this.expectContextual(
                  "exports"
                ), (t.typeAnnotation = this.flowParseTypeAnnotation()), this.semicolon(), this.finishNode(
                  t,
                  "DeclareModuleExports"
                );
              }), (e.prototype.flowParseDeclareTypeAlias = function(t) {
                return this.next(), this.flowParseTypeAlias(t), this.finishNode(
                  t,
                  "DeclareTypeAlias"
                );
                ...
                var t = this.startNode();
                return (t.id = this.flowParseQualifiedTypeIdentifier()), this.isRelational(
                  "<"
                )
                  ? (t.typeParameters = this.flowParseTypeParameterInstantiation())
                  : (t.typeParameters = null), this.finishNode(
                  t,
                  "InterfaceExtends"
                );
              }), (e.prototype.flowParseInterface = function(t) {
                return this.flowParseInterfaceish(t), this.finishNode(
                  t,
                  "InterfaceDeclaration"
                );
              }), (e.prototype.flowParseRestrictedIdentifier = function(t) {
                return rt.indexOf(this.state.value) > -1 &&
                  this.raise(
                    this.state.start,
                    "Cannot overwrite primitive type " + this.state.value
                  ), this.parseIdentifier(t);
              }), (e.prototype.flowParseTypeAlias = function(t) {
                return (t.id = this.flowParseRestrictedIdentifier()), this.isRelational(
                  "<"
                )
                  ? (t.typeParameters = this.flowParseTypeParameterDeclaration())
                  : (t.typeParameters = null), (t.right = this.flowParseTypeInitialiser(
                  C.eq
                )), this.semicolon(), this.finishNode(t, "TypeAlias");
              }), (e.prototype.flowParseOpaqueType = function(t, e) {
                return this.expectContextual(
                  "type"
                ), (t.id = this.flowParseRestrictedIdentifier()), this.isRelational(
                  "<"
                )
                  ? (t.typeParameters = this.flowParseTypeParameterDeclaration())
                  : (t.typeParameters = null), (t.supertype = null), this.match(
                  C.colon
                ) &&
                ...
                return this.expectRelational(
                  ">"
                ), (this.state.inType = t), this.finishNode(
                  e,
                ...
                for (
                  ...
                  t.params.push(this.flowParseType()), this.isRelational(">") ||
                    this.expect(C.comma);
                }
                return this.expectRelational(
                  ">"
                ), (this.state.inType = e), this.finishNode(
                  t,
                ...
                return (t.static = e), this.expect(C.bracketL), this.lookahead()
                  .type === C.colon
                  ? (
                  ...
                  C.bracketR
                ), (t.value = this.flowParseTypeInitialiser()), (t.variance = s), this.finishNode(
                  t,
                  "ObjectTypeIndexer"
                );
              }), (e.prototype.flowParseObjectTypeMethodish = function(t) {
                for (
                  t.params = [], t.rest = null, t.typeParameters = null, this.isRelational(
                    "<"
                  ) &&
                    (t.typeParameters = this.flowParseTypeParameterDeclaration()), this.expect(
                    C.parenL
                  );
                  !this.match(C.parenR) && !this.match(C.ellipsis);

                ) {
                  t.params.push(this.flowParseFunctionTypeParam()), this.match(
                    C.parenR
                  ) || this.expect(C.comma);
                }
                return this.eat(C.ellipsis) &&
                  (t.rest = this.flowParseFunctionTypeParam()), this.expect(
                  C.parenR
                ), (t.returnType = this.flowParseTypeInitialiser()), this.finishNode(
                  t,
                  "FunctionTypeAnnotation"
                );
              }), (e.prototype.flowParseObjectTypeCallProperty = function(
                t,
                e
              ) {
                var s = this.startNode();
                return (t.static = e), (t.value = this.flowParseObjectTypeMethodish(
                  s
                ...
                for (
                  e && this.match(C.braceBarL)
                    ? (this.expect(C.braceBarL), (a = C.braceBarR), (n = !0))
                    : (
                  ...
                  t &&
                    ...
                    (this.next(), (o = !0));
                  var p = this.flowParseVariance();
                  if (this.match(C.bracketL))
                    r.indexers.push(this.flowParseObjectTypeIndexer(h, o, p));
                  else if (this.match(C.parenL) || this.isRelational("<"))
                    p && this.unexpected(p.start), r.callProperties.push(
                      this.flowParseObjectTypeCallProperty(h, o)
                    );
                  else {
                    var c = "init";
                    if (this.isContextual("get") || this.isContextual("set")) {
                      ...
                      (l.type !== C.name &&
                        l.type !== C.string &&
                        l.type !== C.num) ||
                        ((c = this.state.value), this.next());
                    }
                    r.properties.push(
                      this.flowParseObjectTypeProperty(h, o, p, c, s)
                    );
                  }
                  this.flowObjectTypeSemicolon();
                }
                this.expect(a);
                var u = this.finishNode(r, "ObjectTypeAnnotation");
                return (this.state.inType = i), u;
              }), (e.prototype.flowParseObjectTypeProperty = function(
                t,
                e,
                s,
                i,
                ...
                if (this.match(C.ellipsis))
                  return r ||
                    ...
                    C.ellipsis
                  ), (t.argument = this.flowParseType()), this.finishNode(
                    t,
                ...
                this.eat(C.semi) ||
                  ...
                  this.unexpected();
              }), (e.prototype.flowParseQualifiedTypeIdentifier = function(
                t,
                e,
                s
              ) {
                ...
                for (var i = s || this.parseIdentifier(); this.eat(C.dot); ) {
                  ...
                  (r.qualification = i), (r.id = this.parseIdentifier()), (i = this.finishNode(
                    r,
                ...
                var i = this.startNodeAt(t, e);
                return (i.typeParameters = null), (i.id = this.flowParseQualifiedTypeIdentifier(
                  t,
                  e,
                  s
                )), this.isRelational("<") &&
                  (i.typeParameters = this.flowParseTypeParameterInstantiation()), this.finishNode(
                  i,
                ...
                return this.expect(
                  C._typeof
                ), (t.argument = this.flowParsePrimaryType()), this.finishNode(
                  t,
                ...
                return this.expect(C.bracketR), this.finishNode(
                  t,
                  "TupleTypeAnnotation"
                );
                ...
                var t = null,
                  ...
                  i = this.startNode(),
                  r = this.lookahead();
                return r.type === C.colon || r.type === C.question
                  ? (
                      (t = this.parseIdentifier()),
                      this.eat(C.question) && (e = !0),
                      (s = this.flowParseTypeInitialiser())
                    )
                  : (s = this.flowParseType()), (i.name = t), (i.optional = e), (i.typeAnnotation = s), this.finishNode(
                  i,
                  "FunctionTypeParam"
                );
              }), (e.prototype.reinterpretTypeAsFunctionTypeParam = function(
                t
              ) {
                var e = this.startNodeAt(t.start, t.loc.start);
                return (e.name = null), (e.optional = !1), (e.typeAnnotation = t), this.finishNode(
                  e,
                  "FunctionTypeParam"
                );
                ...
                for (
                  ...
                  t.push(this.flowParseFunctionTypeParam()), this.match(
                    C.parenR
                  ) || this.expect(C.comma);
                }
                return this.eat(C.ellipsis) &&
              ...
              }), (e.prototype.flowIdentToTypeAnnotation = function(
                t,
                e,
                s,
                i
                ...
                switch (this.state.type) {
                  ...
                  case C.relational:
                    if ("<" === this.state.value)
                      return (s.typeParameters = this.flowParseTypeParameterDeclaration()), this.expect(
                        C.parenL
                      ), (i = this.flowParseFunctionTypeParams()), (s.params =
                        i.params), (s.rest = i.rest), this.expect(
                        C.parenR
                      ), this.expect(
                        C.arrow
                      ), (s.returnType = this.flowParseType()), this.finishNode(
                        s,
                        "FunctionTypeAnnotation"
                      );
                    break;
                  case C.parenL:
                    ...
                    return (i = r
                      ...
                      : this.flowParseFunctionTypeParams()), (s.params =
                      i.params), (s.rest = i.rest), this.expect(
                      C.parenR
                    ), this.expect(
                      C.arrow
                    ), (s.returnType = this.flowParseType()), (s.typeParameters = null), this.finishNode(
                      s,
                      "FunctionTypeAnnotation"
                    );
                  case C.string:
                  ...
                  case C._true:
                  case C._false:
                    return (s.value = this.match(
                      C._true
                    )), this.next(), this.finishNode(
                      s,
                      "BooleanLiteralTypeAnnotation"
                    );
                  case C.plusMin:
                    if ("-" === this.state.value)
                      return this.next(), this.match(C.num) ||
                        this.unexpected(
                          null,
                ...
                for (
                  ...
                  var i = this.startNodeAt(t, e);
                  (i.elementType = s), this.expect(C.bracketL), this.expect(
                    C.bracketR
                ...
                if (!this.state.noAnonFunctionType && this.eat(C.arrow)) {
                  ...
                  ]), (e.rest = null), (e.returnType = this.flowParseType()), (e.typeParameters = null), this.finishNode(
                    e,
                    "FunctionTypeAnnotation"
                  );
                }
                ...
                return (this.state.inType = t), (this.state.exprAllowed =
                  this.state.exprAllowed || this.state.noAnonFunctionType), e;
              }), (e.prototype.flowParseTypeAnnotation = function() {
                var t = this.startNode();
                return (t.typeAnnotation = this.flowParseTypeInitialiser()), this.finishNode(
                  t,
                  "TypeAnnotation"
                );
                ...
                return (t.expression.typeAnnotation =
                ...
                if (!i && this.match(C.colon)) {
                  var r = this.startNode(),
                    a = this.flowParseTypeAndPredicateInitialiser();
                  (r.typeAnnotation = a[0]), (e.predicate =
                    a[1]), (e.returnType = r.typeAnnotation
                ...
                return (
                  ...
                  this.isContextual("interface") ||
                  this.isContextual("opaque") ||
                  t.prototype.shouldParseExportDeclaration.call(this)
                );
              }), (e.prototype.isExportDefaultSpecifier = function() {
                return (
                  (!this.match(C.name) ||
                  ...
                  t.prototype.isExportDefaultSpecifier.call(this)
                );
                ...
                if (a && this.match(C.question)) {
                  ...
                  try {
                    ...
                    if (t instanceof SyntaxError)
                      return (this.state = n), (a.start =
                        t.pos || this.state.start), e;
                    throw t;
                  }
                }
                return t.prototype.parseConditional.call(this, e, s, i, r);
                ...
                if (
                  (
                    (e = t.prototype.parseParenItem.call(this, e, s, i)),
                    this.eat(C.question) && (e.optional = !0),
                    this.match(C.colon)
                  )
                ) {
                  var r = this.startNodeAt(s, i);
                  return (r.expression = e), (r.typeAnnotation = this.flowParseTypeAnnotation()), this.finishNode(
                    r,
                    "TypeCastExpression"
                  );
                }
                ...
                return ("ExportNamedDeclaration" !==
                  (e = t.prototype.parseExport.call(this, e)).type &&
                  "ExportAllDeclaration" !== e.type) ||
                  (e.exportKind = e.exportKind || "value"), e;
              }), (e.prototype.parseExportDeclaration = function(e) {
                if (this.isContextual("type")) {
                  e.exportKind = "type";
                  var s = this.startNode();
                  return this.next(), this.match(C.braceL)
                    ? (
                ...
                return (
                  t.prototype.shouldParseExportStar.call(this) ||
                  (this.isContextual("type") &&
                    this.lookahead().type === C.star)
                );
              }), (e.prototype.parseExportStar = function(e, s) {
                return this.eatContextual("type") &&
                  (
                    (e.exportKind = "type"),
                    (s = !1)
                  ), t.prototype.parseExportStar.call(this, e, s);
              }), (e.prototype.parseClassId = function(e, s, i) {
                t.prototype.parseClassId.call(this, e, s, i), this.isRelational(
                  "<"
                ) &&
                ...
                if ("TypeCastExpression" !== e.type)
                  return t.prototype.checkLVal.call(this, e, s, i, r);
              }), (e.prototype.parseClassProperty = function(e) {
                return this.match(C.colon) &&
                  (e.typeAnnotation = this.flowParseTypeAnnotation()), t.prototype.parseClassProperty.call(
                  this,
                  e
                );
              }), (e.prototype.isClassMethod = function() {
                return (
                  this.isRelational("<") || t.prototype.isClassMethod.call(this)
                );
              }), (e.prototype.isClassProperty = function() {
                return (
                  this.match(C.colon) || t.prototype.isClassProperty.call(this)
                );
              }), (e.prototype.isNonstaticConstructor = function(e) {
                return (
                  !this.match(C.colon) &&
                  t.prototype.isNonstaticConstructor.call(this, e)
                );
              }), (e.prototype.parseClassMethod = function(e, s, i, r, a) {
                s.variance &&
                  this.unexpected(
                    s.variance.start
                  ), delete s.variance, this.isRelational("<") &&
                  (s.typeParameters = this.flowParseTypeParameterDeclaration()), t.prototype.parseClassMethod.call(
                  this,
                  e,
                  s,
                  i,
                ...
                if (
                  (
                    t.prototype.parseClassSuper.call(this, e),
                    e.superClass &&
                      this.isRelational("<") &&
                  ...
                  do {
                    var i = this.startNode();
                    (i.id = this.parseIdentifier()), this.isRelational("<")
                      ? (i.typeParameters = this.flowParseTypeParameterInstantiation())
                      : (i.typeParameters = null), s.push(
                      this.finishNode(i, "ClassImplements")
                    );
                  } while (this.eat(C.comma));
                }
                ...
                e.variance &&
                  this.unexpected(e.variance.start), delete e.variance;
                var h = void 0;
                this.isRelational("<") &&
                  (
                    (h = this.flowParseTypeParameterDeclaration()),
                    this.match(C.parenL) || this.unexpected()
                  ), t.prototype.parseObjPropValue.call(
                  this,
                  e,
                  s,
                  i,
                ...
                return this.match(C.colon) &&
                  (t.typeAnnotation = this.flowParseTypeAnnotation()), this.finishNode(
                  t,
                  t.type
                ), t;
                ...
                this.isRelational("<") &&
                  (e.typeParameters = this.flowParseTypeParameterDeclaration()), t.prototype.parseFunctionParams.call(
                  this,
                  e
                );
              }), (e.prototype.parseVarHead = function(e) {
                t.prototype.parseVarHead.call(this, e), this.match(C.colon) &&
                  (
                ...
                return t.prototype.parseAsyncArrowFromCallExpression.call(
                  this,
                  e,
                  s
                );
                ...
                return (
                  this.match(C.colon) ||
                  t.prototype.shouldParseAsyncArrow.call(this)
                );
                ...
                if (C.jsxTagStart && this.match(C.jsxTagStart)) {
                  ...
                  try {
                    ...
                    (this.state = n), (this.state.context.length -= 2), (a = t);
                  }
                }
                if (null != a || this.isRelational("<")) {
                  var o = void 0,
                    h = void 0;
                  try {
                    (h = this.flowParseTypeParameterDeclaration()), ((o = t.prototype.parseMaybeAssign.call(
                      this,
                      e,
                      s,
                      i,
                      r
                    )).typeParameters = h), this.resetStartLocationFromNode(
                      o,
                      h
                    );
                  } catch (t) {
                ...
                if (this.match(C.colon)) {
                  ...
                  try {
                    ...
                    var r = this.startNode(),
                      a = this.flowParseTypeAndPredicateInitialiser();
                    (r.typeAnnotation = a[0]), (e.predicate =
                      a[1]), (this.state.noAnonFunctionType = i), this.canInsertSemicolon() &&
                      this.unexpected(), this.match(C.arrow) ||
                      this.unexpected(), (e.returnType = r.typeAnnotation
                      ? this.finishNode(r, "TypeAnnotation")
                      : null);
                  } catch (t) {
                    if (!(t instanceof SyntaxError)) throw t;
                ...
                return (
                  this.match(C.colon) || t.prototype.shouldParseArrow.call(this)
                );
              }), e;
            })(t);
          },
        ...
        (U.j_oTag = new V(
          "<tag",
          !1
        )), (U.j_cTag = new V("</tag", !1)), (U.j_expr = new V("<tag>...</tag>", !0, !0)), (C.jsxName = new k("jsxName")), (C.jsxText = new k("jsxText", { beforeExpr: !0 })), (C.jsxTagStart = new k("jsxTagStart", { startsExpr: !0 })), (C.jsxTagEnd = new k("jsxTagEnd")), (C.jsxTagStart.updateContext = function() {
          this.state.context.push(U.j_expr), this.state.context.push(
            U.j_oTag
          ), (this.state.exprAllowed = !1);
        }), (C.jsxTagEnd.updateContext = function(t) {
          var e = this.state.context.pop();
          (e === U.j_oTag && t === C.slash) || e === U.j_cTag
            ? (
                this.state.context.pop(),
                (this.state.exprAllowed = this.curContext() === U.j_expr)
              )
            : (this.state.exprAllowed = !0);
        });
            ...
            return (function(t) {
              ...
              return A(e, t), (e.prototype.jsxReadToken = function() {
                  ...
                  switch (s) {
                    ...
                    case 38:
                      (t += this.input.slice(
                        e,
                        this.state.pos
                      )), (t += this.jsxReadEntity()), (e = this.state.pos);
                      break;
                    default:
                      o(s)
                        ? (
                ...
                var e = this.input.charCodeAt(this.state.pos),
                  s = void 0;
                return ++this.state.pos, 13 === e &&
                10 === this.input.charCodeAt(this.state.pos)
                  ? (++this.state.pos, (s = t ? "\n" : "\r\n"))
                  : (s = String.fromCharCode(e)), ++this.state
                  .curLine, (this.state.lineStart = this.state.pos), s;
                    ...
                    "#" === t[0]
                      ? "x" === t[1]
                        ? (
                            (t = t.substr(2)),
                            ht.test(t) &&
                              (s = String.fromCodePoint(parseInt(t, 16)))
                          )
                        : (
                            (t = t.substr(1)),
                            pt.test(t) &&
                              (s = String.fromCodePoint(parseInt(t, 10)))
                          )
                      : (s = ot[t]);
                    break;
                  }
                ...
                return this.match(C.jsxName)
                  ...
                  : this.state.type.keyword
                    ...
                    : this.unexpected(), this.next(), this.finishNode(
                  t,
                  "JSXIdentifier"
                );
                ...
                var i = this.startNodeAt(t, e);
                return (i.namespace = s), (i.name = this.jsxParseIdentifier()), this.finishNode(
                  i,
                  "JSXNamespacedName"
                );
                ...
                for (
                  ...
                  var i = this.startNodeAt(t, e);
                  (i.object = s), (i.property = this.jsxParseIdentifier()), (s = this.finishNode(
                    i,
                    "JSXMemberExpression"
                  ));
                }
                ...
                var t = this.startNode();
                return this.expect(C.braceL), this.expect(
                  C.ellipsis
                ), (t.expression = this.parseExpression()), this.expect(
                  C.braceR
                ), this.finishNode(t, "JSXSpreadChild");
              }), (e.prototype.jsxParseExpressionContainer = function() {
                var t = this.startNode();
                return this.next(), this.match(C.braceR)
                ...
                return (s.selfClosing = this.eat(C.slash)), this.expect(
                  C.jsxTagEnd
                ), this.finishNode(s, "JSXOpeningElement");
              }), (e.prototype.jsxParseClosingElementAt = function(t, e) {
                var s = this.startNodeAt(t, e);
                return (s.name = this.jsxParseElementName()), this.expect(
                  C.jsxTagEnd
                ...
                return (s.openingElement = r), (s.closingElement = a), (s.children = i), this.match(
                  C.relational
                ) &&
                  "<" === this.state.value &&
                  this.raise(
                ...
                return this.match(C.jsxText)
                  ...
                  : this.match(C.jsxTagStart)
                    ...
                    : t.prototype.parseExprAtom.call(this, e);
              }), (e.prototype.readToken = function(e) {
                if (this.state.inPropertyName)
                  return t.prototype.readToken.call(this, e);
                ...
                if (this.match(C.braceL)) {
                  var s = this.curContext();
                  s === U.j_oTag
                    ? this.state.context.push(U.braceExpression)
                    : s === U.j_expr
                      ? this.state.context.push(U.templateQuasi)
                      : t.prototype.updateContext.call(
                          this,
                          e
                        ), (this.state.exprAllowed = !0);
                } else {
                  if (!this.match(C.slash) || e !== C.jsxTagStart)
                    return t.prototype.updateContext.call(this, e);
                  (this.state.context.length -= 2), this.state.context.push(
                    U.j_cTag
                  ), (this.state.exprAllowed = !1);
                }
              }), e;
            ...
            return (function(t) {
              ...
              return A(e, t), (e.prototype.tsIsIdentifier = function() {
                ...
                return s
                  ...
                  : this.expectRelational(">"), r;
              }), (e.prototype.tsParseEntityName = function(t) {
                for (var e = this.parseIdentifier(); this.eat(C.dot); ) {
                  var s = this.startNodeAtNode(e);
                  (s.left = e), (s.right = this.parseIdentifier(
                    t
                ...
                var t = this.startNode();
                return (t.typeName = this.tsParseEntityName(
                  !1
                )), !this.hasPrecedingLineBreak() &&
                  this.isRelational("<") &&
                  (t.typeParameters = this.tsParseTypeArguments()), this.finishNode(
                  t,
                  "TSTypeReference"
                );
                ...
                this.next();
                var e = this.startNode();
                return (e.parameterName = t), (e.typeAnnotation = this.tsParseTypeAnnotation(
                  !1
                ...
                return this.expect(
                  C._typeof
                ), (t.exprName = this.tsParseEntityName(!0)), this.finishNode(
                  t,
                  "TSTypeQuery"
                );
              }), (e.prototype.tsParseTypeParameter = function() {
                var t = this.startNode();
                return (t.name = this.parseIdentifierName(t.start)), this.eat(
                  C._extends
                ) && (t.constraint = this.tsParseType()), this.eat(C.eq) &&
                  (t.default = this.tsParseType()), this.finishNode(
                  t,
                  "TypeParameter"
                );
                ...
                return this.isRelational("<") || this.match(C.jsxTagStart)
                  ? this.next()
                  : this.unexpected(), (t.params = this.tsParseBracketedList(
                ...
                var s = t === C.arrow;
                (e.typeParameters = this.tsTryParseTypeParameters()), this.expect(
                  C.parenL
                ), (e.parameters = this.tsParseBindingListForSignature()), s
                ...
                var t = this;
                return this.parseBindingList(C.parenR).map(function(e) {
                ...
                var e = this.startNode();
                return "TSConstructSignatureDeclaration" === t &&
                  this.expect(C._new), this.tsFillSignature(
                  C.colon,
                  e
                ), this.tsParseTypeMemberSemicolon(), this.finishNode(e, t);
                ...
                if (
                  ...
                  this.expect(
                    ...
                    !1
                  )), this.expect(C.bracketR), (t.parameters = [e]);
                  var s = this.tsTryParseTypeAnnotation();
                  return s &&
                    (t.typeAnnotation = s), this.tsParseTypeMemberSemicolon(), this.finishNode(
                    t,
                    "TSIndexSignature"
                  );
                }
              }), (e.prototype.tsParsePropertyOrMethodSignature = function(
                t,
                e
              ) {
                this.parsePropertyName(t), this.eat(C.question) &&
                  (t.optional = !0);
                var s = t;
                if (e || (!this.match(C.parenL) && !this.isRelational("<"))) {
                  ...
                  return r &&
                    (i.typeAnnotation = r), this.tsParseTypeMemberSemicolon(), this.finishNode(
                    i,
                    "TSPropertySignature"
                  );
                }
                ...
                return this.tsFillSignature(
                  C.colon,
                  a
                ), this.tsParseTypeMemberSemicolon(), this.finishNode(
                  a,
                  "TSMethodSignature"
                );
                ...
                return this.next(), this.match(C.parenL) ||
                  this.isRelational("<");
              }), (e.prototype.tsParseTypeLiteral = function() {
                var t = this.startNode();
                return (t.members = this.tsParseObjectTypeMembers()), this.finishNode(
                  t,
                  "TSTypeLiteral"
                );
              }), (e.prototype.tsParseObjectTypeMembers = function() {
                this.expect(C.braceL);
                var t = this.tsParseList(
                  "TypeMembers",
                  this.tsParseTypeMember.bind(this)
                );
                return this.expect(C.braceR), t;
              }), (e.prototype.tsIsStartOfMappedType = function() {
                return this.next(), this.isContextual("readonly") &&
                  this.next(), !!this.match(C.bracketL) &&
                  (
                    this.next(),
                    !!this.tsIsIdentifier() && (this.next(), this.match(C._in))
                  );
              }), (e.prototype.tsParseMappedTypeParameter = function() {
                var t = this.startNode();
                return (t.name = this.parseIdentifierName(
                  t.start
                )), this.expect(
                  C._in
                ), (t.constraint = this.tsParseType()), this.finishNode(
                  t,
                  "TypeParameter"
                );
              }), (e.prototype.tsParseMappedType = function() {
                var t = this.startNode();
                return this.expect(C.braceL), this.eatContextual("readonly") &&
                  (t.readonly = !0), this.expect(
                  C.bracketL
                ), (t.typeParameter = this.tsParseMappedTypeParameter()), this.expect(
                  C.bracketR
                ), this.eat(C.question) &&
                  (t.optional = !0), (t.typeAnnotation = this.tsTryParseType()), this.semicolon(), this.expect(
                  C.braceR
                ), this.finishNode(t, "TSMappedType");
              }), (e.prototype.tsParseTupleType = function() {
                var t = this.startNode();
                return (t.elementTypes = this.tsParseBracketedList(
                  "TupleElementTypes",
                ...
                return this.expect(
                  C.parenL
                ), (t.typeAnnotation = this.tsParseType()), this.expect(
                  C.parenR
                ...
                switch (this.state.type) {
                  ...
                  case C._void:
                  case C._null:
                    var t = this.match(C._void)
                      ? "TSVoidKeyword"
                      : this.match(C._null)
                        ? "TSNullKeyword"
                        : x(this.state.value);
                    if (void 0 !== t && this.lookahead().type !== C.dot) {
                      var e = this.startNode();
                  ...
                  case C.plusMin:
                    if ("-" === this.state.value) {
                      ...
                      if ((this.next(), !this.match(C.num)))
                        throw this.unexpected();
                      return (s.literal = this.parseLiteral(
                        -this.state.value,
                        "NumericLiteral",
                        s.start,
                        s.loc.start
                  ...
                  case C._this:
                    ...
                    !this.hasPrecedingLineBreak()
                      ? this.tsParseThisTypePredicate(i)
                      : i;
                  case C._typeof:
                ...
                for (
                  ...
                  !this.hasPrecedingLineBreak() && this.eat(C.bracketL);

                ) {
                  if (this.match(C.bracketR)) {
                    var e = this.startNodeAtNode(t);
                    (e.elementType = t), this.expect(
                      C.bracketR
                    ), (t = this.finishNode(e, "TSArrayType"));
                  } else {
                    var s = this.startNodeAtNode(t);
                    (s.objectType = t), (s.indexType = this.tsParseType()), this.expect(
                      C.bracketR
                ...
                return this.expectContextual(
                  t
                ), (e.operator = t), (e.typeAnnotation = this.tsParseTypeOperatorOrHigher()), this.finishNode(
                  e,
                  "TSTypeOperator"
                );
              }), (e.prototype.tsParseTypeOperatorOrHigher = function() {
                return this.isContextual("keyof")
                  ? this.tsParseTypeOperator("keyof")
                  : this.tsParseArrayTypeOrHigher();
              }), (e.prototype.tsParseUnionOrIntersectionType = function(
                t,
                e,
                s
              ) {
                ...
                if (this.tsSkipParameterStart()) {
                  ...
                  if (
                    this.match(C.parenR) &&
                    (this.next(), this.match(C.arrow))
                  )
                    return !0;
                }
                return !1;
              }), (e.prototype.tsParseTypeOrTypePredicateAnnotation = function(
                t
              ) {
                var e = this.startNode();
                this.expect(t);
                ...
                var i = this.tsParseTypeAnnotation(!1),
                  r = this.startNodeAtNode(s);
                return (r.parameterName = s), (r.typeAnnotation = i), (e.typeAnnotation = this.finishNode(
                  r,
                  "TSTypePredicate"
                ...
                return void 0 === t && (t = !0), void 0 === e &&
                  (e = this.startNode()), t &&
                  this.expect(
                    C.colon
                  ), (e.typeAnnotation = this.tsParseType()), this.finishNode(
                  e,
                  "TypeAnnotation"
                );
                ...
                var t = this.startNode();
                return (t.typeAnnotation = this.tsParseType()), this.expectRelational(
                  ">"
                ), (t.expression = this.parseMaybeUnary()), this.finishNode(
                  t,
                  "TSTypeAssertion"
                );
                ...
                return this.tsTryParseAndCatch(function() {
                  var e = t.startNode();
                  t.expectRelational("<");
                  var s = t.tsParseDelimitedList(
                    "TypeParametersOrArguments",
                    t.tsParseType.bind(t)
                  );
                  return t.expectRelational(
                    ">"
                  ), (e.params = s), t.finishNode(e, "TypeParameterInstantiation"), t.expect(C.parenL), e;
                });
                ...
                var t = this.startNode();
                return (t.expression = this.tsParseEntityName(
                  !1
                )), this.isRelational("<") &&
                  (t.typeParameters = this.tsParseTypeArguments()), this.finishNode(
                  t,
                ...
                (t.id = this.parseIdentifier()), (t.typeParameters = this.tsTryParseTypeParameters()), this.eat(
                  C._extends
                ) && (t.extends = this.tsParseHeritageClause());
                var e = this.startNode();
                return (e.body = this.tsParseObjectTypeMembers()), (t.body = this.finishNode(
                  e,
                  "TSInterfaceBody"
                )), this.finishNode(t, "TSInterfaceDeclaration");
              }), (e.prototype.tsParseTypeAliasDeclaration = function(t) {
                return (t.id = this.parseIdentifier()), (t.typeParameters = this.tsTryParseTypeParameters()), this.expect(
                  C.eq
                ), (t.typeAnnotation = this.tsParseType()), this.semicolon(), this.finishNode(
                  t,
                ...
                return (t.id = this.match(C.string)
                  ...
                  : this.parseIdentifier(!0)), this.eat(C.eq) &&
                  (t.initializer = this.parseMaybeAssign()), this.finishNode(
                  t,
                  "TSEnumMember"
                );
              }), (e.prototype.tsParseEnumDeclaration = function(t, e) {
                return e &&
                  (t.const = !0), (t.id = this.parseIdentifier()), this.expect(
                  C.braceL
                ), (t.members = this.tsParseDelimitedList(
                  "EnumMembers",
                  this.tsParseEnumMember.bind(this)
                )), this.expect(C.braceR), this.finishNode(
                  t,
                  "TSEnumDeclaration"
                );
              }), (e.prototype.tsParseModuleBlock = function() {
                var t = this.startNode();
                return this.expect(C.braceL), this.parseBlockOrModuleBlockBody(
                  (t.body = []),
                  void 0,
                  !0,
                  C.braceR
                ), this.finishNode(t, "TSModuleBlock");
              }), (e.prototype.tsParseModuleOrNamespaceDeclaration = function(
                t
              ) {
                if (((t.id = this.parseIdentifier()), this.eat(C.dot))) {
                  var e = this.startNode();
              ...
              }), (e.prototype.tsParseAmbientExternalModuleDeclaration = function(
                t
              ) {
                return this.isContextual("global")
                  ...
                  : this.match(C.string)
                    ? (t.id = this.parseExprAtom())
                    : this.unexpected(), this.match(C.braceL)
                  ? (t.body = this.tsParseModuleBlock())
                  : this.semicolon(), this.finishNode(t, "TSModuleDeclaration");
              }), (e.prototype.tsParseImportEqualsDeclaration = function(t, e) {
                return (t.isExport =
                  e || !1), (t.id = this.parseIdentifier()), this.expect(
                  C.eq
                ), (t.moduleReference = this.tsParseModuleReference()), this.semicolon(), this.finishNode(
                  t,
                ...
                if (
                  ...
                  throw this.unexpected();
                return (t.expression = this.parseLiteral(
                  this.state.value,
                  "StringLiteral"
                )), this.expect(C.parenR), this.finishNode(
                  t,
                ...
                var s = this.startNodeAtNode(t);
                return (s.type = e), (s.end = t.end), (s.loc.end =
                  t.loc.end), t.leadingComments &&
                  (s.leadingComments = t.leadingComments), t.trailingComments &&
                  (s.trailingComments = t.trailingComments), t.innerComments &&
                  (s.innerComments = t.innerComments), s;
                ...
                switch (this.state.type) {
                  ...
                  case C._const:
                    if (
                      ...
                      return this.expect(C._const), this.expectContextual(
                        "enum"
                ...
                return e.type === C.name && e.value === t;
                ...
                switch (e.name) {
                  ...
                  case "global":
                    if (this.match(C.braceL)) {
                      var i = t;
                      return (i.global = !0), (i.id = e), (i.body = this.tsParseModuleBlock()), this.finishNode(
                        i,
                        "TSModuleDeclaration"
                      );
                    }
                ...
                switch (e) {
                  case "abstract":
                    if (s || this.match(C._class)) {
                      var i = t;
                      return (i.abstract = !0), s &&
                        this.next(), this.parseClass(i, !0, !1);
                    }
                    break;
                  case "enum":
                    if (s || this.match(C.name))
                      return s && this.next(), this.tsParseEnumDeclaration(
                        t,
                        !1
                      );
                    break;
                  case "interface":
                    if (s || this.match(C.name))
                      return s && this.next(), this.tsParseInterfaceDeclaration(
                        t
                      );
                    break;
                  case "module":
                  ...
                  case "namespace":
                    if (s || this.match(C.name))
                      return s &&
                        this.next(), this.tsParseModuleOrNamespaceDeclaration(
                        t
                      );
                    break;
                  case "type":
                    if (s || this.match(C.name))
                      return s && this.next(), this.tsParseTypeAliasDeclaration(
                        t
                      );
                }
              }), (e.prototype.tsTryParseGenericAsyncArrowFunction = function(
                e,
                s
              ) {
                var i = this,
                  r = this.tsTryParseAndCatch(function() {
                    ...
                    return (r.typeParameters = i.tsParseTypeParameters()), t.prototype.parseFunctionParams.call(i, r), (r.returnType = i.tsTryParseTypeOrTypePredicateAnnotation()), i.expect(C.arrow), r;
                  });
                if (r)
                  return (r.id = null), (r.generator = !1), (r.expression = !0), (r.async = !0), this.parseFunctionBody(
                    r,
                    !0
                  ), this.finishNode(r, "ArrowFunctionExpression");
              }), (e.prototype.tsParseTypeArguments = function() {
                var t = this.startNode();
                return this.expectRelational(
                  "<"
                ), (t.params = this.tsParseDelimitedList(
                  "TypeParametersOrArguments",
                  this.tsParseType.bind(this)
                )), this.expectRelational(">"), this.finishNode(
                  t,
                  "TypeParameterInstantiation"
                );
              }), (e.prototype.isExportDefaultSpecifier = function() {
                ...
                if (s || i) {
                  ...
                  return (n.parameter = a), this.finishNode(
                    n,
                    "TSParameterProperty"
                  );
                }
                ...
                var r =
                  "FunctionDeclaration" === s
                    ? "TSDeclareFunction"
                    : "ClassMethod" === s ? "TSDeclareMethod" : void 0;
                ...
                if (this.eat(C.bang)) {
                  ...
                  return (n.expression = e), this.finishNode(
                    n,
                    "TSNonNullExpression"
                  );
                }
                if (!r && this.isRelational("<")) {
                  ...
                  h.callee = e;
                  var p = this.tsTryParseTypeArgumentsInExpression();
                  if (p)
                    return (h.arguments = this.parseCallExpressionArguments(
                      C.parenR,
                      !1
                    )), (h.typeParameters = p), this.finishCallExpression(h);
                }
                ...
                if (this.isRelational("<")) {
                  var i = this.tsTryParseAndCatch(function() {
                    ...
                    return s.match(C.parenL) || s.unexpected(), t;
                  });
                ...
                if (
                  ...
                  var n = this.startNodeAt(s, i);
                  return (n.expression = e), (n.typeAnnotation = this.tsParseType()), this.finishNode(
                    n,
                    "TSAsExpression"
                  ), this.parseExprOp(n, s, i, r, a);
                }
                return t.prototype.parseExprOp.call(this, e, s, i, r, a);
              }), (e.prototype.checkReservedWord = function(
                t,
                e,
                s,
                i
              ) {}), (e.prototype.checkDuplicateExports = function() {}), (e.prototype.parseImport = function(
                e
              ) {
                return this.match(C.name) && this.lookahead().type === C.eq
                  ? this.tsParseImportEqualsDeclaration(e)
                  : t.prototype.parseImport.call(this, e);
              }), (e.prototype.parseExport = function(e) {
                if (this.match(C._import))
                  return this.expect(
                    C._import
                ...
                if (this.eat(C.eq)) {
                  var s = e;
                  return (s.expression = this.parseExpression()), this.semicolon(), this.finishNode(
                    s,
                    "TSExportAssignment"
                  );
                }
                if (this.eatContextual("as")) {
                  ...
                  return this.expectContextual(
                    "namespace"
                  ), (i.id = this.parseIdentifier()), this.semicolon(), this.finishNode(
                    i,
                ...
                if (this.state.type === C._const) {
                  var i = this.lookahead();
                  if (i.type === C.name && "enum" === i.value) {
                    var r = this.startNode();
                    return this.expect(C._const), this.expectContextual(
                      "enum"
                    ), this.tsParseEnumDeclaration(r, !0);
                  }
                }
                ...
                r && (s.accessibility = r), t.prototype.parseClassMember.call(
                  this,
                  e,
                  s,
                  i
                ...
                if (p)
                  return (a.static = r), this.parseClassPropertyName(
                    n
                  ), this.parsePostMemberNameModifiers(
                    a
                  ), void this.pushClassProperty(e, n);
                ...
                return (
                  ("Identifier" === s.type
                    ...
                    : void 0) ||
                  t.prototype.parseExpressionStatement.call(this, e, s)
                );
              }), (e.prototype.shouldParseExportDeclaration = function() {
                if (this.match(C.name))
                ...
                return t.prototype.shouldParseExportDeclaration.call(this);
              }), (e.prototype.parseConditional = function(e, s, i, r, a) {
                if (!a || !this.match(C.question))
                  return t.prototype.parseConditional.call(this, e, s, i, r, a);
                var n = this.state.clone();
                try {
                  return t.prototype.parseConditional.call(this, e, s, i, r);
                } catch (t) {
                ...
                if (
                  ...
                  var r = this.startNodeAt(s, i);
                  return (r.expression = e), (r.typeAnnotation = this.tsParseTypeAnnotation()), this.finishNode(
                    r,
                    "TypeCastExpression"
                  );
                }
                ...
                var s = this.eatContextual("declare"),
                  i = void 0;
                return this.match(C.name) &&
                  (i = this.tsTryParseExportDeclaration()), i ||
                  (i = t.prototype.parseExportDeclaration.call(this, e)), i &&
                  s &&
                  (i.declare = !0), i;
              }), (e.prototype.parseClassId = function(e, s, i) {
                var r;
                if ((s && !i) || !this.isContextual("implements")) {
                  (r = t.prototype.parseClassId).call.apply(
                    r,
                ...
                var s = this.tsTryParseTypeAnnotation();
                return s &&
                  (e.typeAnnotation = s), t.prototype.parseClassProperty.call(
                  this,
                  e
                );
              }), (e.prototype.parseClassMethod = function(e, s, i, r, a) {
                var n = this.tsTryParseTypeParameters();
                n && (s.typeParameters = n), t.prototype.parseClassMethod.call(
                  this,
                  e,
                  s,
                  i,
                ...
                t.prototype.parseClassSuper.call(this, e), e.superClass &&
                  this.isRelational("<") &&
                  (e.superTypeParameters = this.tsParseTypeArguments()), this.eatContextual(
                  "implements"
                ...
                (s = t.prototype.parseObjPropValue).call.apply(
                  s,
                  [this, e].concat(r)
                );
              }), (e.prototype.parseFunctionParams = function(e) {
                ...
                s &&
                  (e.typeParameters = s), t.prototype.parseFunctionParams.call(
                  this,
                  e
                );
              }), (e.prototype.parseVarHead = function(e) {
                t.prototype.parseVarHead.call(this, e);
                var s = this.tsTryParseTypeAnnotation();
                s &&
                  ((e.id.typeAnnotation = s), this.finishNode(e.id, e.id.type));
              }), (e.prototype.parseAsyncArrowFromCallExpression = function(
                e,
                s
              ) {
                return this.match(C.colon) &&
                  (e.returnType = this.tsParseTypeAnnotation()), t.prototype.parseAsyncArrowFromCallExpression.call(
                  this,
                  e,
                  s
                );
                ...
                for (
                  var e = void 0, s = arguments.length, i = Array(s), r = 0;
                  r < s;
                  r++
                ) {
                  i[r] = arguments[r];
                ...
                if (this.match(C.jsxTagStart)) {
                  ...
                  try {
                    var n;
                    return (n = t.prototype.parseMaybeAssign).call.apply(
                      n,
                      [this].concat(i)
                    );
                  } catch (t) {
                    if (!(t instanceof SyntaxError)) throw t;
                    (this.state = a), m(
                      this.curContext() === U.j_oTag
                    ), this.state.context.pop(), m(
                      this.curContext() === U.j_expr
                    ), this.state.context.pop(), (e = t);
                  }
                }
                if (void 0 === e && !this.isRelational("<")) {
                  var o;
                  return (o = t.prototype.parseMaybeAssign).call.apply(
                    o,
                    [this].concat(i)
                  );
                }
                ...
                try {
                  var l;
                  (p = this.tsParseTypeParameters()), "ArrowFunctionExpression" !==
                    (h = (l = t.prototype.parseMaybeAssign).call.apply(
                      l,
                      [this].concat(i)
                  ...
                  if (e) throw e;
                  return m(!this.hasPlugin("jsx")), (this.state = c), (u =
                    t.prototype.parseMaybeAssign).call.apply(
                    u,
                    [this].concat(i)
                  );
                }
                return p &&
                  ...
                  this.resetStartLocationFromNode(
                    h,
                    p.params[0]
                  ), (h.typeParameters = p), h;
              }), (e.prototype.parseMaybeUnary = function(e) {
                return !this.hasPlugin("jsx") && this.eatRelational("<")
                  ? this.tsParseTypeAssertion()
                  : t.prototype.parseMaybeUnary.call(this, e);
              }), (e.prototype.parseArrow = function(e) {
                if (this.match(C.colon)) {
                  var s = this.state.clone();
                  try {
                    var i = this.tsParseTypeOrTypePredicateAnnotation(C.colon);
                    this.canInsertSemicolon() && this.unexpected(), this.match(
                      C.arrow
                    ) || this.unexpected(), (e.returnType = i);
                  } catch (t) {
                    if (!(t instanceof SyntaxError)) throw t;
                    this.state = s;
                  }
                ...
                switch (e.type) {
                  case "TypeCastExpression":
                    return t.prototype.toAssignable.call(
                      this,
                      this.typeCastToParameter(e),
                      s,
                      i
                ...
                for (
                  var e, s = arguments.length, i = Array(s), r = 0;
                  r < s;
                  r++
                ) {
                  i[r] = arguments[r];
                }
                var a = (e = t.prototype.parseMaybeDefault).call.apply(
                  e,
                  [this].concat(i)
                );
                return "AssignmentPattern" === a.type &&
                  a.typeAnnotation &&
        ...
        (et.estree = it), (et.flow = nt), (et.jsx = ct), (et.typescript = lt);
        var ut = {};
        (e.parse = v), (e.parseExpression = P), (e.tokTypes = C);
      });
    var createError = parserCreateError;
    var parserBabylon = parse;
    module.exports = parserBabylon;
  });
