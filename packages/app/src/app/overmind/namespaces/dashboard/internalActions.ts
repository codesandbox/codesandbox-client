 ...
 */
export const changeSandboxesInState: Action<
  {
    sandboxIds: string[];
    /**
  ...
  {
    changedSandboxes: Set<SandboxFragmentDashboardFragment>;
  }
> = ({ state: { dashboard } }, { sandboxIds, sandboxMutation }) => {
...
export const deleteSandboxesFromState: Action<{
  ids: string[];
}> = ({ state: { dashboard } }, { ids }) => {
