...
const CONSOLE_INPUT_PADDING = CONSOLE_INPUT_TOP_PADDING + CONSOLE_INPUT_BOTTOM_PADDING;
    ...
    editorDidMount = async (editor: any) => {
        ...
        editor.onDidChangeModelContent(() => {
            ...
            if (lineCount !== lastLineCount) {
                this.setState({
                    editorHeight: Math.min(CONSOLE_INPUT_MAX_HEIGHT, lineCount * CONSOLE_INPUT_LINE_HEIGHT)
                });
                this.resizeEditor();
        ...
        editor.onKeyDown((event) => {
            ...
            if (e.keyCode === 13) {
                ...
                const newCursor = Math.min(this.state.commandCursor + 1, this.state.commandHistory.length - 1);
