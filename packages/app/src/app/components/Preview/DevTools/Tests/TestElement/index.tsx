...
import { Container, FileName, Path, Tests, FileData, Test, Block, TestName, Actions } from './elements';
...
class TestElement extends React.Component<Props> {
    ...
    render() {
        ...
        return (
            <Container onClick={this.selectFile} selected={file === this.props.selectedFile}>
                <FileData>
                    <StatusElement />
