...
import { TestDetails, FailedTests, PassedTests, TotalTests, RightSide } from './elements';
...
const TestSummaryText: React.SFC<Props> = ({ failedCount, passedCount, totalCount, totalDuration }) => (
    <TestDetails>
...
export default TestSummaryText;
