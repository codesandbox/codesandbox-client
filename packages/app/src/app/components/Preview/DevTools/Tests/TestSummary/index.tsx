...
import { Container, Title, Progress, SuccessBar, FailBar, TestData, IdleBar, Actions } from './elements';
        ...
        <div>
            <Container>
                <Title>
                    ...
                    <Actions>
                        <div style={{ fontSize: '.875rem' }}>{totalTestCount !== 0 && `${totalDuration}ms`}</div>
                        <Tooltip title="Toggle File Watching">
                            <SyncIcon style={{ color: watching ? 'white' : 'inherit' }} onClick={toggleWatching} />
                        </Tooltip>
