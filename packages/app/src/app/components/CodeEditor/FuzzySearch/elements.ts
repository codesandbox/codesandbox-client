...
>('div')`
  ...
  ${({ isNotSynced }) => isNotSynced && css`padding-left: 2rem;`};
  color: rgba(255, 255, 255, 0.8);

  ${({ isActive }) => isActive && css`background-color: ${(props) => props.theme.secondary.clearer(0.7)};`};
`;
...
export const Name = styled.span`margin: 0 0.5rem;`;
