...
import { getModulePath, resolveModule } from 'common/libsandbox/modules';
import { listen } from 'codesandbox-api';

import prettify from 'app/src/app/utils/prettify';
import DEFAULT_PRETTIER_CONFIG from 'common/libprettify-default-config';
...
import type {
  ...
  ModuleError,
  ModuleCorrection,
} from 'common/libtypes';
import { getTextOperation } from 'common/libutils/diff';
