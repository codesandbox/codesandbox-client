...
export type RootMutationTypeUpdateCommentThreadArgs = {
  commentThreadId: Scalars['ID'],
...
export type RootMutationTypeCreateCommentThreadArgs = {
  content: Scalars['String'],
  sandboxId: Scalars['ID']
};
...
export type RootSubscriptionType = {
  ...
  commentThreadCreated: CommentThread,
  commentThreadDeleted: CommentThread,
  commentThreadUpdated: CommentThread,
...
export type RootSubscriptionTypeCommentThreadCreatedArgs = {
  sandboxId: Scalars['ID']
};


export type RootSubscriptionTypeCommentThreadDeletedArgs = {
  sandboxId: Scalars['ID']
};


export type RootSubscriptionTypeCommentThreadUpdatedArgs = {
  sandboxId: Scalars['ID']
};
...
/** A Sandbox */
export type SandboxCommentThreadArgs = {
  commentThreadId: Scalars['ID']
};
...
export type TemplateFragment = (
  ...
  & { sandbox: Maybe<(
    { __typename?: 'Sandbox' }
    & Pick<Sandbox, 'id' | 'alias' | 'title' | 'description' | 'insertedAt' | 'updatedAt'>
    & { collection: Maybe<(
      { __typename?: 'Collection' }
      & { team: Maybe<(
        { __typename?: 'Team' }
...
export type ListPersonalTemplatesQuery = (
  ...
  & { me: Maybe<(
    ...
    & { templates: Maybe<Array<Maybe<(
      { __typename?: 'Template' }
      & TemplateFragment
    )>>>, recentlyUsedTemplates: Maybe<Array<Maybe<(
      { __typename?: 'Template' }
      & { sandbox: Maybe<(
        { __typename?: 'Sandbox' }
        & { git: Maybe<(
          { __typename?: 'Git' }
          & Pick<Git, 'id' | 'username' | 'commitSha' | 'path' | 'repo' | 'branch'>
        )> }
      )> }
      & TemplateFragment
...
export type MakeSandboxesTemplateMutation = (
  { __typename?: 'RootMutationType' }
  & { makeSandboxesTemplates: Maybe<Array<Maybe<(
    { __typename?: 'Template' }
    & Pick<Template, 'id'>
  )>>> }
);
...
export type UnmakeSandboxesTemplateMutation = (
  { __typename?: 'RootMutationType' }
  & { unmakeSandboxesTemplates: Maybe<Array<Maybe<(
    { __typename?: 'Template' }
    & Pick<Template, 'id'>
  )>>> }
);
...
export type CollaboratorFragment = (
  { __typename?: 'Collaborator' }
  & Pick<Collaborator, 'id' | 'authorization' | 'lastSeenAt' | 'warning'>
  & { user: (
    { __typename?: 'User' }
...
export type InvitationFragment = (
  { __typename?: 'Invitation' }
  & Pick<Invitation, 'id' | 'authorization' | 'email'>
);

export type SandboxChangedFragment = (
  { __typename?: 'Sandbox' }
  & Pick<Sandbox, 'id' | 'privacy' | 'title' | 'description' | 'authorization'>
);
...
export type CommentFragment = (
  { __typename?: 'Comment' }
  & Pick<Comment, 'id' | 'content' | 'insertedAt' | 'updatedAt'>
  & { user: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'username' | 'avatarUrl'>
  ) }
...
export type CreateCommentThreadMutationVariables = {
  sandboxId: Scalars['ID'],
  content: Scalars['String']
};
...
export type CreateCommentThreadMutation = (
  ...
  & { createCommentThread: (
    { __typename?: 'CommentThread' }
    & Pick<CommentThread, 'id' | 'isResolved' | 'insertedAt' | 'updatedAt'>
    & { initialComment: (
      { __typename?: 'Comment' }
      & CommentFragment
    ) }
...
export type ToggleCommentThreadResolvedMutationVariables = {
  commentThreadId: Scalars['ID'],
  isResolved: Maybe<Scalars['Boolean']>,
  sandboxId: Scalars['ID']
};
...
export type ToggleCommentThreadResolvedMutation = (
  { __typename?: 'RootMutationType' }
  & { updateCommentThread: (
    { __typename?: 'CommentThread' }
    & Pick<CommentThread, 'id' | 'isResolved' | 'updatedAt'>
  ) }
);
...
export type SandboxCommentRepliesQueryVariables = {
  sandboxId: Scalars['ID'],
  commentThreadId: Scalars['ID']
};


export type SandboxCommentRepliesQuery = (
  { __typename?: 'RootQueryType' }
  & { sandbox: Maybe<(
    { __typename?: 'Sandbox' }
    & { commentThread: Maybe<(
      { __typename?: 'CommentThread' }
      & Pick<CommentThread, 'id'>
      & { comments: Array<(
        { __typename?: 'Comment' }
        & CommentFragment
      )> }
...
export type SandboxCommentThreadsQueryVariables = {
  sandboxId: Scalars['ID']
};


export type SandboxCommentThreadsQuery = (
  { __typename?: 'RootQueryType' }
  & { sandbox: Maybe<(
    { __typename?: 'Sandbox' }
    & { commentThreads: Array<(
      { __typename?: 'CommentThread' }
      & Pick<CommentThread, 'id' | 'insertedAt' | 'isResolved' | 'updatedAt'>
      & { initialComment: (
        { __typename?: 'Comment' }
        & CommentFragment
      ) }
...
export type SandboxFragment = (
  { __typename?: 'Sandbox' }
  & Pick<Sandbox, 'id' | 'alias' | 'title' | 'description' | 'insertedAt' | 'updatedAt' | 'removedAt' | 'privacy' | 'screenshotUrl' | 'screenshotOutdated'>
  & { source: (
    { __typename?: 'Source' }
    & Pick<Source, 'template'>
...
export type TeamFragment = (
  { __typename?: 'Team' }
  & Pick<Team, 'id' | 'name' | 'description' | 'creatorId'>
  & { users: Array<(
    { __typename?: 'User' }
...
export type DeleteCollectionMutation = (
  { __typename?: 'RootMutationType' }
  & { deleteCollection: Maybe<Array<Maybe<(
    { __typename?: 'Collection' }
    & SidebarCollectionFragment
  )>>> }
);
...
export type RenameCollectionMutation = (
  { __typename?: 'RootMutationType' }
  & { renameCollection: Maybe<Array<Maybe<(
    { __typename?: 'Collection' }
    & SidebarCollectionFragment
  )>>> }
);
...
export type DeleteSandboxesMutation = (
  { __typename?: 'RootMutationType' }
  & { deleteSandboxes: Maybe<Array<Maybe<(
    { __typename?: 'Sandbox' }
    & SandboxFragment
  )>>> }
);
...
export type SetSandboxesPrivacyMutation = (
  { __typename?: 'RootMutationType' }
  & { setSandboxesPrivacy: Maybe<Array<Maybe<(
    { __typename?: 'Sandbox' }
    & SandboxFragment
  )>>> }
);
...
export type PermanentlyDeleteSandboxesMutation = (
  { __typename?: 'RootMutationType' }
  & { permanentlyDeleteSandboxes: Maybe<Array<Maybe<(
    { __typename?: 'Sandbox' }
    & SandboxFragment
  )>>> }
);
...
export type LeaveTeamMutation = (
  { __typename?: 'RootMutationType' }
  & Pick<RootMutationType, 'leaveTeam'>
);
...
export type BookmarkTemplateV2Mutation = (
  { __typename?: 'RootMutationType' }
  & { template: Maybe<(
    { __typename?: 'Template' }
    & BookmarkTemplateFieldsFragment
  )> }
);
...
export type BookmarkedSandboxInfoV2Query = (
  { __typename?: 'RootQueryType' }
  & { sandbox: Maybe<(
    { __typename?: 'Sandbox' }
    & Pick<Sandbox, 'id'>
    & { author: Maybe<(
      ...
      { __typename?: 'Template' }
      & BookmarkTemplateFieldsV2Fragment
    )> }
  )> }
);
