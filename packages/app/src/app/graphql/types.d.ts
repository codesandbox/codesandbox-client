...
export type BookmarkTemplateaMutationVariables = {
  template: Scalars['ID'],
  team?: Maybe<Scalars['ID']>
};


export type BookmarkTemplateaMutation = (
  { __typename?: 'RootMutationType' }
  & { template: Maybe<(
    { __typename?: 'Template' }
...
export type UnbookmarkTemplateaMutationVariables = {
  template: Scalars['ID'],
  team?: Maybe<Scalars['ID']>
};


export type UnbookmarkTemplateaMutation = (
  { __typename?: 'RootMutationType' }
  & { template: Maybe<(
    { __typename?: 'Template' }
    & TemplateFieldsFragment
...
export type TemplateFragment = (
  { __typename?: 'Template' }
  & Pick<Template, 'color' | 'iconUrl' | 'id' | 'published'>
  & { sandbox: Maybe<(
    { __typename?: 'Sandbox' }
    & SandboxFragment
  )> }
