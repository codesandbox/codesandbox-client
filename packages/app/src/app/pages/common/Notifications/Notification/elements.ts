...
>('div')`
  ...
  border-color: ${(props) => {
      ...
      if (props.type === 'warning') {
          return theme.primary.darken(0.2);
      }
...
>('div')`
  ...
  background-color: ${(props) => {
      if (props.type === 'error') {
          return theme.redBackground.lighten(0.2);
      }
      if (props.type === 'warning') {
          return theme.primary.darken(0.5);
      }
  ...
  &:hover {
    background-color: ${(props) => {
        if (props.type === 'error') {
            return theme.redBackground.lighten(0.1);
        }
        if (props.type === 'warning') {
            return theme.primary.darken(0.6);
        }
