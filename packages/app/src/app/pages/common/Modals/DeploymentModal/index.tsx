        ...
        <IntegrationModal
            ...
            subtitle={
                <div>
                    ...
                    <a target="_blank" rel="noreferrer noopener" href="https://zeit.co/now">
                        ZEIT Now
                    </a>
                </div>
            }
                ...
                {store.deployment.url ? (
                    <Margin top={1} bottom={2}>
                        <Centered horizontal>
                            ...
                            <DeployedLink href={store.deployment.url} rel="nofollow noreferrer" target="_blank">
                                {store.deployment.url}
                            </DeployedLink>

                            <DeploymentManagementNotice>
                                You can manage your deployments{' '}
                                <a href="https://zeit.co/dashboard" target="_blank" rel="noreferrer noopener">
                                    here
                                </a>.
                            </DeploymentManagementNotice>
                        </Centered>
