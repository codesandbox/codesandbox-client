...
export default () => (
  <div>
    ...
    <div id="ppBody">
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> To improve our website
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> To quickly process
        your transactions.
      </div>
      <div className="innerText">
      ...
      <div className="innerText">
        ...
        you allow) that enables the site{"'"}s or service provider{"'"}s systems
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Understand and save
        user{"'"}s preferences for future visits.
      </div>
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Compile aggregate data
      ...
      <div className="innerText">
        <br />Google, as a third-party vendor, uses cookies to serve ads on our
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Remarketing with
        Google AdSense
      </div>
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Demographics and
        Interests Reporting
      </div>
      <div className="innerText">
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> On our Privacy Policy
        Page<br />
      </div>
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> By logging in to your
        account
      </div>
      <div className="innerText">
      ...
      <div className="innerText">
        ...
        services must do to protect children{"'"}s privacy and safety online.<br />
        <br />
      </div>
      <div className="innerText">
      ...
      <div className="innerText">
        ...
        privacy laws that protect personal information.<br />
        <br />
      </div>
      <div className="innerText">
        <h3>
      ...
      <div className="innerText">
        <br />We also agree to the Individual Redress Principle which requires
      ...
      <div className="innerText">
        ...
        tough penalties for violations.<br />
      </div>
      <div className="innerText">
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Process orders and to
        send information and updates pertaining to orders.
      </div>
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Market to our mailing
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Identify the message
        as an advertisement in some reasonable way.
      </div>
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Include the physical
        address of our business or site headquarters.
      </div>
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>•</strong> Monitor third-party
      ...
      <div className="innerText">
        <strong>
          ...
          future emails, you can email us at hello@codesandbox.io
        </strong>
      </div>
      <br />
      <div className="innerText">
