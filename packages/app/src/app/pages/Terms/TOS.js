...
export default () => (
  <div>
    ...
    <p>
      ...
      renew under the exact same conditions unless you cancel it or Bas en Ives
      VOF cancels it. You may cancel your Subscription renewal either through
      your online account management page or by contacting Bas en Ives VOF
      customer support team.
    </p>

    <p>
      A valid payment method, including credit card, is required to process the
      payment for your Subscription. You shall provide Bas en Ives VOF with
      ...
      information, you automatically authorize Bas en Ives VOF to charge all
      Subscription fees incurred through your account to any such payment
      instruments.
    </p>

    <p>
      Should automatic billing fail to occur for any reason, Bas en Ives VOF
    ...
    <p>
      Bas en Ives VOF, in its sole discretion and at any time, may modify the
    ...
    <p>
      Bas en Ives VOF will provide you with a reasonable prior notice of any
    ...
    <p>
      Certain refund requests for Subscriptions may be considered by Bas en Ives
      VOF on a case-by-case basis and granted in sole discretion of Bas en Ives
      VOF.
    </p>
    ...
    <p>
      ...
      licence. You retain any and all of your rights to any Content you submit,
      post or display on or through the Service and you are responsible for
      protecting those rights. You agree that this license includes the right
      for us to make your Content available to other users of the Service, who
      may also use your Content subject to these Terms. If you specifically save
      a Sandbox as private to CodeSandbox, and that Sandbox has never been
      public on CodeSandbox or anywhere else, the code in that particular
    ...
    <p>
      ...
      are not owned or controlled by Bas en Ives VOF.
    </p>

    <p>
      Bas en Ives VOF has no control over, and assumes no responsibility for,
      the content, privacy policies, or practices of any third party web sites
      or services. You further acknowledge and agree that Bas en Ives VOF shall
    ...
    <p>
      Bas en Ives VOF its subsidiaries, affiliates, and its licensors do not
