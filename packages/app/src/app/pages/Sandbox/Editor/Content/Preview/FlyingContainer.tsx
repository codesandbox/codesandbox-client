...
class FlyingContainer extends React.Component<Props, State> {
    ...
    handleHeightResize = (
        ...
        const handleMouseMove = (dragEvent: MouseEvent) => {
            ...
            const newSizeY = changePositionY ? previewHeight + deltaY : previewHeight - deltaY;
            const newSizeX = changePositionX ? previewWidth + deltaX : previewWidth - deltaX;
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                >
                    <TopResizer onMouseDown={(e) => this.handleHeightResize(e, true, false, true, false)} />
                    <RightResizer onMouseDown={(e) => this.handleHeightResize(e, false, true, false, true)} />
                    <BottomResizer onMouseDown={(e) => this.handleHeightResize(e, true, false, false, false)} />
                    <LeftResizer onMouseDown={(e) => this.handleHeightResize(e, false, true, false, false)} />
                    <NEResizer onMouseDown={(e) => this.handleHeightResize(e, true, true, true, true)} />
                    <SEResizer onMouseDown={(e) => this.handleHeightResize(e, true, true, false, true)} />
                    <SWResizer onMouseDown={(e) => this.handleHeightResize(e, true, true, false, false)} />
                    <NWResizer onMouseDown={(e) => this.handleHeightResize(e, true, true, true, false)} />
                    {this.props.children({ resize: this.resizeTo })}

                    {this.state.resizing && (
                        <ResizingNotice>
                            {Math.floor(width)} x {Math.floor(height - 2.5 * 16 /* navigation bar */)}
                        </ResizingNotice>
                    )}
                </div>
            </Draggable>
