    ...
    class EditorPreview extends React.Component<typeof props, State> {
      ...
      componentDidMount() {
        ...
        this.disposeEditorChange = reaction(
          () => this.props.settings.codeMirror,
          () => this.forceUpdate()
        );
      ...
      onInitialized = (codeEditor) => {
        const { preferences, workspace, editor, parsedConfigurations, currentModule, errors, corrections, glyphs, settings } = this.props;
        ...
        const disposeCorrectionsHandler = reaction(
          ...
          corrections => {
            if (codeEditor.setCorrections) {
              codeEditor.setCorrections(corrections);
            }
          }
        );
      ...
      render() {
        const { currentModule, isAllModulesSynced, zenMode, settings, parsedConfigurations, showDevtools, isForkingSandbox, openedWorkspaceItem } = this.props
            ...
            <FullSize>
              ...
              <DevTools
                ...
                setDevToolsOpen={open =>
                  this.props.setDevtoolsOpen({ open })
                }
              />
            </FullSize>
          </ThemeProvider>
