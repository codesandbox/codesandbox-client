...
export const ResizeHandles = ({
  ...
  <Styled on={on} id="styled-resize-wrapper">
    <div>
      ...
      <div
        id="screenshot-indicator-1"
        style={{
          position: 'absolute',
          width: '3px',
          height: '1px',
          zIndex: 9999999999999999,
          top: on ? HANDLE_OFFSET * 2 : 0,
          left: on ? `calc(50% - ${(width * scale) / 2}px)` : 0,
          display: 'none',
      ...
      <div
        id="screenshot-indicator-2"
        style={{
          position: 'absolute',
          width: '3px',
          height: '1px',
          zIndex: 9999999999999999,
          right: on ? `calc(50% - ${(width * scale) / 2}px)` : 0,
          top: on
            ? `calc(${height * scale + HANDLE_OFFSET * 2 - 5}px)`
            : 'calc(100% - 5px)',
          display: 'none',
          border: '2px solid black',
        }}
