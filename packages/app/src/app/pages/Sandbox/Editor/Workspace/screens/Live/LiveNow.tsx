...
import { sara, sid } from '@codesandbox/components/lib/components/Avatar/stubs';
  ...
  const {
    ...
    state: {
      live: {
        notificationsHidden,
        liveUserId,
        roomInfo: { startTime, roomId, chatEnabled, mode, users, ownerIds },
      },
    },
  } = useOvermind();
  ...
  return (
    <>
      ...
      <Collapsible title="Owners" defaultOpen>
        <Stack direction="vertical" gap={6} css={css({ paddingX: 2 })}>
          <Element>
            {owners.map(owner => {
              return (
