...
export const Added: React.SFC<AddedProps> = ({ changes, hideColor }) => {
    return <Changes changes={changes} color={theme.green} Icon={AddedIcon} title="Added" hideColor={hideColor} />;
};
...
export const Modified: React.SFC<ModifiedProps> = ({ changes, hideColor }) => {
    return (
        <Changes changes={changes} color={theme.secondary} Icon={ModifiedIcon} title="Modified" hideColor={hideColor} />
    );
};
...
export const Deleted: React.SFC<DeletedProps> = ({ changes, hideColor }) => {
    return <Changes changes={changes} color={theme.red} Icon={RemovedIcon} title="Deleted" hideColor={hideColor} />;
};
