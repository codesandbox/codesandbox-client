...
class Git extends React.Component<Props> {
    ...
    render() {
        ...
        const changeCount = gitChanges
            ? gitChanges.added.length + gitChanges.modified.length + gitChanges.deleted.length
            : 0;
        ...
        return (
            <Container>
                ...
                <Margin bottom={0}>
                    <WorkspaceSubtitle>Changes ({gitChanges ? changeCount : '...'})</WorkspaceSubtitle>
                        ...
                        <Margin top={1}>
                            ...
                            {changeCount > 0 ? (
                                <Margin top={1}>
                                    ...
                                    {modulesNotSaved && (
                                        <ErrorMessage>You need to save all modules before you can commit</ErrorMessage>
                                    )}
