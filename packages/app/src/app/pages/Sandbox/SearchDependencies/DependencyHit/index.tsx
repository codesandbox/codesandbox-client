...
export default class DependencyHit extends React.PureComponent<Props, State> {
    ...
    makeSearchUrl(hitName: string) {
        return `${process.env
            .CODESANDBOX_HOST}/search?refinementList%5Bnpm_dependencies.dependency%5D%5B0%5D=${hitName}&page=1`;
    }
        ...
        return (
            <Container highlighted={highlighted} onClick={onClick}>
                <Left>
                    ...
                    <Row>
                        <StyledUserWithAvatar username={hit.owner.name} avatarUrl={hit.owner.avatar} />
                    </Row>
                </Left>
                <Right>
                    <Row>
