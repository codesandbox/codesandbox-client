...
>('div')`
  display: flex;
  background: ${(props) => (props.highlighted ? props.theme.background2.darken(0.3) : props.theme.background2)};
...
export const StyledSelect = Select.extend`font-size: 0.875rem;`;

export const StyledUserWithAvatar = styled<UserWithAvatarProps>(UserWithAvatar)`
  font-size: 0.75rem;
  font-weight: 500;
`;
