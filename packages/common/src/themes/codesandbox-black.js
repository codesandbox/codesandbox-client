...
const colors = {
  ...
  editor: {
    background: '#151515',
    foreground: '#ffffff',
    hoverHighlightBackground: '#333',
    inactiveSelectionBackground: '#333',
    lineHighlightBackground: '#242424',
    lineHighlightBorder: '#242424',
    rangeHighlightBackground: '#222',
    selectionBackground: '#242424',
    selectionHighlightBackground: '#242424',
    wordHighlightStrongBackground: '#242424',
    wordHighlightBackground: '#242424',
  },
  editorBracketMatch: {
    background: '#242424',
    border: '#242424',
  ...
  editorGroup: {
    background: '#151515',
    border: '#242424',
    dropBackground: '#151515',
  },
  editorGroupHeader: {
    noTabsBackground: null,
    tabsBackground: '#151515',
    tabsBorder: '#242424',
  },
  editorGutter: {
    background: '#151515',
    deletedBackground: '#E1270E',
    modifiedBackground: '#151515',
  },
  editorHoverWidget: {
    background: '#151515',
    border: '#242424',
  ...
  editorOverviewRuler: {
    border: '#242424',
    commonContentForeground: '#242424',
    currentContentForeground: '#E1270E',
    incomingContentForeground: '#5BC266',
  },
  editorSuggestWidget: {
    background: '#151515',
    border: '#242424',
  ...
  extensionButton: {
    prominentBackground: '#242424',
    prominentForeground: '#fff',
    prominentHoverBackground: '#242424',
  },
  input: {
    background: '#242424',
    foreground: '#fff',
  ...
  inputValidation: {
    ...
    warningBorder: '#FBCC43',
    errorForeground: null,
    errorBackground: null,
    errorBorder: '#E1270E',
  },
  list: {
    activeSelectionBackground: '#151515',
    activeSelectionForeground: '#fff',
    dropBackground: '#151515',
    focusBackground: '#151515',
    highlightForeground: '#6CC7F6',
    hoverBackground: '#242424',
    inactiveSelectionBackground: null,
    inactiveSelectionForeground: null,
    warningForeground: '#FBCC43',
    errorForeground: '#E1270E',
  ...
  peekViewEditor: {
    background: '#242424',
    matchHighlightBackground: '#76D0FB',
  },
  ...
  statusBar: {
    background: '#242424',
    foreground: '#ffffff',
    debuggingBackground: '#E1270E',
    debuggingForeground: '#242424',
    noFolderBackground: '#242424',
    noFolderForeground: '#F8F8F2',
    border: '#242424',
  },
  statusBarItem: {
    activeBackground: null,
    hoverBackground: null,
    prominentBackground: '#E1270E',
    prominentHoverBackground: '#FFB86C',
    remoteForeground: '#e6e6e6',
    remoteBackground: '#BF5AF2',
  },
  tab: {
    ...
    inactiveBackground: '#151515',
    inactiveForeground: '#757575',
    unfocusedActiveForeground: '#ffffff',
    unfocusedInactiveForeground: '#757575',
  },
  terminal: {
    background: '#040404',
    foreground: '#fff',
    ansiBrightBlack: '#535BCF',
    ansiBrightRed: '#E1270E',
    ansiBrightGreen: '#5BC266',
    ansiBrightYellow: '#FBCC43',
    ansiBlack: '#21222C',
    ansiRed: '#E1270E',
    ansiGreen: '#5BC266',
    ansiYellow: '#FBCC43',
