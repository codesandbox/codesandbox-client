...
export default ({ width = 32, height = 32, className }) => (
  ...
  >
     <defs>
      <linearGradient id="gridsome_paint0_linear" x1="124" y1="-37" x2="-15.3949" y2="446.346" gradientUnits="userSpaceOnUse">
        <stop stop-color="#00A672"/>
        <stop offset="1" stop-color="#008B60"/>
      </linearGradient>
      <linearGradient id="gridsome_paint1_linear" x1="263.861" y1="445.388" x2="263.861" y2="251.498" gradientUnits="userSpaceOnUse">
        <stop stop-color="white" stop-opacity="0.95"/>
        <stop offset="1" stop-color="white" stop-opacity="0.5"/>
      </linearGradient>
    </defs>
    
    <rect width="512" height="512" rx="256" fill="url(#gridsome_paint0_linear)"/>
