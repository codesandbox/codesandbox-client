...
| `node` | The Node.js major version to use inside the container. The exact versions used are as follows:<br />`"10"`: `10.24.1`<br />`"12"`: `12.22.6`<br />`"14"`: `14.17.6`<br />`"16"`: `16.8.0` | `"10"` / `"12"` / `"14"` / `"16"` | `"14"` |
