...
Note that a [Pro subscription](https://codesandbox.stream/pricing) is required
to make sandboxes private or unlisted.
...
able to solve this yourself, then
[get in touch](mailto:hello@codesandbox.stream) and provide a link to the repo
you're importing and we can look into this for you.
...
[Pro page](https://codesandbox.stream/pro). For legacy Patron users, you can
cancel your subscription on the
[Patron page](https://codesandbox.stream/patron).
