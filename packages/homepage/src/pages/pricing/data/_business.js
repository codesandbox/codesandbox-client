...
export const business = {
  plans: [
    { name: "Team Pro", color: "#ac9cff" },
    { name: "Organization", color: "#dcff50" },
    { name: "Enterprise", color: "#00b2ff" },
  ],
  ...
  items: [
    {
      ...
      features: [
        {
          name: "Dashboard ",
          desc: "Organize sandboxes and templates. Search, sort, or modify sandboxes at once",
          available: true,
        },
        {
        ...
        },
        {
          ...
          desc: "Disable the ability to fork or download all shared sandboxes in a team",
          available: true,
        },
        {
          name: "Analytics",
      ...
      features: [
        {
          ...
          desc: "Sandboxes, both the preview and code, are available publicly by default",
          available: true,
        },
        {
        ...
        },
        {
          ...
          desc: "Set a sandbox as private or unlisted so others can’t see the code",
          available: true,
        },
        {
          name: "Private GitHub Repos",
          desc: "Import and sync repos which are private on GitHub to CodeSandbox",
          available: true,
        },
        {
