    ...
    >
      ...
      <Grid>
        ...
        <div>
          ...
          Create templates for your specific use-case with the configuration,
          file structure, and dependencies you need.
        </div>
      </Grid>
      <Border />
      <Wrapper>
      ...
      <Wrapper>
        ...
        <Grid>
          ...
          <div>
            ...
            We auto-detect and run Jest tests, showing results next to your
            code.
          </div>
          <div>
            <H6>Error Overlay</H6>
      ...
      <Wrapper>
        ...
        <Grid>
          ...
          <div>
            <H6>Export to Zip</H6>
            You can always download your sandbox as a zip if you want to
            continue locally.
          </div>
        </Grid>
      </Wrapper>
